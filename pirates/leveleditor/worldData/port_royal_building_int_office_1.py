# Embedded file name: pirates.leveleditor.worldData.port_royal_building_int_office_1
...
objectStruct = {
    'Objects': {
        '1155684634.87dzlu0': {
            ...
            'Name': '',
            'AdditionalData': ['interior_spanish_office'],
            'Instanced': True,
            'Objects': {
                ...
                '1169083104.56sdnaik': {
                    ...
                    'AnimSet': 'bar_write',
                    'CustomModel': 'None',
                    'Hpr': VBase3(86.815, 0.0, 0.0),
                    'Patrol Radius': '12.0000',
                    'Pos': Point3(5.718, -5.814, 0.0),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'Private Status': 'All',
                    'Respawns': True,
                ...
                '1212700053.63kmuller': {
                    'Type': 'Writing_Paper',
                    'Hpr': VBase3(94.349, 0.0, 0.0),
                    'Pos': Point3(3.634, -5.341, 2.981),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'Visual': {
    ...
    'ObjectIds': {
        '1155684634.87dzlu0':
        '["Objects"]["1155684634.87dzlu0"]',
        '1167174504.17kmuller':
        '["Objects"]["1155684634.87dzlu0"]["Objects"]["1167174504.17kmuller"]',
        '1167174514.03kmuller':
        '["Objects"]["1155684634.87dzlu0"]["Objects"]["1167174514.03kmuller"]',
        '1169082812.19sdnaik':
        '["Objects"]["1155684634.87dzlu0"]["Objects"]["1169082812.19sdnaik"]',
        '1169083104.56sdnaik':
        '["Objects"]["1155684634.87dzlu0"]["Objects"]["1169083104.56sdnaik"]',
        '1212699883.86kmuller':
        '["Objects"]["1155684634.87dzlu0"]["Objects"]["1212699883.86kmuller"]',
        '1212700053.63kmuller':
        '["Objects"]["1155684634.87dzlu0"]["Objects"]["1212700053.63kmuller"]'
    }
}
extraInfo = {
    'camPos': Point3(380.289, -1851.58, 20.0729),
    'camHpr': VBase3(-130.326, -37.5729, 0),
