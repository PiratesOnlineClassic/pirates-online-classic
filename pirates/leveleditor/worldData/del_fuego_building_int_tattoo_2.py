# Embedded file name: pirates.leveleditor.worldData.del_fuego_building_int_tattoo_2
...
objectStruct = {
        ...
        '1190672768.0dxschafe1': {
            ...
            'Objects': {
                ...
                '1201559943.36dxschafe': {
                    ...
                    'DropOff': '0.0000',
                    'FlickRate': '0.5000',
                    'Hpr': VBase3(-156.352, -22.196, 6.707),
                    'Intensity': '0.5783',
                    'LightType': 'SPOT',
                    'Pos': Point3(-5.773, 18.225, 16.423),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'Visual': {
                        'Color': (1, 1, 1, 1),
    ...
    'ObjectIds': {
        '1190672768.0dxschafe1':
        '["Objects"]["1190672768.0dxschafe1"]',
        '1201219079.81dxschafe':
        '["Objects"]["1190672768.0dxschafe1"]["Objects"]["1201219079.81dxschafe"]',
        '1201219079.83dxschafe':
        '["Objects"]["1190672768.0dxschafe1"]["Objects"]["1201219079.83dxschafe"]',
        '1201224743.34dxschafe':
        '["Objects"]["1190672768.0dxschafe1"]["Objects"]["1201224743.34dxschafe"]',
        '1201559943.36dxschafe':
        '["Objects"]["1190672768.0dxschafe1"]["Objects"]["1201559943.36dxschafe"]',
        '1201561394.09dxschafe':
        '["Objects"]["1190672768.0dxschafe1"]["Objects"]["1201561394.09dxschafe"]'
    }
}
extraInfo = {
    'camPos': Point3(16.28, 2.85684, 7.03096),
    'camHpr': VBase3(113.753, -39.4171, 0),
