# Embedded file name: pirates.leveleditor.worldData.port_royal_building_int_blacksmith_2
...
objectStruct = {
        ...
        '1153420647.55dzlu0': {
            ...
            'Objects': {
                '1181260288.0dxschafe': {
                    ...
                    'CustomModel': 'None',
                    'HelpID': 'NONE',
                    'Hpr': VBase3(-164.408, 0.0, 0.0),
                    'Patrol Radius': '12.0000',
                    'Pos': Point3(-13.73, 7.442, 0.0),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'Private Status': 'All',
                    'Respawns': True,
    ...
    'ObjectIds': {
        '1153420647.55dzlu0':
        '["Objects"]["1153420647.55dzlu0"]',
        '1181260288.0dxschafe':
        '["Objects"]["1153420647.55dzlu0"]["Objects"]["1181260288.0dxschafe"]',
        '1192213120.0dchiappe0':
        '["Objects"]["1153420647.55dzlu0"]["Objects"]["1192213120.0dchiappe0"]',
        '1213290769.34aapatel':
        '["Objects"]["1153420647.55dzlu0"]["Objects"]["1213290769.34aapatel"]',
        '1213290785.14aapatel':
        '["Objects"]["1153420647.55dzlu0"]["Objects"]["1213290785.14aapatel"]'
    }
}
extraInfo = {
    'camPos': Point3(24.1289, -86.9144, 65.7237),
    'camHpr': VBase3(16.3192, -35.3248, 1.04644e-06),
