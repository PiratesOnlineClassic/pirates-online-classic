# Embedded file name: pirates.leveleditor.worldData.port_royal_building_int_blacksmith_1
...
objectStruct = {
        ...
        '1153423464.2dzlu0': {
            ...
            'Objects': {
                '1181171584.0dxschafe0': {
                    ...
                    'CustomModel': 'None',
                    'HelpID': 'NONE',
                    'Hpr': VBase3(-169.861, 0.0, 0.0),
                    'Patrol Radius': '12.0000',
                    'Pos': Point3(6.664, 17.591, 0.0),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'Private Status': 'All',
                    'Respawns': True,
    ...
    'ObjectIds': {
        '1153423464.2dzlu0':
        '["Objects"]["1153423464.2dzlu0"]',
        '1181171584.0dxschafe0':
        '["Objects"]["1153423464.2dzlu0"]["Objects"]["1181171584.0dxschafe0"]',
        '1192212864.0dchiappe0':
        '["Objects"]["1153423464.2dzlu0"]["Objects"]["1192212864.0dchiappe0"]',
        '1213222075.18aapatel':
        '["Objects"]["1153423464.2dzlu0"]["Objects"]["1213222075.18aapatel"]',
        '1213222099.15aapatel':
        '["Objects"]["1153423464.2dzlu0"]["Objects"]["1213222099.15aapatel"]'
    }
}
extraInfo = {
    'camPos': Point3(23.9737, -35.6586, 25.7884),
    'camHpr': VBase3(36.6516, -24.8666, -5.6461e-06),
