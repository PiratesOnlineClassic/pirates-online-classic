...
objectStruct = {
        ...
        '1156279496.29dzlu0': {
            ...
            'Objects': {
                '1169067906.19mike': {
                    ...
                    'AnimSet': 'tatoo',
                    'CustomModel': 'None',
                    'Hpr': VBase3(-102.509, 1.642, 0.0),
                    'Patrol Radius': '12.0000',
                    'Pos': Point3(6.937, -8.133, -0.017),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'Private Status': 'All',
                    'Respawns': True,
                ...
                '1179360000.0dchiappe': {
                    ...
                    'Pos': Point3(7.057, -8.171, 0.0),
                    'Scale': VBase3(0.954, 0.954, 0.954),
                    'Visual': {
                ...
                '1179360000.0dchiappe0': {
                    'Type': 'Furniture',
                    'DisableCollision': False,
                    'Hpr': VBase3(-29.781, 0.0, 0.0),
                    'Objects': {},
                    'Pos': Point3(7.636, -4.541, -0.0),
                ...
                '1179360256.0dchiappe': {
                    ...
                    'CustomModel': 'None',
                    'Hpr': VBase3(-125.548, -4.22, -0.497),
                    'Patrol Radius': '12.0000',
                    'Pos': Point3(7.176, -4.228, 0.49),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'Private Status': 'All',
                    'Respawns': True,
                ...
                '1201122985.55dxschafe': {
                    ...
                    'DropOff': '45.5422',
                    'FlickRate': '0.5000',
                    'Hpr': VBase3(170.832, -20.397, 4.921),
                    'Intensity': '1.0602',
                    'LightType': 'SPOT',
                ...
                '1201124068.83dxschafe': {
                    ...
                    'DropOff': '29.8193',
                    'FlickRate': '0.5000',
                    'Hpr': VBase3(-119.397, -38.379, 0.0),
                    'Intensity': '0.9639',
                    'LightType': 'SPOT',
                    'Pos': Point3(1.086, 14.825, 18.821),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'Visual': {
                        'Color': (1, 1, 1, 1),
                        'Model': 'models/props/light_tool_bulb'
    ...
    'ObjectIds': {
        '1156279496.29dzlu0':
        '["Objects"]["1156279496.29dzlu0"]',
        '1169067906.19mike':
        '["Objects"]["1156279496.29dzlu0"]["Objects"]["1169067906.19mike"]',
        '1179360000.0dchiappe':
        '["Objects"]["1156279496.29dzlu0"]["Objects"]["1179360000.0dchiappe"]',
        '1179360000.0dchiappe0':
        '["Objects"]["1156279496.29dzlu0"]["Objects"]["1179360000.0dchiappe0"]',
        '1179360256.0dchiappe':
        '["Objects"]["1156279496.29dzlu0"]["Objects"]["1179360256.0dchiappe"]',
        '1201025152.0dxschafe':
        '["Objects"]["1156279496.29dzlu0"]["Objects"]["1201025152.0dxschafe"]',
        '1201025280.0dxschafe':
        '["Objects"]["1156279496.29dzlu0"]["Objects"]["1201025280.0dxschafe"]',
        '1201122985.55dxschafe':
        '["Objects"]["1156279496.29dzlu0"]["Objects"]["1201122985.55dxschafe"]',
        '1201124068.83dxschafe':
        '["Objects"]["1156279496.29dzlu0"]["Objects"]["1201124068.83dxschafe"]'
    }
}
extraInfo = {
    'camPos': Point3(27.5818, -0.0333776, 7.80025),
    'camHpr': VBase3(105.822, -9.40712, -1.73082e-06),
