...
objectStruct = {
    ...
    'Objects': {
        '1168033330.17kmuller0': {
            ...
            'AdditionalData': ['interior_mansion'],
            'Instanced': True,
            'Objects': {
                '1171325040.86MAsaduzz': {
                    ...
                    'Hpr': VBase3(-27.528, 0.0, 0.0),
                    'Pos': Point3(-0.101, -8.086, -0.028),
                    'Private Status': 'All',
                    'Respawns': True,
    ...
    'ObjectIds': {
        '1168033330.17kmuller0':
        '["Objects"]["1168033330.17kmuller0"]',
        '1171325040.86MAsaduzz':
        '["Objects"]["1168033330.17kmuller0"]["Objects"]["1171325040.86MAsaduzz"]',
        '1176937728.0dxschafe':
        '["Objects"]["1168033330.17kmuller0"]["Objects"]["1176937728.0dxschafe"]'
    }
}
