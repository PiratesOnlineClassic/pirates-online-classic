# Embedded file name: pirates.leveleditor.worldData.del_fuego_building_int_blacksmith_2
...
objectStruct = {
        ...
        '1153434928.03dzlu0': {
            ...
            'Objects': {
                ...
                '1213290386.14aapatel': {
                    ...
                    'CustomModel': 'None',
                    'HelpID': 'NONE',
                    'Hpr': VBase3(134.57, 0.0, 0.0),
                    'Patrol Radius': '12.0000',
                    'Pos': Point3(7.116, 5.393, 0.0),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'Private Status': 'All',
                    'Respawns': True,
    ...
    'ObjectIds': {
        '1153434928.03dzlu0':
        '["Objects"]["1153434928.03dzlu0"]',
        '1157098037.86jasyeung':
        '["Objects"]["1153434928.03dzlu0"]["Objects"]["1157098037.86jasyeung"]',
        '1213290358.72aapatel':
        '["Objects"]["1153434928.03dzlu0"]["Objects"]["1213290358.72aapatel"]',
        '1213290386.14aapatel':
        '["Objects"]["1153434928.03dzlu0"]["Objects"]["1213290386.14aapatel"]'
    }
}
extraInfo = {
    'camPos': Point3(10.2739, -87.8973, 55.1858),
    'camHpr': VBase3(8.1854, -25.4559, 5.90983e-06),
