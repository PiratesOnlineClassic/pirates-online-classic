# Embedded file name: pirates.leveleditor.worldData.tortuga_building_int_13
...
objectStruct = {
        ...
        '1156279255.42dzlu0': {
            ...
            'Objects': {
                ...
                '1222963591.11akelts': {
                    ...
                    'Intensity': '0.3012',
                    'LightType': 'AMBIENT',
                    'Pos': Point3(15.78, 3.344, 37.624),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'VisSize': '',
                    'Visual': {
                        'Color': (0.95, 1.0, 0.91, 1.0),
                ...
                '1222963599.89akelts': {
                    ...
                    'DropOff': '0.0000',
                    'FlickRate': '0.5000',
                    'Hpr': VBase3(180.0, -86.067, 180.0),
                    'Intensity': '0.6747',
                    'LightType': 'DIRECTIONAL',
                    'Pos': Point3(22.268, 2.541, 42.139),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'VisSize': '',
                    'Visual': {
                        'Color': (0.94, 0.95, 1.0, 1.0),
                        'Model': 'models/props/light_tool_bulb'
                    }
                }
            },
    ...
    'ObjectIds': {
        '1156279255.42dzlu0':
        '["Objects"]["1156279255.42dzlu0"]',
        '1172092324.47kmuller':
        '["Objects"]["1156279255.42dzlu0"]["Objects"]["1172092324.47kmuller"]',
        '1181605248.0dxschafe':
        '["Objects"]["1156279255.42dzlu0"]["Objects"]["1181605248.0dxschafe"]',
        '1222963573.55akelts':
        '["Objects"]["1156279255.42dzlu0"]["Objects"]["1222963573.55akelts"]',
        '1222963591.11akelts':
        '["Objects"]["1156279255.42dzlu0"]["Objects"]["1222963591.11akelts"]',
        '1222963599.89akelts':
        '["Objects"]["1156279255.42dzlu0"]["Objects"]["1222963599.89akelts"]'
    }
}
extraInfo = {
    'camPos': Point3(-150.458, 22.778, 79.9705),
    'camHpr': VBase3(147.714, -15.7037, 0),
