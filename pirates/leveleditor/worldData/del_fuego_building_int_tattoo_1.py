# Embedded file name: pirates.leveleditor.worldData.del_fuego_building_int_tattoo_1
...
objectStruct = {
        ...
        '1153434880.63dzlu0': {
            ...
            'Objects': {
                ...
                '1201547343.75dxschafe': {
                    ...
                    'DropOff': '0.0000',
                    'FlickRate': '0.5000',
                    'Hpr': VBase3(-150.689, -16.467, 0.0),
                    'Intensity': '0.8313',
                    'LightType': 'SPOT',
                    'Pos': Point3(-17.738, 6.712, 15.011),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'Visual': {
                        'Color': (1, 1, 1, 1),
    ...
    'ObjectIds': {
        '1153434880.63dzlu0':
        '["Objects"]["1153434880.63dzlu0"]',
        '1201136836.84dxschafe':
        '["Objects"]["1153434880.63dzlu0"]["Objects"]["1201136836.84dxschafe"]',
        '1201230131.11dxschafe':
        '["Objects"]["1153434880.63dzlu0"]["Objects"]["1201230131.11dxschafe"]',
        '1201547343.75dxschafe':
        '["Objects"]["1153434880.63dzlu0"]["Objects"]["1201547343.75dxschafe"]'
    }
}
extraInfo = {
    'camPos': Point3(2.19335, -12.757, 8.36372),
    'camHpr': VBase3(68.5072, -22.6132, 0),
