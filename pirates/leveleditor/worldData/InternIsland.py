...
objectStruct = {
    ...
    'Objects': {
        '1180633600.0sdnaik0': {
            ...
            'Name': 'InternIsland',
            'File': '',
            'AdditionalData': ['RumrunnerIsland'],
            'Objects': {
                "\n                    '1180634112.0sdnaik': {\n                    'Type': 'InternObject',\n                    'Hpr': Point3(0.000,0.000,0.000),\n                    'Pos': Point3(142.858,194.580,0.000),\n                    'Scale': VBase3(1.000,1.000,1.000),\n                    'Visual': {\n                        'Model': 'models/props/barrel',},},\n1180635136.0sdnaik":
                {
                    ...
                    'Index': 1,
                    'Pos': Point3(127.066, 202.495, 7.685),
                ...
                '1155695180.13sdnaik': {
                    ...
                    'Scale': VBase3(2076.06, 2076.06, 2076.06),
                    'Visual': {
                ...
                '1183682138.26joswilso': {
                    'Type': 'Dinghy',
                    'Hpr': VBase3(0.0, 9.07, 0.0),
                    'Pos': Point3(130.736, 169.944, 1.634),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'Visual': {
    ...
    'ObjectIds': {
        '1180633600.0sdnaik0':
        '["Objects"]["1180633600.0sdnaik0"]',
        '1155695180.13sdnaik':
        '["Objects"]["1180633600.0sdnaik0"]["Objects"]["1155695180.13sdnaik"]',
        '1180635136.0sdnaik':
        '["Objects"]["1180633600.0sdnaik0"]["Objects"]["1180635136.0sdnaik"]',
        '1183682138.26joswilso':
        '["Objects"]["1180633600.0sdnaik0"]["Objects"]["1183682138.26joswilso"]'
    }
}
