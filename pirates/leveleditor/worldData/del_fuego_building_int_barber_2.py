# Embedded file name: pirates.leveleditor.worldData.del_fuego_building_int_barber_2
...
objectStruct = {
        ...
        '1153777945.95dzlu0': {
            ...
            'Objects': {
                ...
                '1201560149.3dxschafe': {
                    ...
                    'DropOff': '28.1928',
                    'FlickRate': '0.5000',
                    'Hpr': VBase3(-153.225, -19.296, 0.0),
                    'Intensity': '0.6747',
                    'LightType': 'SPOT',
                    'Pos': Point3(-8.765, -9.836, 10.399),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'Visual': {
                        'Color': (1, 1, 1, 1),
    ...
    'ObjectIds': {
        '1153777945.95dzlu0':
        '["Objects"]["1153777945.95dzlu0"]',
        '1201219525.27dxschafe':
        '["Objects"]["1153777945.95dzlu0"]["Objects"]["1201219525.27dxschafe"]',
        '1201225541.73dxschafe':
        '["Objects"]["1153777945.95dzlu0"]["Objects"]["1201225541.73dxschafe"]',
        '1201560149.3dxschafe':
        '["Objects"]["1153777945.95dzlu0"]["Objects"]["1201560149.3dxschafe"]'
    }
}
extraInfo = {
    'camPos': Point3(-26.1069, 13.7106, 23.6725),
    'camHpr': VBase3(-145.253, -29.9329, 0),
