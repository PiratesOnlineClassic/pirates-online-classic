...
objectStruct = {
    ...
    'Objects': {'1141410776.53sdnaik': {'Type': 'Region',
        ...
        '1142018473.22dxschafe': {
            ...
            'Scale': VBase3(1.0, 1.0, 1.0),
            'Visual': {'Model': 'models/islands/madre_del_fuego_zero'},
            },
        '1150922126.8dzlu': {
            'Type': 'Island',
            'Name': 'Port Royal',
            ...
            'Objects': {'1152835593.61jubutler': {
                'Type': 'LOD Sphere',
                'Hpr': Point3(133.0, 0.0, 0.0),
                'Pos': Point3(402.2, 358.0, 580.947),
                'Radi': [4377.600582220298, 5000.0, 7573.948791938436],
                'Scale': VBase3(1.0, 1.0, 1.0),
                }},
            'Phase': 1,
        ...
        '1156359855.24bbathen': {
            ...
            'Scale': VBase3(1.0, 1.0, 1.0),
            'Undockable': False,
            'Visual': {'Model': 'models/islands/wild_island_a_zero'},
            },
        '1159933206.48sdnaik': {
            'Type': 'Island',
            'Name': 'Kingshead',
        ...
        '1160614528.73sdnaik': {
            ...
            'Scale': VBase3(1.0, 1.0, 1.0),
            'Undockable': False,
            'Visual': {'Model': 'models/islands/cuba_zero'},
            },
        '1161282725.84kmuller': {
            ...
            'Scale': VBase3(1.0, 1.0, 1.0),
            'Visual': {'Model': 'models/islands/rum_runner_zero'},
            },
        '1164135492.81dzlu': {
            'Type': 'Island',
            'Name': "Devil's Anvil",
            ...
            'Scale': VBase3(1.0, 1.0, 1.0),
            'Visual': {'Model': 'models/islands/wild_island_c_zero'},
            },
        '1164150392.42dzlu': {
            'Type': 'Island',
            'Name': 'Isla Tormenta',
            ...
            'Scale': VBase3(1.0, 1.0, 1.0),
            'Undockable': False,
            'Visual': {'Model': 'models/islands/wild_island_b_zero'},
            },
        '1164157132.99dzlu': {
            'Type': 'Island',
            'Name': 'Isla Perdida',
            ...
            'Scale': VBase3(1.0, 1.0, 1.0),
            'Visual': {'Model': 'models/islands/wild_island_d_zero'},
            },
        '1164763706.66sdnaik': {
            'Type': 'Island',
        ...
        '1173381952.2sdnaik': {
            ...
            'Scale': VBase3(1.0, 1.0, 1.0),
            'Visual': {'Model': 'models/islands/wild_island_e_zero'},
            },
        '1173382404.64sdnaik': {
            'Type': 'Island',
            'Name': 'Cutthroat Isle',
            ...
            'Scale': VBase3(1.0, 1.0, 1.0),
            'Visual': {'Model': 'models/islands/wild_island_f_zero'},
            },
        ...
        '1196970035.53sdnaik': {
            ...
            'Scale': VBase3(1.0, 1.0, 1.0),
            'Undockable': False,
            'Visual': {'Model': 'models/islands/pvp_b_zero'},
            },
        '1196970080.56sdnaik': {
            'Type': 'Island',
            ...
            'Scale': VBase3(1.0, 1.0, 1.0),
            'Undockable': False,
            'Visual': {'Model': 'models/islands/pvp_a_zero'},
            },
        '1201636857.8kmuller': {
            'Type': 'Island',
            'File': 'pvp_rock_big_1',
            'Hpr': VBase3(315.369, 0.0, 0.0),
            'Objects': {'1210981042.09kmuller': {
                'Type': 'LOD Sphere',
                'Hpr': Point3(0.0, 0.0, 0.0),
            ...
            'Scale': VBase3(1.0, 1.0, 1.0),
            'Undockable': True,
            'Visual': {'Model': 'models/islands/pvp_rock_big_zero'},
            },
        '1201641372.09kmuller': {
            'Type': 'Island',
            'File': 'pvp_rock_med_1',
            'Hpr': VBase3(337.38, 0.0, 0.0),
            'Objects': {'1210981113.03kmuller': {
                'Type': 'LOD Sphere',
                'Hpr': Point3(0.0, 0.0, 0.0),
            ...
            'Scale': VBase3(1.0, 1.0, 1.0),
            'Undockable': True,
            'Visual': {'Model': 'models/islands/pvp_rock_med_zero'},
            },
        '1201641393.2kmuller': {
            'Type': 'Island',
            'File': 'pvp_rock_big_3',
            'Hpr': VBase3(333.579, 0.0, 0.0),
            'Objects': {'1210981144.78kmuller': {
                'Type': 'LOD Sphere',
                'Hpr': Point3(0.0, 0.0, 0.0),
        ...
        '1201641487.41kmuller': {
            ...
            'Scale': VBase3(1.0, 1.0, 1.0),
            'Undockable': True,
            'Visual': {'Model': 'models/islands/pvp_rock_sml_zero'},
            },
        '1210197632.0WDIG': {
            'Type': 'Ship Spawn Node',
            'Flagship': True,
    ...
    'Ocean Areas': [
        [Point3(11000, -1000, 0), Point3(-3000, 15000, 0),
         'Windward_Passage', '1180566400.0dxschafe0'],
        [Point3(-29000, 21000, 0), Point3(-15000, 9000, 0),
         'Brigand_Bay', '1180567552.0dxschafe'],
        [Point3(11000, 27000, 0), Point3(-3000, 21000, 0),
         'Blackheart_Strait', '1180568320.0dxschafe'],
        [Point3(13000, 27000, 0), Point3(25000, 15000, 0), 'Salty_Flats'
         , '1180569600.0dxschafe'],
        [Point3(25000, 13000, 0), Point3(13000, -1000, 0),
         'Mar_de_Plata', '1180569728.0dxschafe0'],
        [Point3(17000, -3000, 0), Point3(3000, -15000, 0),
         'Smugglers_Run', '1180570240.0dxschafe'],
        [Point3(19000, -9000, 0), Point3(21000, -15000, 0),
         'Smugglers_Run', '1180570240.0dxschafe0'],
        [Point3(25000, -13000, 0), Point3(23000, -15000, 0),
         'The_Hinterseas', '1180570368.0dxschafe'],
        [Point3(15000, -17000, 0), Point3(25000, -29000, 0),
         'The_Hinterseas', '1180570368.0dxschafe0'],
        [Point3(25000, -11000, 0), Point3(23000, -9000, 0),
         'Mar_de_Plata', '1180570496.0dxschafe'],
        [Point3(19000, -7000, 0), Point3(25000, -3000, 0),
         'Mar_de_Plata', '1180570496.0dxschafe0'],
        [Point3(13000, -23000, 0), Point3(3000, -17000, 0),
         'Boiling_Bay', '1180571008.0dxschafe'],
        [Point3(13000, -25000, 0), Point3(-15000, -29000, 0),
         'Mariners_Reef', '1180571008.0dxschafe0'],
        [Point3(-3000, 19000, 0), Point3(3000, 17000, 0),
         'Blackheart_Strait', '1180571264.0dxschafe'],
        [Point3(5000, 19000, 0), Point3(11000, 17000, 0),
         'Windward_Passage', '1180571776.0dxschafe'],
        [Point3(-13000, 9000, 0), Point3(-5000, 27000, 0),
         'Scurvy_Shallows', '1191538304.0dxschafe'],
        [Point3(-29000, -7000, 0), Point3(-13000, -15000, 0),
         'Dead_Mans_Trough', '1191539072.0dxschafe0'],
        [Point3(-11000, -23000, 0), Point3(1000, -7000, 0),
         'Leeward_Passage', '1191539328.0dxschafe'],
        [Point3(-15000, -17000, 0), Point3(-13000, -23000, 0),
         'Leeward_Passage', '1191539328.0dxschafe0'],
        [Point3(-29000, 7000, 0), Point3(-5000, -5000, 0),
         'Bloody_Bayou', '1191539328.0dxschafe1'],
        [Point3(-3000, -3000, 0), Point3(1000, -5000, 0), 'Bloody_Bayou'
         , '1191539328.0dxschafe2'],
        ],
    'Node Links': [
        ['1185235968.0dxschafe1', '1185235968.0dxschafe0',
         'Bi-directional'],
        ['1185236224.0dxschafe', '1185236224.0dxschafe3',
         'Bi-directional'],
        ['1185236480.0dxschafe', '1185236736.0dxschafe',
         'Bi-directional'],
        ['1185236864.0dxschafe', '1185236480.0dxschafe1',
         'Bi-directional'],
        ['1185237120.0dxschafe2', '1185237120.0dxschafe',
         'Bi-directional'],
        ['1185237248.0dxschafe', '1185237120.0dxschafe1',
         'Bi-directional'],
    ...
    'ObjectIds': {
        ...
        '1152835593.61jubutler': '["Objects"]["1141410776.53sdnaik"]["Objects"]["1150922126.8dzlu"]["Objects"]["1152835593.61jubutler"]',
