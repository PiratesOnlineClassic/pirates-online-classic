# Embedded file name: pirates.leveleditor.worldData.del_fuego_building_int_jeweler_2
...
objectStruct = {
        ...
        '1153778094.12dzlu0': {
            ...
            'Objects': {
                ...
                '1201223902.67dxschafe': {
                    ...
                    'AnimSet': 'default',
                    'CustomModel': 'None',
                    'Hpr': VBase3(-75.735, 0.0, 0.0),
                    'Patrol Radius': '12.0000',
                    'Pos': Point3(9.885, -2.035, 0.0),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'Private Status': 'All',
                    'Respawns': True,
    ...
    'ObjectIds': {
        '1153778094.12dzlu0':
        '["Objects"]["1153778094.12dzlu0"]',
        '1201219847.02dxschafe':
        '["Objects"]["1153778094.12dzlu0"]["Objects"]["1201219847.02dxschafe"]',
        '1201223902.67dxschafe':
        '["Objects"]["1153778094.12dzlu0"]["Objects"]["1201223902.67dxschafe"]'
    }
}
extraInfo = {
    'camPos': Point3(492.998, -1217.75, 91.3245),
    'camHpr': VBase3(-178.528, -41.6261, 0),
