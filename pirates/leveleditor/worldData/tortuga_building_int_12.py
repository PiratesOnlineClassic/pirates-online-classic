# Embedded file name: pirates.leveleditor.worldData.tortuga_building_int_12
...
objectStruct = {
    ...
    'Objects': {
        '1156279216.23dzlu0': {
            ...
            'Name': '',
            'AdditionalData': ['interior_shanty_store_jeweler'],
            'Instanced': True,
            'Objects': {
                ...
                '1201122739.06dxschafe': {
                    ...
                    'DropOff': '0.0000',
                    'FlickRate': '0.5000',
                    'Hpr': VBase3(104.166, -24.966, -1.303),
                    'Intensity': '0.7711',
                    'LightType': 'SPOT',
                    'Pos': Point3(25.833, 5.059, 11.106),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'Visual': {
                        'Color': (1, 1, 1, 1),
    ...
    'ObjectIds': {
        '1156279216.23dzlu0':
        '["Objects"]["1156279216.23dzlu0"]',
        '1196907776.0dxschafe0':
        '["Objects"]["1156279216.23dzlu0"]["Objects"]["1196907776.0dxschafe0"]',
        '1201041268.69dxschafe':
        '["Objects"]["1156279216.23dzlu0"]["Objects"]["1201041268.69dxschafe"]',
        '1201122739.06dxschafe':
        '["Objects"]["1156279216.23dzlu0"]["Objects"]["1201122739.06dxschafe"]'
    }
}
extraInfo = {
    'camPos': Point3(59.7725, -13.2216, 32.2232),
    'camHpr': VBase3(70.3894, -36.1231, -2.11395e-06),
