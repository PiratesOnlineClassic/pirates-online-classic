...
# Embedded file name: pirates.shipparts.DistributedSail
import random
...
class DistributedSail(DistributedShippart.DistributedShippart, DistributedDestructibleObject.DistributedDestructibleObject):
    ...
    def createProp(self):
        ...
        self.ship.sails[self.dna.mastPosIndex][self.dna.posIndex] = [self.prop, self]
    ...
    def getHp(self):
        return [
         self.dna.mastPosIndex, self.dna.posIndex, self.Hp, self.maxHp]
    ...
    def updateSiegeTeam(self):
        ...
        return
# okay decompiling .\pirates\shipparts\DistributedSail.pyc
