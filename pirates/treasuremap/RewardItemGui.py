...
class RewardItemGui(DirectFrame):
    ...
    def __init__(self, item, parent=None, textScale=None, itemHeight=None,
                 **kw):
        if itemHeight == None:
        ...
        optiondefs = (('state', DGG.NORMAL, None), ('frameColor', (0.1, 0.1, 1,
                      ...
                      ('borderWidth', PiratesGuiGlobals.BorderWidth,
                       None), ('frameSize', (0.0, RewardItemGui.Width, 0.0,
                                             itemHeight), None))
    ...
    def _createIface(self):
        ...
        self.descText = DirectLabel(
            ...
            textMayChange=1,
            pos=(0.6, 0, self.getHeight() / 2))
        self.valueText = DirectLabel(
            parent=self,
            relief=None,
            text=str(self.item[1]),
            text_align=TextNode.ARight,
            text_scale=self.textScale,
            text_fg=textFg,
            text_shadow=PiratesGuiGlobals.TextShadow,
            textMayChange=1,
            pos=(1.8, 0, self.getHeight() / 2))
        return
