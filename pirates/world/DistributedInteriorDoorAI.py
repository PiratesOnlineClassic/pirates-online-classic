...
class DistributedInteriorDoorAI(DistributedDoorBaseAI):
    ...
    def handleRequestInteraction(self, avatar, interactType, instant):
        result = DistributedDoorBaseAI.handleRequestInteraction(
            self, avatar, interactType, instant)
        ...
        if not exterior:
            self.notify.warning(
                'Cannot handle avatar %d interact for door %d, exterior %d not found!'
        ...
        if not self.otherDoor:
            self.notify.warning(
                'Cannot handle avatar %d interact for door %d, exterior door not found!'
    ...
    def d_setInteriorId(self, interiorDoId, interiorParentId, interiorZoneId):
        self.sendUpdate('setInteriorId',
                        [interiorDoId, interiorParentId, interiorZoneId])
    ...
    def setExteriorId(self, exteriorDoId, exteriorWorldParentId,
                      exteriorWorldZoneId):
    ...
    def d_setExteriorId(self, exteriorDoId, exteriorWorldParentId,
                        exteriorWorldZoneId):
        self.sendUpdate(
            'setExteriorId',
            [exteriorDoId, exteriorWorldParentId, exteriorWorldZoneId])

    def b_setExteriorId(self, exteriorDoId, exteriorWorldParentId,
                        exteriorWorldZoneId):
        self.setExteriorId(exteriorDoId, exteriorWorldParentId,
                           exteriorWorldZoneId)
        self.d_setExteriorId(exteriorDoId, exteriorWorldParentId,
                             exteriorWorldZoneId)

    def getExteriorId(self):
        return [
            self.exteriorDoId, self.exteriorWorldParentId,
            self.exteriorWorldZoneId
        ]
