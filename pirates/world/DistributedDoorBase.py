...
class DistributedDoorBase(DistributedInteractive.DistributedInteractive):
    ...
    def setMovie(self, mode, avId, timestamp):
        ...
        if mode == PiratesGlobals.DOOR_OPEN and self.hasDoors:
            ...
            self.doorTrack = Sequence(Func(base.playSfx, self.openSfx, node = self.soundNode, volume = 0.7, cutoff = 100), self.openDoorIval, Wait(2.0), self.closeDoorIval, Func(base.playSfx, self.closeSfx, node = self.soundNode, volume = 0.69999999999999996, cutoff = 100))
