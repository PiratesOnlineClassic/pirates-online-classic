...
# Embedded file name: pirates.quest.QuestLadderDB
from pirates.piratesbase import PLocalizer
from pirates.quest import QuestDB
from pirates.quest.QuestConstants import ExpRewards, NPCIds
from pirates.quest.QuestDNA import QuestDNA
from pirates.quest.QuestLadderDNA import (QuestChoiceDNA, QuestChoiceSingleDNA,
                                          QuestLadderDNA)
...
FameQuestLadderDict = {
    ...
    QuestLadderDNA(
        ...
        (QuestLadderDNA(
         ...
         QuestLadderDNA(
             ...
             containers=
             (QuestDB.QuestDict['c2_visit_will_turner'], QuestDB.QuestDict[
                 'c2.2defeatSkeletons'],
              QuestDB.QuestDict[
                  'c2_visit_tia_dalma'], QuestDB.QuestDict['c2.4recoverOrders'],
              QuestDB.QuestDict[
                  'c2.5deliverOrders'], QuestDB.QuestDict['c2.9visitDarby'],
              QuestDB.QuestDict[
         ...
         QuestLadderDNA(
             name='Chapter 3',
             questInt=3900,
             firstQuestId='c3visitJack',
             containers=
             (QuestDB.QuestDict['c3visitJack'], QuestDB.QuestDict[
                 'c3visitJoshamee'],
              QuestChoiceDNA(
                  name
                  =
                  ...
                  containers=
                  (QuestDB.QuestDict['c3r1.1sinkNavyShips'],
              ...
              QuestLadderDNA(
                  ...
                  (QuestLadderDNA(
                      ...
                      =
                      3903,
                      firstQuestId='c3r2r1.1visitScarlet',
                      containers
                      =
                      (QuestDB.QuestDict['c3r2r1.1visitScarlet'], QuestDB.
                       QuestDict[
                           'c3r2r1.3visitCarver'], QuestDB.
                       QuestDict[
                           'c3r2r1.4deliverGrog'],
                       QuestDB.QuestDict[
                           'c3r2r1.5visitCarver'],
                       ...
                       QuestChoiceDNA(
                           ...
                           containers
                           =
                           (QuestDB.QuestDict['c3r2r1r1.1recoverClaw'], QuestDB.
                            QuestDict[
                                'c3r2r1r1.2recoverRod'],
                            QuestDB.
                            QuestDict['c3r2r1r1.3recoverBlood']
                           )),
                       QuestDB.QuestDict[
                           'c3r2r1.7visitCarver'],
                       QuestDB.QuestDict[
                       ...
                       QuestChoiceDNA(
                           ...
                           containers
                           =
                           (QuestDB.QuestDict['c3r2r1r2.1Carrou'], QuestDB.QuestDict[
                               'c3r2r1r2.2DArcis'],
                            QuestDB.
                            QuestDict['c3r2r1r2.3Coteau']
                           )),
                       QuestDB.QuestDict[
                           'c3r2r1.13visitGrog'],
                       QuestChoiceDNA(
                           ...
                           containers
                           =
                           (QuestDB.QuestDict['c3r2r1r3.1Guano'], QuestDB.QuestDict[
                               'c3r2r1r3.2Hair'], QuestDB.QuestDict[
                                   'c3r2r1r3.3Blood'])),
                       QuestDB.QuestDict[
                       ...
                       (QuestDB.QuestDict['c3r2r2.1visitGreer'],
                        ...
                        QuestChoiceSingleDNA(
                            ...
                            =(QuestLadderDNA(
                                ...
                                containers
                                =
                                (QuestDB.QuestDict['c3r2r2r8r1.1visitSmitty'],
                                 QuestChoiceDNA(
                                     name
                                     =
                              ...
                              QuestLadderDNA(
                                  ...
                                  containers
                                  =(QuestDB.QuestDict[
                                      'c3r2r2r8r2.1visitCraven'], QuestDB.
                                    QuestDict[
                                        'c3r2r2r8r2.1.5bribeCraven'], QuestDB.
                                    QuestDict['c3r2r2r8r2.2sinkShips'], QuestDB.
                                    QuestDict['c3r2r2r8r2.3sinkNavyShips'],
                                    QuestDB.
                                    QuestDict['c3r2r2r8r2.4deliverPlates'])),
                              QuestLadderDNA(
                                  name='c3r2r2r8r3Chickens',
                                  questInt
                                  =3912,
                                  firstQuestId=
                                  ...
                                  containers
                                  =(QuestDB.QuestDict[
                                      'c3r2r2r8r3.1recoverChickens'], QuestDB.
                                    QuestDict[
                                        'c3r2r2r8r3.2recoverChickens'], QuestDB.
                                    QuestDict['c3r2r2r8r3.3deliverEggs'],
                                    QuestDB.
                                    QuestDict['c3r2r2r8r3.4visitJune'])))),
                        QuestChoiceSingleDNA(
                            name='c3r2r2r8JunesList2',
                            questInt=
                            3047,
                            firstQuestId='c3r2r2r8.4recoverPig',
                            containers
                            =(QuestDB.QuestDict['c3r2r2r8.4recoverPig'],
                              QuestLadderDNA(
                                  name='c3r2r2r8r5Necklace',
                                  questInt
                                  =3913,
                                  firstQuestId
                                  ...
                                  containers=
                                  (QuestDB.QuestDict[
                                      'c3r2r2r8r5.1visitLucinda'], QuestDB.
                                   QuestDict['c3r2r2r8r5.1.5bribeLucinda'],
                                   QuestChoiceDNA(
                                       name='c3r2r2r8r5r2NecklaceMaterials',
                                       questInt
                                       =3914,
                                       giverId=
                                       NPCIds.LUCINDA,
                                       ...
                                       (QuestDB.QuestDict[
                                        ...
                                        QuestDB.
                                        QuestDict['c3r2r2r8r5r2.2recoverTeeth']
                                       )),
                                   QuestDB.
                                   QuestDict['c3r2r2r8r5.3deliverNecklace'])),
                              QuestLadderDNA(
                                  name='c3r2r2r8r6Doll',
                                  questInt
                                  =3915,
                                  ...
                                  (QuestDB.QuestDict['c3r2r2r8r6.1visitGreer'],
                                   QuestDB.
                                   QuestDict['c3r2r2r8r6.2visitMallet'],
                                   QuestDB.
                                   QuestDict['c3r2r2r8r6.3visitFabiola'],
                                   QuestDB.
                                   QuestDict['c3r2r2r8r6.3.5bribeFabiola'],
                                   QuestChoiceDNA(
                                       name='c3r2r2r8r6r4CurseCure',
                                       questInt
                                       =3916,
                                       giverId=
                                       NPCIds.FABIOLA,
                                       ...
                                       (QuestDB.QuestDict[
                                        ...
                                        QuestDB.
                                        QuestDict['c3r2r2r8r6r4.3recoverPoison']
                                       )),
                                   QuestChoiceDNA(
                                       name='c3r2r2r8r6r4CurseCure2',
                                       questInt
                                       =3049,
                                       giverId=
                                       NPCIds.FABIOLA,
                                       ...
                                       (QuestDB.QuestDict[
                                        ...
                                        QuestDB.
                                        QuestDict['c3r2r2r8r6r4.5recoverMud'])),
                                   QuestDB.
                                   QuestDict['c3r2r2r8r6.5deliverRemedy'],
                                   QuestDB.
                                   QuestDict['c3r2r2r8r6.6visitCarver'],
                                   QuestDB.
                                   QuestDict['c3r2r2r8r6.7deliverGrog'],
                                   QuestDB.
                                   QuestDict['c3r2r2r8r6.8deliverDoll'])))),
                        QuestChoiceSingleDNA(
                            name='c3r2r2r8JunesList3',
                            questInt=
                            3048,
                            firstQuestId='c3r2r2r8r8Parrot',
                            containers=(QuestLadderDNA(
                                name='c3r2r2r8r8Parrot',
                                questInt=
                                3917,
                                firstQuestId=
                                'c3r2r2r8r8.1visitGreer',
                                containers=
                                (QuestDB.QuestDict['c3r2r2r8r8.1visitGreer'],
                                 QuestDB.QuestDict[
                                     'c3r2r2r8r8.2visitOrinda'],
                                 QuestDB.QuestDict[
                                     'c3r2r2r8r8.3visitTomas'],
                                 QuestChoiceSingleDNA(
                                     name='c3r2r2r8r8r4Honey',
                                     questInt=
                                     3918,
                                     firstQuestId
                        ...
                        QuestChoiceSingleDNA(
                            name='c3r2r2r10GreersWrongs',
                            questInt=3922,
                            firstQuestId='c3r2r2r10r1Bowdash',
                            containers=(
                                QuestLadderDNA(
                                    name='c3r2r2r10r1Bowdash',
                                    questInt=3923,
                                ...
                                QuestLadderDNA(
                                    name='c3r2r2r10r2Grog',
                                    questInt=3924,
                                    firstQuestId='c3r2r2r10r2.1visitGrog',
                                    containers=
                                    (QuestDB.
                                     QuestDict['c3r2r2r10r2.1visitGrog'],
                                     QuestChoiceDNA(
                                         name='c3r2r2r10r2r2Remedy',
                                         questInt=3925,
                   ...
                   QuestLadderDNA(
                       ...
                       (QuestDB.QuestDict['c3r2r3.1visitScarlet'],
                        ...
                        QuestChoiceSingleDNA(
                            ...
                            containers=(
                                QuestDB.QuestDict['c3r2r3r1.1RecoverSkeletons'],
                                QuestLadderDNA(
                                    name='c3r2r3r1r2Cufflinks',
                                    questInt=3930,
                        ...
                        QuestChoiceSingleDNA(
                            name='c3r2r3r1Pearls2',
                            questInt=3030,
                            firstQuestId='c3r2r3r1.4recoverNavy',
                            containers=
                            (QuestDB.QuestDict['c3r2r3r1.4recoverNavy'],
                             QuestLadderDNA(
                                 name='c3r2r3r1r5Smuggler',
                                 questInt=3931,
                        ...
                        QuestLadderDNA(
                            name='c3r2r3r1r7Alberto',
                            questInt=3934,
                            firstQuestId='c3r2r3r1r7.1visitMallet',
                            containers=(
                                QuestDB.QuestDict['c3r2r3r1r7.1visitMallet'],
                   ...
                   QuestLadderDNA(
                       ...
                       containers=(
                           ...
                           QuestChoiceSingleDNA(
                               name='c3r2r5r2Medicine',
                               questInt=3941,
                               firstQuestId='c3r2r5r2r1KrakenEye',
                               containers=(QuestLadderDNA(
                                   name='c3r2r5r2r1KrakenEye',
                                   questInt=3942,
                           ...
                           QuestChoiceDNA(
                               name='c3r2r5r2Medicine2',
                               questInt=3031,
                               giverId=NPCIds.DOC_GROG,
                               containers=(
                                   QuestDB.QuestDict['c3r2r5r2.4recoverGuano'],
                                   QuestDB.QuestDict[
                                       'c3r2r5r2.5recoverSplinter'],
                                   QuestDB.QuestDict['c3r2r5r2.6recoverDust'])),
                           QuestChoiceDNA(
                               name='c3r2r5r2Medicine3',
                               questInt=3032,
                               giverId=NPCIds.DOC_GROG,
                               containers=(
                                   QuestDB.QuestDict['c3r2r5r2.7recoverEarth'],
                                   QuestDB.QuestDict[
                                       'c3r2r5r2.8recoverLichens'],
                                   QuestDB.QuestDict['c3r2r5r2.9recoverWater']
                               )),
                           QuestChoiceDNA(
                               name='c3r2r5r2Medicine4',
                               questInt=3034,
                               giverId=NPCIds.DOC_GROG,
                               containers=(
                                   QuestDB.QuestDict['c3r2r5r2.10recoverEggs'],
              ...
              QuestLadderDNA(
                  ...
                  containers=(QuestLadderDNA(
                      name='c3r3r1Gunner',
                      questInt=3944,
                      firstQuestId='c3r3r1.1visitOrinda',
                      containers=(
                          ...
                          QuestLadderDNA(
                              ...
                              containers=(
                                  ...
                                  QuestLadderDNA(
                                      name='c3r3r1r13r4makeRum',
                                      questInt=3950,
                                      firstQuestId='c3r3r1r13r4.1recoverLadle',
                                      containers
                                      =(QuestDB.
                                        QuestDict['c3r3r1r13r4.1recoverLadle'],
                                        QuestChoiceDNA(
                                            name='c3r3r1r13r4r2makeGrog',
                                            questInt=3951,
                                        ...
                                        QuestChoiceDNA(
                                            name='c3r3r1r13r4r3makeLightRum',
                                            questInt=3952,
                                            giverId=NPCIds.GUNNER,
                                            containers=
                                            (QuestDB.
                          ...
                          QuestChoiceSingleDNA(
                              name='c3r3r1r21skeletonRum',
                              questInt=3954,
                              firstQuestId='c3r3r1r21r1makeSkeletonRum',
                              containers=(QuestLadderDNA(
                                  name='c3r3r1r21r1makeSkeletonRum',
                                  questInt=3955,
                                  firstQuestId='c3r3r1r21r1.1visitRomany',
                                  containers=
                                  (QuestDB.
                                   QuestDict['c3r3r1r21r1.1visitRomany'],
                                   QuestChoiceDNA(
                                       name='c3r3r1r21r1r2ingredients',
                                       questInt=3956,
                          ...
                          QuestChoiceSingleDNA(
                              name='c3r3r1r25SingaporeanRum',
                              questInt=3957,
                              firstQuestId='c3r3r1r25r1makeSingaporeanRum',
                              containers=(QuestLadderDNA(
                                  name='c3r3r1r25r1makeSingaporeanRum',
                                  questInt=3958,
                                  firstQuestId='c3r3r1r25r1.1visitCarver',
                                  containers=
                                  (QuestDB.
                                   QuestDict['c3r3r1r25r1.1visitCarver'],
                                   QuestDB.QuestDict[
                                       'c3r3r1r25r1.2deliverPint'],
                                   QuestChoiceDNA(
                                       name='c3r3r1r25r1r3ingredients',
                                       questInt=3959,
                                       giverId=NPCIds.JOSHAMEE,
                                       containers=(
                                           QuestDB.QuestDict[
                          ...
                          QuestChoiceSingleDNA(
                              name='c3r3r1r28makeVoodooRum2',
                              questInt=3035,
                              firstQuestId='c3r3r1r28r4hairballs',
                              containers=(
                                  QuestLadderDNA(
                                      name='c3r3r1r28r4hairballs',
                                      questInt=3962,
                          ...
                          QuestChoiceSingleDNA(
                              name='c3r3r1r31twentyFiveRum',
                              questInt=3963,
                              firstQuestId='c3r3r1r31r1Joshamee',
                              containers=(
                                  QuestLadderDNA(
                                      name='c3r3r1r31r1Joshamee',
                                      questInt=3964,
                                  ...
                                  QuestLadderDNA(
                                      name='c3r3r1r31r2Fernando',
                                      questInt=3965,
                                      firstQuestId='c3r3r1r31r2.1visitFernando',
                                      containers=
                                      (QuestDB.
                                       QuestDict['c3r3r1r31r2.1visitFernando'],
                                       QuestChoiceDNA(
                                           name='c3r3r1r31r2r2chores',
                                           questInt=3966,
                          ...
                          QuestDB.QuestDict['c3r3r1.53visitJoshamee'])),
                              ...
                              QuestLadderDNA(
                                  ...
                                  =(QuestDB.QuestDict['c3r3r3.1visitCarver'],
                                    ...
                                    QuestChoiceSingleDNA(
                                        ...
                                        containers=
                                        (QuestDB.
                                         QuestDict['c3r3r3r7.4recoverWater'],
                                         QuestLadderDNA(
                                             name='c3r3r3r7r5cryptWater',
                                             questInt=3974,
                                             firstQuestId=
                              ...
                              QuestLadderDNA(
                                  ...
                                  =(QuestDB.QuestDict['c3r3r4.1visitBowdash'],
                                    ...
                                    QuestChoiceSingleDNA(
                                        name='c3r3r4r3starboardHull',
                                        questInt=3990,
                                        firstQuestId='c3r3r4r3r1build',
                                        containers=(QuestLadderDNA(
                                            name='c3r3r4r3r1build',
                                            questInt=3991,
                                            firstQuestId=
                                    ...
                                    QuestChoiceSingleDNA(
                                        name='c3r3r4r4portHull',
                                        questInt=3995,
                                        firstQuestId='c3r3r4r4r1build',
                                        containers=(QuestLadderDNA(
                                            name='c3r3r4r4r1build',
                                            questInt=3996,
                                            firstQuestId=
    ...
    QuestLadderDNA(
        ...
        containers=(
            QuestDB.QuestDict['wd.1visitTia'],
            QuestChoiceDNA(
                name='wdr2Materials',
                questInt=19901,
    ...
    QuestLadderDNA(
        ...
        containers=(QuestDB.QuestDict['wk.1visitElizabeth'],
    ...
    QuestLadderDNA(
        ...
        containers=(QuestDB.QuestDict['wg.1visitJack'],
    ...
    QuestLadderDNA(
        ...
        containers=(QuestDB.QuestDict['ws.1visitTia'],
                    QuestChoiceDNA(
                        name='wsr2Heart',
                        questInt=19951,
                        giverId=NPCIds.TIA_DALMA,
                    ...
                    QuestChoiceDNA(
                        ...
                        questInt=19952,
                        giverId=NPCIds.TIA_DALMA,
                        containers=(QuestDB.QuestDict['wsr3.1defeatWasp'],
    ...
    QuestLadderDNA(
        ...
        containers=(
            ...
            QuestChoiceDNA(
                name='vdul5r2FirstGeneral',
                questInt=2353,
                giverId=NPCIds.TIA_DALMA,
                containers=(
                    QuestDB.QuestDict['vdul5r2.1defeatUndead'],
                    QuestDB.QuestDict['vdul5r2.2defeatGeneralBloodless'])),
            QuestChoiceDNA(
                name='vdul5r3SecondGeneral',
                questInt=2354,
                giverId=NPCIds.TIA_DALMA,
                containers=(QuestDB.QuestDict['vdul5r3.1defeatUndead'],
                            QuestDB.QuestDict['vdul5r3.2defeatGeneralHex'])),
            QuestChoiceDNA(
                name='vdul5r4ThirdGeneral',
                questInt=2355,
                giverId=NPCIds.TIA_DALMA,
                containers=(
                    QuestDB.QuestDict['vdul5r4.1defeatUndead'],
                    QuestDB.QuestDict['vdul5r4.2defeatGeneralSandspine'])),
            QuestChoiceDNA(
                name='vdul5r2FinalGeneral',
                questInt=2356,
                giverId=NPCIds.TIA_DALMA,
                containers=(
                    QuestDB.QuestDict['vdul5r5.1defeatUndead'],
    ...
    QuestLadderDNA(
        ...
        containers=(
            ...
            QuestChoiceDNA(
                name='vsul5r1EITCItems',
                questInt=2501,
                giverId=NPCIds.ROLAND_RAGGART,
                containers=(
                    QuestDB.QuestDict['vsul5r1.1acquireEITCBadge'],
                    QuestDB.QuestDict['vsul5r1.2acquireGoldHandleRapier'])),
            QuestChoiceDNA(
                name='vsul5r2VariousEITC',
                questInt=2502,
                giverId=NPCIds.ROLAND_RAGGART,
    ...
    QuestLadderDNA(
        ...
        droppable=False,
        containers=(QuestDB.QuestDict['dul5.1visitFerrar'],
    ...
    QuestLadderDNA(
        ...
        containers=(
            ...
            QuestChoiceDNA(
                ...
                giverId=NPCIds.ERASMUS_GRIMSDITCH,
                containers=(
                    QuestDB.QuestDict['pul5r1.1acquireCopper'],
...
FortuneQuestLadderDict = {
    ...
    QuestLadderDNA(
        name='TreasureTeeth2',
        questInt=19910,
        firstQuestId='tt2.1deliverTeeth',
    ...
    QuestLadderDNA(
        name='TreasureMedals',
        questInt=19911,
        firstQuestId='tm.1visitWill',
        containers=(QuestDB.QuestDict['tm.1visitWill'],)),
    'TreasureMedals2':
    QuestLadderDNA(
        name='TreasureMedals2',
        questInt=19912,
        firstQuestId='tm2.1deliverMedals',
    ...
    QuestLadderDNA(
        name='TreasureRings2',
        questInt=19914,
        firstQuestId='trr2.1deliverRings',
    ...
    QuestLadderDNA(
        name='TreasureChess2',
        questInt=19916,
        firstQuestId='tc2.1deliverChess',
        containers=(QuestDB.QuestDict['tc2.1deliverChess'],)),
    'TreasureFigurines':
    QuestLadderDNA(
        name='TreasureFigurines',
        questInt=19917,
        firstQuestId='tf.1visitTia',
        containers=(QuestDB.QuestDict['tf.1visitTia'],)),
    'TreasureFigurines2':
    QuestLadderDNA(
        name='TreasureFigurines2',
        questInt=19918,
        firstQuestId='tf2.1deliverFigurines',
    ...
    'TPT_PortRoyalUnlock':
    QuestLadderDNA(
        name='TPT_PortRoyalUnlock',
        questInt=19730,
        firstQuestId='tptpr.1visitLucinda',
    ...
    QuestLadderDNA(
        name='TPT_CubaUnlock',
        questInt=19740,
        firstQuestId='tptc.1visitTiaDalma',
        containers=(
            QuestDB.QuestDict['tptc.1visitTiaDalma'],
            QuestChoiceDNA(
                name='tptcPayment',
                questInt=19741,
                giverId=NPCIds.TIA_DALMA,
    ...
    QuestLadderDNA(
        name='TPT_PadresDelFuegoUnlock',
        questInt=19750,
        firstQuestId='tptpdf.1visitRomany',
        containers=(
            QuestDB.QuestDict['tptpdf.1visitRomany'],
            QuestChoiceDNA(
                name='tptpdfPayment',
                questInt=19751,
                giverId=NPCIds.ROMANY_BEV,
    ...
    'PortRoyalPCTier1':
    QuestLadderDNA(
        name='PortRoyalPCTier1',
        questInt=19940,
        giverId=NPCIds.SHANE_MCGREENY,
    ...
    'PortRoyalPCTier2':
    QuestLadderDNA(
        name='PortRoyalPCTier2',
        questInt=19760,
        giverId=NPCIds.SHANE_MCGREENY,
        firstQuestId='cards.prt2.recoverNavyMuskets',
        containers=(
            QuestDB.QuestDict['cards.prt2.recoverNavyMuskets'],
            QuestChoiceDNA(
                name='PortRoyalPCTier2Tasks',
                questInt=19761,
                giverId=NPCIds.SHANE_MCGREENY,
    ...
    'PortRoyalPCTier3':
    QuestLadderDNA(
        name='PortRoyalPCTier3',
        questInt=19944,
        giverId=NPCIds.SHANE_MCGREENY,
        firstQuestId='cards.prt3.stealGuardSchedule',
        containers=(QuestDB.QuestDict['cards.prt3.stealGuardSchedule'],
    ...
    QuestLadderDNA(
        ...
        droppable=True,
        containers=(QuestDB.QuestDict['pc.1visitSam'],
    ...
    'SeabonesErrand2':
    QuestLadderDNA(
        name='SeabonesErrand2',
        questInt=19941,
        giverId=NPCIds.SAM_SEABONES,
        droppable=True,
        containers=(QuestDB.QuestDict['0'],)),
    'SeabonesErrand3':
    QuestLadderDNA(
        name='SeabonesErrand3',
        questInt=19942,
        giverId=NPCIds.SAM_SEABONES,
        droppable=True,
    ...
    'SeabonesErrand4':
    QuestLadderDNA(
        name='SeabonesErrand4',
        questInt=19943,
        giverId=NPCIds.SAM_SEABONES,
        droppable=True,
        containers=(QuestDB.QuestDict['2'],)),
    'PerlaAlodiaJewels':
    QuestLadderDNA(
        ...
        droppable=True,
        containers=(QuestDB.QuestDict['pa1.trackDownJewels'],
    ...
    QuestLadderDNA(
        ...
        droppable=True,
        containers=(QuestDB.QuestDict['dm2.recoverShopApplication'],
                    ...
                    QuestChoiceDNA(
                        name='dm2.recoverHides',
                        questInt=24714,
                        giverId=NPCIds.SEAMSTRESS_ANNE,
                        containers=(
                            QuestDB.QuestDict['dm2.recoverAlligatorHides'],
    ...
    QuestLadderDNA(
        ...
        containers=(
            ...
            QuestChoiceDNA(
                name='js1.defeatWavemongersList',
                questInt=24213,
    ...
    QuestLadderDNA(
        ...
        droppable=True,
        containers=(QuestDB.QuestDict['js2.visitSmitty'],
                    QuestDB.QuestDict['js2.deliverBloodSample'],
                    QuestDB.QuestDict['js2.deliverList'],
                    QuestDB.QuestDict['js2.bribeEdward'],
                    QuestChoiceDNA(
                        name='js2.gatherMedicalSupplies',
                        questInt=24808,
                        giverId=NPCIds.SARAH,
                        containers=(
                            QuestDB.QuestDict['js2.recoverMedicine'],
    ...
    QuestLadderDNA(
        ...
        droppable=True,
        containers=(QuestDB.QuestDict['sd1.visitLucinda'],
                    QuestChoiceDNA(
                        name='sd1.collectingIngredients',
                        questInt=24315,
                        giverId=NPCIds.LUCINDA,
    ...
    QuestLadderDNA(
        ...
        droppable=True,
        containers=(QuestDB.QuestDict['sd2.deliverTattooPattern'],
    ...
    QuestLadderDNA(
        ...
        containers=(
            ...
            QuestChoiceDNA(
                name='mc1.ShochettsList',
                questInt=24515,
                giverId=NPCIds.SHOCHETT_PRYMME,
                containers=(QuestDB.QuestDict['mc1.defeatSkeletons'],
    ...
    QuestLadderDNA(
        ...
        droppable=True,
        containers=(QuestDB.QuestDict['mc2.visitFernando'],
                    ...
                    QuestChoiceDNA(
                        name='mc2.tattooInfection',
                        questInt=24909,
                        giverId=NPCIds.MERCEDES_CORAZON,
                        containers=(
                            QuestDB.QuestDict['mc2.recoverBarnacles'],
    ...
    QuestLadderDNA(
        ...
        droppable=False,
        containers=(QuestDB.QuestDict['wt1.visitWillTurner'],
                    ...
                    QuestChoiceDNA(
                        name='recoverLorePages',
                        questInt=25409,
                        giverId=NPCIds.WILL_TURNER,
                        containers=(
                            QuestDB.QuestDict['wt1.recoverLorePagesA'],
                    ...
                    QuestChoiceDNA(
                        name='PuttingItAllTogether',
                        questInt=25423,
                        giverId=NPCIds.WILL_TURNER,
                        containers=(
                            QuestDB.QuestDict['wt1.recoverRestOfBookA'],
    ...
    QuestLadderDNA(
        ...
        droppable=False,
        containers=(QuestDB.QuestDict['jw1.visitJohnWallace'],
                    ...
                    QuestChoiceDNA(
                        name='BladeIngredients',
                        questInt=25320,
                        giverId=NPCIds.JOHN_WALLACE,
                        containers=(
                            QuestDB.QuestDict['jw1.recoverCursedWood'],
    ...
    QuestLadderDNA(
        ...
        droppable=False,
        containers=(QuestDB.QuestDict['at1.0visitThayer'],
                    ...
                    QuestChoiceDNA(
                        name='StoreEndorsement',
                        questInt=25217,
                        giverId=NPCIds.ALEXANDER_THAYER,
                        containers=(
                            QuestDB.QuestDict['at1.defeatBigAlligators'],
    ...
    QuestLadderDNA(
        ...
        containers=(
            ...
            QuestChoiceDNA(
                name='ConstructDestructionSpell',
                questInt=4102,
                giverId=NPCIds.TIA_DALMA,
                containers=(
    ...
    QuestLadderDNA(
        ...
        containers=(
            ...
            QuestChoiceDNA(
                name='SpecialVisionSpell',
                questInt=4146,
                giverId=NPCIds.ROLAND_RAGGART,
                containers=(
                    QuestDB.QuestDict['vsu4r1.1acquireGatorEyes'],
            ...
            QuestChoiceDNA(
                name='ExtractionSpell',
                questInt=4147,
                giverId=NPCIds.ROLAND_RAGGART,
                containers=(
                    QuestDB.QuestDict['vsu4r2.1acquireSkeletonRibs'],
            ...
            QuestChoiceDNA(
                name='FurtherExtraction',
                questInt=4148,
                giverId=NPCIds.ROLAND_RAGGART,
                containers=(
                    QuestDB.QuestDict['vsu4r3.1acquireStumpBranch'],
    ...
    QuestLadderDNA(
        ...
        droppable=True,
        containers=(QuestDB.QuestDict['spanish.ShipPVPTaskA'],
                    QuestChoiceDNA(
                        name='spanish.ShipPVPTaskB_C',
                        questInt=28001,
                        giverId=NPCIds.GARCIA_DE_AVARCIA,
    ...
    QuestLadderDNA(
        ...
        droppable=True,
        containers=(QuestDB.QuestDict['french.ShipPVPTaskA'],
                    QuestChoiceDNA(
                        name='french.ShipPVPTaskB_C',
                        questInt=29001,
                        giverId=NPCIds.PIERRE_LE_PORC,
    ...
    QuestLadderDNA(
        ...
        droppable=False,
        containers=(QuestDB.QuestDict['om1.visitWoodruff'],
                    ...
                    QuestChoiceDNA(
                        name='om1.defeatSpanishUndead',
                        questInt=30010,
                        giverId=NPCIds.WOODRUFF,
                        containers=(
                            QuestDB.QuestDict['om1.defeatSpanishUndeadA'],
                    ...
                    QuestChoiceDNA(
                        name='om1.defeatSpanishShips',
                        questInt=30014,
                        giverId=NPCIds.WOODRUFF,
                        containers=(
                            QuestDB.QuestDict['om1.defeatSpanishShipA'],
    ...
    QuestLadderDNA(
        ...
        containers=(
            QuestDB.QuestDict['FathersDay2008.1visitGiladoga'],
            QuestChoiceDNA(
                name='FathersDay2008.2giladogaList',
                questInt=10008,
                giverId=NPCIds.GILADOGA,
                containers=(
                    QuestDB.QuestDict['FathersDay2008t1.1RockCrabs'],
    ...
    QuestLadderDNA(
        ...
        containers=(
            ...
            QuestChoiceDNA(
                ...
                giverId=NPCIds.DARBY_DRYDOCK,
                containers=(
                    QuestDB.QuestDict['OQB.retrievePlanksFromNavyShips'],
            ...
            QuestChoiceDNA(
                name='PlunderingTasksA',
                questInt=30310,
                giverId=NPCIds.NATHANIEL_TRUEHOUND,
                containers=(
                    QuestDB.QuestDict['OQB.retrieveClothFromNavyShip'],
            ...
            QuestChoiceDNA(
                name='PlunderingTasksB',
                questInt=30311,
                giverId=NPCIds.BARTHOLOMEW_WATKINS,
                containers=(
                    QuestDB.QuestDict['OQB.retrieveCursedSailClothFromUndead'],
    ...
    QuestLadderDNA(
        ...
        containers=(QuestDB.QuestDict['OQA.visitRomanyBev'],
                    ...
                    QuestChoiceDNA(
                        name='ShirtVestIngredientsA',
                        questInt=30208,
                        giverId=NPCIds.ADORIA_DOLORES,
                        containers=(
                            QuestDB.QuestDict['OQA.recoverButtons'],
                            QuestDB.QuestDict['OQA.recoverBoneDust'],
                            QuestDB.QuestDict['OQA.recoverHides'],
                            QuestDB.QuestDict['OQA.recoverCursedBark'])),
                    QuestChoiceDNA(
                        name='ShirtVestIngredientsB',
                        questInt=30213,
                        giverId=NPCIds.ADORIA_DOLORES,
                        containers=(
                            QuestDB.QuestDict['OQA.recoverCursedCloth'],
                    ...
                    QuestChoiceDNA(
                        name='recoverVoodooArtifacts',
                        questInt=30221,
                        giverId=NPCIds.ROMANY_BEV,
                        containers=(
                            QuestDB.QuestDict['OQA.recoverVoodooArtifactsA'],
                            QuestDB.QuestDict['OQA.recoverVoodooArtifactsB'])),
                    QuestDB.QuestDict['OQA.visitMaggieRigrage'],
                    QuestChoiceDNA(
                        name='recoverFamilyHeirloomsFromShips',
                        questInt=30226,
                        giverId=NPCIds.MAGGIE_RIGRAGE,
                        containers=(
                            QuestDB.QuestDict['OQA.recoverFamilyHeirloomsA'],
                            QuestDB.QuestDict['OQA.recoverFamilyHeirloomsB'],
                            QuestDB.QuestDict['OQA.recoverFamilyHeirloomsC'])),
                    QuestChoiceDNA(
                        name='recoverFamilyHeirloomsFromLand',
                        questInt=30229,
                        giverId=NPCIds.MAGGIE_RIGRAGE,
                        containers=(
                            QuestDB.QuestDict['OQA.recoverFamilyHeirloomsD'],
                    ...
                    QuestChoiceDNA(
                        name='recoverTentacles',
                        questInt=30264,
                        giverId=NPCIds.ADORIA_DOLORES,
                        containers=(
                            QuestDB.QuestDict['OQA.recoverTentaclesA'],
...
# okay decompiling .\pirates\quest\QuestLadderDB.pyc
