...
class LocationIds:
    ...
    LocationDefs = {
        ...
        PORT_ROYAL_ALL: (PORT_ROYAL_ISLAND, PORT_ROYAL_PORT, PORT_ROYAL_FORT_CHARLES, PORT_ROYAL_CAVE_A, PORT_ROYAL_CAVE_B, PORT_ROYAL_JUNGLE_A, PORT_ROYAL_JUNGLE_B, PORT_ROYAL_JUNGLE_C, GOVERNORS_MANSION, PORT_ROYAL_GRAVEYARD, PORT_ROYAL_DINGHY),
        ...
        ANY_LARGE_ISLAND: (PORT_ROYAL_ISLAND, TORTUGA_ISLAND, DEL_FUEGO_ISLAND, CUBA_ISLAND, KINGSHEAD_ISLAND),
...
class PropIds:
    ...
    PropDefs = {
        ...
        FC_BARRELS: (FC_BARREL_EASY_1, FC_BARREL_EASY_2, FC_BARREL_EASY_3, FC_BARREL_EASY_4, FC_BARREL_MED_1, FC_BARREL_MED_2, FC_BARREL_MED_3, FC_BARREL_MED_4),
        ...
        FC_CRATES: (FC_CRATE_EASY_1, FC_CRATE_EASY_2, FC_CRATE_MED_1, FC_CRATE_MED_2, FC_CRATE_MED_3, FC_CRATE_MED_4, FC_CRATE_MED_5),
        ...
        FD_ALL: (FD_CRATE_EASY_1, FD_CRATE_MED_1, FD_CRATE_MED_2, FD_CRATE_MED_3, FD_CRATE_MED_4, FD_CRATE_MED_5, FD_BARREL_EASY_1, FD_BARREL_EASY_2, FD_BARREL_EASY_3, FD_BARREL_EASY_4, FD_BARREL_EASY_5, FD_BARREL_EASY_6, FD_BARREL_MED_1, FD_BARREL_MED_2, FD_BARREL_MED_3, FD_BARREL_MED_4),
...
class TreasureIds:
    ...
    TreasureDefs = {
        ...
        PR_ROYAL_CAVERNS_CHESTS: (PR_ROYAL_CAVERNS_CHEST_1, PR_ROYAL_CAVERNS_CHEST_2, PR_ROYAL_CAVERNS_CHEST_3, PR_ROYAL_CAVERNS_CHEST_4, PR_ROYAL_CAVERNS_CHEST_5),
        ...
        T_CHESTS: (T_CHEST_5, T_CHEST_6, T_CHEST_7, T_CHEST_8, T_CHEST_9, T_CHEST_10),
