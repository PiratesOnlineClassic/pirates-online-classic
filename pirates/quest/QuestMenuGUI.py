        ...
        for i, offer in zip(range(len(offers)), offers):
            if i == 0:
                ...
                if i == 1:
                    ...
                    z -= 0.105
            if offer.questId in PLocalizer.QuestStrings and 'title' in PLocalizer.QuestStrings[offer.questId].keys():
...
# okay decompiling .\pirates\quest\QuestMenuGUI.pyc
