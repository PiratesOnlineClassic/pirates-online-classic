...
# Embedded file name: pirates.piratesbase.PiratesAmbientManager
...
class PiratesAmbientManager(AmbientManagerBase.AmbientManagerBase):
    ...
    def __init__(self):
        ...
        self.volumeModifierDict = {'jungle': 0.6, 'swamp': 0.75, 'jail_interior': 1.25}
...
# okay decompiling .\pirates\piratesbase\PiratesAmbientManager.pyc
