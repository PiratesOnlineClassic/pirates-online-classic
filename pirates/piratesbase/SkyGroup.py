...
class SkyGroup(NodePath):
    ...
    def __init__(self):
        ...
        self.skySettings = {
          PiratesGlobals.TOD_DAWN: [(self.texTransparent, '', VBase4(0, 0, 0, 0), VBase4(0.8, 0.5, 0.2, 1)), (self.texOpaque, '', VBase4(0, 0, 0, 0), VBase4(0.4, 0.58, 0.6, 1)), VBase4(0.8, 0.8, 0.6, 1), VBase4(0.3, 0.2, 0.15, 1)],
