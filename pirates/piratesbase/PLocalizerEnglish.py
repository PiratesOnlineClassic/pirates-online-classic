...
CRBootedReasons = {
    ...
    153:
    'The world you were playing on has been reset.  Everyone who was playing on that world has been disconnected.  However, you should be able to connect again and go right back into the game.',
    288:
...
MakeAPiratePageNames = [
    'Body', 'Head', 'Mouth', 'Eyes', 'Nose', 'Ear', 'Hair', 'Clothes', 'Name',
    'Tattoos', 'Jewelry'
]
...
DiceText_DiceUp_Chat = [
    'Higher than that', 'Up ye vermin!', 'Perhaps some more', 'Up we go'
]
DiceText_DiceUp_Size = len(DiceText_DiceUp_Chat) - 1
DiceText_DiceDown_Chat = [
    'Whoa, too high', 'Maybe a wee bit less', 'Not so much then'
]
DiceText_DiceDown_Size = len(DiceText_DiceDown_Chat) - 1
DiceText_Roll_Chat = [
    'Gimme a winner!', 'No tricks now you scamps!', 'Something good',
    "C'mon, show me the gold.", "Don't you be making me mad now"
]
...
SkillDescriptions = {
    ...
    InventoryType.CutlassHack: (ComboSkill, 'A quick opening attack!', '',
                                ClickToLearnCombo),
    InventoryType.CutlassSlash: (ComboSkill, 'A broad slash!', '',
                                 ClickToLearnCombo),
    InventoryType.CutlassCleave: (ComboSkill, 'A mighty overhead cleave!', '',
                                  ClickToLearnCombo),
    InventoryType.CutlassFlourish: (ComboSkill, 'A series of fast slashes!', '',
                                    ClickToLearnCombo),
    InventoryType.CutlassStab: (ComboSkill, 'A fancy finishing thrust!', '',
                                ClickToLearnCombo),
    InventoryType.CutlassParry:
    (PassiveSkill,
     'Parry enemy attacks! %d%% chance to block incoming Combat Attacks!',
     'Upgrade to increase your chance to Parry!'),
    InventoryType.CutlassEndurance:
    (PassiveSkill, 'Increases maximum Health by %d!',
     'Upgrade to increase your maximum Health!'),
    ...
    (CombatSkill, 'A wide circular slash! Hits all nearby enemies!', ''),
    InventoryType.CutlassBladestorm: (CombatSkill,
                                      'Delivers a barrage of sword slashes!',
                                      ''),
    InventoryType.PistolShoot: (AttackSkill, 'Basic shooting skill.', ''),
    InventoryType.PistolTakeAim:
    (AttackSkill,
     'Hold down the attack button for an Aimed Shot! Increases the accuracy, range, and damage of the shot!',
     ''),
    InventoryType.PistolEagleEye:
    (PassiveSkill,
     'Increases the maximum range for Firearms and ranged Dagger attacks by %d feet!',
     'Upgrade to increase Range bonus of this Skill!'),
    InventoryType.PistolDodge: (PassiveSkill,
                                '%d%% chance to Dodge incoming Ranged Attacks.',
                                'Upgrade to increase your chance to Dodge!'),
    InventoryType.PistolSharpShooter:
    (PassiveSkill,
     'Increases accuracy for Firearms and ranged Dagger attacks by %d%%!',
     'Upgrade Accuracy boost for Firearms and ranged Dagger attacks!'),
    InventoryType.PistolLeadShot: (AmmoSkill, 'Standard Ammunition.', '',
                                   ClickToLearnAmmo),
    InventoryType.PistolBaneShot: (AmmoSkill, 'A cursed bullet.', '',
                                   ClickToLearnAmmo),
    InventoryType.PistolSilverShot: (AmmoSkill, 'Made from solid silver.', '',
                                     ClickToLearnAmmo),
    InventoryType.PistolHexEaterShot:
    (AmmoSkill, 'Damages ' + ManaName + ' as well as Health.', '',
     ClickToLearnAmmo),
    InventoryType.PistolSteelShot: (AmmoSkill, 'The strongest metal shot.', '',
                                    ClickToLearnAmmo),
    InventoryType.PistolVenomShot: (AmmoSkill, 'Coated with deadly venom.', '',
                                    ClickToLearnAmmo),
    ...
    (ShipSkill, 'Fire left broadside.',
     'Upgrade to increase Left Broadside Cannonball damage!',
     ClickToLearnManeuver),
    InventoryType.SailBroadsideRight:
    (ShipSkill, 'Fire right broadside.',
     'Upgrade to increase Right Broadside Cannonball damage!',
     ClickToLearnManeuver),
    InventoryType.SailFullSail:
    (ShipSkill,
     "Coaxes a short burst of speed out of the ship. Interrupts the 'Come About' Maneuver.",
     'Upgrade to increase Maneuver duration!', ClickToLearnManeuver),
    InventoryType.SailComeAbout:
    (ShipSkill,
     "Allows your ship to make a hard sudden turn. Interrupts the 'Full Sail' Maneuver.",
     'Upgrade to increase Maneuver duration!', ClickToLearnManeuver),
    InventoryType.SailOpenFire:
    (OrderSkill, 'Call upon your shipmates to fire cannons for great effect!',
     'Upgrade to increase Open Fire duration!'),
    InventoryType.SailRammingSpeed:
    (ShipSkill,
     'Bear down upon an enemy vessel and ram it into splinters! Interrupts all other Sailing Maneuvers.',
     'Upgrade to improve ship ramming damage!', ClickToLearnManeuver),
    InventoryType.SailTakeCover:
    (OrderSkill, 'Protect your ship and shipmates from incoming fire.',
     'Upgrade to increase Take Cover duration!'),
    InventoryType.SailPowerRecharge:
    (ShipSkill,
     'Temporarily increases the rate of recharging sailing and cannon skills for the ship.',
     'Unlocked after you recover the Black Pearl!'),
    InventoryType.SailWindcatcher:
    (PassiveSkill,
     'A master of the sail, you know how to catch the wind in your sails for maximum speed. Increases ship speed by %d%%!',
     'Upgrade to increase Speed bonus!'),
    InventoryType.SailTacking:
    (PassiveSkill,
     'Superior knowledge of the rigging allows you to turn more rapidly. Improves ship turning radius by %d%%!',
     'Upgrade to increase Maneuverability bonus!'),
    InventoryType.SailTreasureSense:
    (PassiveSkill,
     'Your endeavours always seem to uncover more gold. Increases the quality of cargo drops by %d%%!',
     'Upgrade to increase Cargo Drop bonus!'),
    InventoryType.SailTaskmaster:
    (PassiveSkill,
     'A harsh taskmaster can get his shipmates to reload his cannons faster. Decreases cooldown time for Broadsides by %d%%!',
     'Upgrade to decrease Broadside cooldown time!'),
    InventoryType.DaggerCut:
    (ComboSkill,
     'An opening cut! Deals extra damage when striking a foe in the back!', '',
     ClickToLearnCombo),
    InventoryType.DaggerSwipe:
    (ComboSkill,
     'A whirling dagger attack! Deals extra damage when striking a foe in the back!',
     '', ClickToLearnCombo),
    InventoryType.DaggerGouge:
    (ComboSkill,
     'A powerful downward slice! Deals extra damage when striking a foe in the back!',
     '', ClickToLearnCombo),
    InventoryType.DaggerEviscerate:
    (ComboSkill,
     'Delivers three quick cuts! Deals extra damage when striking a foe in the back!',
     '', ClickToLearnCombo),
    InventoryType.DaggerFinesse:
    (PassiveSkill,
     'Decreases cooldown time for Dagger and Cutlass Skills by %d%%!',
     'Upgrade to decrease Dagger and Cutlass Skill cooldown times!'),
    InventoryType.DaggerBladeInstinct:
    (PassiveSkill, 'Increases Cutlass and Dagger Combat damage by %d%%!',
     'Upgrade to increase Cutlass and Dagger damage!'),
    ...
    (AttackSkill, 'Fire in the hole! Basic grenade throwing skill.', ''),
    InventoryType.GrenadeExplosion: (AmmoSkill, 'A hefty grenade!', '',
                                     ClickToLearnAmmo),
    InventoryType.GrenadeShockBomb: (AmmoSkill, 'A weak but stunning grenade!',
                                     '', ClickToLearnAmmo),
    InventoryType.GrenadeFireBomb: (AmmoSkill, 'A flammable concoction!', '',
                                    ClickToLearnAmmo),
    InventoryType.GrenadeSmokeCloud:
    (AmmoSkill, 'A smoke grenade that can used to obscure vision.', '',
     ClickToLearnAmmo),
    InventoryType.GrenadeSiege:
    (AmmoSkill, 'A powerful siege bomb! Watch out, it is heavy!', '',
     ClickToLearnAmmo),
    InventoryType.GrenadeLongVolley:
    (CombatSkill,
     'Hold down the attack button to throw the grenade farther!  The longer you hold down the button, the further it will go!',
     ''),
    InventoryType.GrenadeDemolitions:
    (PassiveSkill,
     'Increases the area of effect for your Grenade and Cannonball explosions!',
     'Upgrade to increase Area of Effect bonus!'),
    InventoryType.GrenadeDetermination:
    (PassiveSkill, 'Increases your Health Recovery rate by %d%%!',
     'Upgrade to increase your Health Recovery rate!'),
    InventoryType.GrenadeToughness:
    (PassiveSkill,
     'Decreases damage suffered by incoming Grenades and Cannonballs by %d%%',
     'Upgrade to increase your damage resistance to Grenades and Cannonballs!'),
    InventoryType.GrenadeIgnorePain:
    (PassiveSkill, 'Stun and Slow effect durations are reduced by %d%%!',
     'Upgrade to increase Slow recovery speed!'),
    InventoryType.DollAttune:
    (AttackSkill, 'Attune the doll to a target in order to cast Hexes!',
     'Upgrade to gain the ability to Attune the doll to 1 additional friend or enemy!'
    ),
    ...
    InventoryType.DollShackles: (HexSkill,
                                 'Chains from the grave wrap around the enemy!',
                                 ''),
    InventoryType.DollCure:
    (HexSkill,
     'Heals a friendly pirate and removes hostile effect Buffs from a friendly pirate!',
     ''),
    ...
    (PassiveSkill,
     'Increases your maximum ' + ManaName + ' amount by %d ' + ManaName + '!',
     'Upgrade to increase your maximum ' + ManaName + '!'),
    InventoryType.DollSpiritWard:
    (PassiveSkill, '%d%% chance to Resist enemy Voodoo!',
     'Upgrade to increase your chance to Resist enemy Voodoo!'),
    ...
    (PassiveSkill, 'Increases your ' + ManaName + ' Recovery rate by %d%%!',
     'Upgrade to increase your ' + ManaName + ' Recovery rate!'),
    InventoryType.StaffSpiritLore:
    (PassiveSkill, 'Increases Casting Speed for the Voodoo Staff by %d%%!',
     'Upgrade to increase Casting Speed for the Voodoo Staff!'),
    InventoryType.StaffConservation:
    (PassiveSkill,
     'Decreases ' + ManaName + ' used by Voodoo Staff and Voodoo Doll by %d%%!',
     'Upgrade to decrease ' + ManaName +
     ' usage for Voodoo Staff and Voodoo Doll!'),
    InventoryType.StaffSpiritMastery:
    (PassiveSkill,
     'Increases damage of Voodoo Doll and Staff Voodoo Hexes by %d%%!',
     'Upgrade to increase Staff and Doll Voodoo Hex damage!'),
    InventoryType.CannonShoot: (AttackSkill, 'Basic Cannoneering Skill!',
                                'Upgrade to increase Cannon firing rate!'),
    InventoryType.CannonRoundShot:
    (AmmoSkill, 'Medium ranged shot! Effective against ship hulls!', '',
     ClickToLearnAmmo),
    InventoryType.CannonChainShot:
    (AmmoSkill, 'Short ranged shot! Effective against masts & sails!', '',
     ClickToLearnAmmo),
    InventoryType.CannonExplosive: (AmmoSkill,
    ...
    (AmmoSkill,
     'Short ranged shot! Effective only against Crew in PVP and Sea Monsters!',
     '', ClickToLearnAmmo),
    InventoryType.CannonSkull: (AmmoSkill, '', '', ClickToLearnAmmo),
    InventoryType.CannonFirebrand:
    (AmmoSkill, 'Flaming cannonballs set fire to enemy ships.', '',
     ClickToLearnAmmo),
    ...
    (AmmoSkill, 'Summons a thunderbolt to strike the enemy ship!', '',
     ClickToLearnAmmo),
    InventoryType.CannonFury: (AmmoSkill, 'A spectral cannonball!', '',
                               ClickToLearnAmmo),
    InventoryType.CannonComet: (AmmoSkill, '', '', ClickToLearnAmmo),
    InventoryType.CannonGrappleHook:
    (AmmoSkill, 'Used for grappling enemy ships for boarding actions!', '',
     ClickToLearnAmmo),
    InventoryType.CannonRapidReload: (
        PassiveSkill, 'Increases Cannon reloading speed by %d%%!',
        'Upgrade to increase Cannon reloading speed!'),
    InventoryType.CannonBarrage:
    (PassiveSkill, 'Increases damage for Cannon and Grenade attacks by %d%%!',
     'Upgrade to increase Cannon and Grenade damage!'),
    InventoryType.CannonShrapnel:
    (PassiveSkill,
     'Upgrade your Cannonballs and Grenades to explode in a cloud of shrapnel!',
     'Upgrade to increase Shrapnel Wounding duration!'),
...
WeaponDescriptions = {
    ...
    "It's a bit crude, but it still has an edge.",
    InventoryType.CutlassWeaponL2:
    'A well crafted iron blade. A good weapon! \n +2 damage per hit.',
    InventoryType.CutlassWeaponL3:
    'An ornate steel cutlass. Well balanced and sharp! \n +4 damage per hit.',
    InventoryType.CutlassWeaponL4:
    "A Fine Cutlass. It is crafted with pride by the Caribbean's best blacksmiths.\n +6 damage per hit.",
    InventoryType.CutlassWeaponL5:
    'A Pirate Blade, a clear warning sign to any EITC or Navy blokes.\n +8 damage per hit.',
    InventoryType.CutlassWeaponL6:
    'A Dark Cutlass. \n +10 damage per hit.',
    InventoryType.PistolWeaponL1:
    'A standard flintlock pistol. Fires one shot before it needs to be reloaded.',
    InventoryType.PistolWeaponL2:
    'A flintlock pistol with two barrels. Each barrel can be fired separately before reloading.',
    InventoryType.PistolWeaponL3:
    'A multi-barreled pistol! This rare device can fire three times before reloading.',
    InventoryType.PistolWeaponL4:
    'A Heavy Tri-Barrel Pistol, a fine piece of weaponry. \n +1 damage per hit.',
    InventoryType.PistolWeaponL5:
    'A Grand Pistol, equipped with three deadly barrels. \n +2 damage per hit.',
    InventoryType.PistolWeaponL6:
    'A Quad-Barrel Pistol, four shiny barrels that will scare even the deadliest of pirates away. \n +3 damage per hit.',
    ...
    'A sharp dagger. Small but deadly.',
    InventoryType.DaggerWeaponL2:
    'A long knife. Well balanced for fighting. \n +2 damage per hit.',
    InventoryType.DaggerWeaponL3:
    'A fancy blade that is useful for keeping your opponent off guard. \n +4 damage per hit.',
    InventoryType.DaggerWeaponL4:
    "A Coltello dagger, it is a pirate's best friend in the right fight. \n +6 damage per hit.",
    InventoryType.DaggerWeaponL5:
    'A Bloodletter dagger. It is meticulously designed to fend off even the largest of foes. \n +8 damage per hit.',
    InventoryType.DaggerWeaponL6:
    'A Slicer dagger. Tear through your enemies with ease with this deadly weapon. \n +10 damage per hit.',
    InventoryType.GrenadeWeaponL1:
    'Grenades are highly lethal explosives. They are effective against large crowds of enemies!',
    ...
    'A mystical doll said to be able to bind to the spirit of anything it touches.',
    InventoryType.DollWeaponL2:
    'A powerful doll able to bind to the spirits of the living and the dead. \n +2 damage per hit.',
    InventoryType.DollWeaponL3:
    'An elaborate oriental doll able to strongly bind to the spirits of others. \n +4 damage per hit.',
    InventoryType.DollWeaponL4:
    'A Pirate Doll. Bind to the spirits of the Caribbean with this rare doll. \n +6 damage per hit.',
    InventoryType.DollWeaponL5:
    'A Taboo Doll. Many pirates fear the power and unknowns of this legendary doll. \n +8 damage per hit.',
    InventoryType.DollWeaponL6:
    'A Mojo Doll. Out perform almost any pirate with deadly and unmatched precision. \n +10 damage per hit.',
    InventoryType.WandWeaponL1:
    'A tribal fetish used for summoning evil spirits.',
    InventoryType.WandWeaponL2:
    'A powerful fetish used for summoning and controlling spirits. \n +2 damage per hit.',
    InventoryType.WandWeaponL3:
    'Sought after by many, this fetish allows the bearer to speak to the spirits of the dead. \n +4 damage per hit.',
    InventoryType.WandWeaponL4:
    'Harrow Staff. Inflict the secrets of the dead upon your enemies with this rare staff. \n +6 damage per hit.',
    InventoryType.WandWeaponL5:
    'Vile Staff. Summon the plagues of the dead and unknown against your foes. \n +8 damage per hit.',
    InventoryType.WandWeaponL6:
    'Dire Staff. A myth to some pirates, this staff holds the power to demolish your enemies. \n +10 damage per hit.',
    ...
    'Eases pain. Smells kinda strong too.',
    InventoryType.Potion2:
    'An exotic remedy. Said to cure all maladies.',
    InventoryType.Potion3:
    'Water blessed by the angels and gods.',
    InventoryType.Potion4:
    'The one and only, legendary Elixir of Life!',
    InventoryType.Potion5:
    'A miracle potion said to cure all sicknesses and regrow hair!',
    InventoryType.PorkChunk:
    "A tasty chunk of pork cooked for the Founder's Feast!",
    InventoryType.ShipRepairKit:
    'Tools and supplies for repairing your ship in PvP.',
    InventoryType.AmmoLeadShot:
    'A solid ball of lead. Crude but effective.',
    InventoryType.AmmoVenomShot:
    "Coated with snake venom. If the shot don't kill you, the venom will.",
    InventoryType.AmmoBaneShot:
    'Cursed by Davy Jones himself! Weakens your opponents.',
    InventoryType.AmmoSilverShot:
    'Useful against spooks and ghouls.',
    InventoryType.AmmoHexEaterShot:
    'Disrupts Voodoo of witch doctors and the like.',
    InventoryType.AmmoSteelShot:
    'The strongest shot. Great for hunting beasts and monsters.',
    InventoryType.AmmoAsp:
    'A small set of throwing knives. \n Throwing ammunition for the Asp Skill.',
    InventoryType.AmmoAdder:
    'A throwing knife coated with snake venom. \n Throwing ammunition for the Adder Skill.',
    InventoryType.AmmoSidewinder:
    'A large curved throwing knife. \n Throwing ammunition for the Sidewinder Skill.',
    InventoryType.AmmoViperNest:
    'A brace of special throwing knives meant to be thrown in a set. \n Throwing ammunition for the Viper Nest Skill.',
    InventoryType.AmmoGrenadeExplosion:
    'A crude ceramic grenade.',
    InventoryType.AmmoGrenadeFlame:
    'A flammable bomb that sets fire to its surroundings.',
    InventoryType.AmmoGrenadeShockBomb:
    'A ceramic pot filled with noxious gas and foul smelling gunk.',
    InventoryType.AmmoGrenadeSmoke:
    'A bomb filled with quick burning tar and rags. Creates a blinding cloud of smoke.',
    InventoryType.AmmoGrenadeSiege:
    'A heavy iron grenade that packs a wallop!',
    InventoryType.AmmoRoundShot:
    'Standard large round cannonball.',
    InventoryType.AmmoChainShot:
    'Two iron balls connected by a chain. Useful for tearing down sails and masts.',
    InventoryType.AmmoExplosive:
    'A mighty exploding cannonball. Highly volatile and extremely heavy.',
    InventoryType.AmmoGrapeShot:
    'A canister of small metal balls that fires in a huge spread. It is deadly against enemy crewmen, but has a short range.',
    InventoryType.AmmoFirebrand:
    'A flaming cannonball capable of setting fire to enemy ships.',
    InventoryType.AmmoFlamingSkull:
    'A flaming skull capable of setting fire to enemy ships.',
    InventoryType.AmmoThunderbolt:
    'A highly charged cannonball that causes a lightning bolt to strike where it lands.',
    InventoryType.AmmoFury:
    'An ethereal ghostly fireball.',
    InventoryType.AmmoGrappleHook:
    'Useful for boarding enemy ships. First, disable the ship. Then fire grapples and pull it in.',
    InventoryType.PistolPouchL1:
    'A small ammo pouch for pistol bullets. Lets you hold more bullets of each type.',
    InventoryType.PistolPouchL2:
    'A medium ammo pouch for pistol bullets. Lets you hold more bullets of each type.',
    InventoryType.PistolPouchL3:
    'A large ammo pouch for pistol bullets. Lets you hold more bullets of each type.',
    InventoryType.DaggerPouchL1:
    'A small belt for throwing daggers. Lets you hold more throwing daggers of each type.',
    InventoryType.DaggerPouchL2:
    'A medium belt for throwing daggers. Lets you hold more throwing daggers of each type.',
    InventoryType.DaggerPouchL3:
    'A large belt for throwing daggers. Lets you hold more throwing daggers of each type.',
    InventoryType.GrenadePouchL1:
    'A small sack for grenades. Lets you hold more grenades of each type.',
    InventoryType.GrenadePouchL2:
    'A medium sack for grenades. Lets you hold more grenades of each type.',
    InventoryType.GrenadePouchL3:
    'A large sack for grenades. Lets you hold more grenades of each type.',
    InventoryType.CannonPouchL1:
    'A small barrel for holding cannon ammo. Lets you hold more cannonballs of each type.',
    InventoryType.CannonPouchL2:
    'A medium barrel for holding cannon ammo. Lets you hold more cannonballs of each type.',
    InventoryType.CannonPouchL3:
    'A large barrel for holding cannon ammo. Lets you hold more cannonballs of each type.'
}
ShipDescriptions = {
...
QuestItemNames = {
    ...
    135: ('a bucket of saltpeter', 'buckets of saltpeter',
          'Buckets of Saltpeter'),
    ...
    158: ('the name of the attacker', 'the name of the attacker',
    ...
    164: ('a well-fashioned voodoo doll head', '',
          'Well-Fashioned Voodoo Doll Heads'),
    165: ('a well-fashioned voodoo doll torso', '',
          'Well-Fashioned Voodoo Doll Torsos'),
    166: ('a well-fashioned voodoo doll left arm', '',
          'Well-Fashioned Voodoo Doll Left Arms'),
    167: ('a well-fashioned voodoo doll right arm', '',
          'Well-Fashioned Voodoo Doll Right Arms'),
    168: ('a well-fashioned voodoo doll left leg', '',
          'Well-Fashioned Voodoo Doll Left Legs'),
    169: ('a well-fashioned voodoo doll right leg', '',
          'Well-Fashioned Voodoo Doll Right Legs'),
    ...
    178: ('a canteen of latrine water', 'canteens of latrine water',
          'Canteens of Latrine Water'),
    179: ('a cup of moonlit water', 'cups of moonlit water',
          'Cups of Moonlit Water'),
    180: ('a bottle of battle-touched water', 'bottles of battle-touched water',
          'Bottles of Battle-Touched Water'),
    ...
    207: ('a page from Pirate Lore', 'pages from Pirate Lore',
          'Pages from Pirate Lore'),
    208: ('a chest of Pirate Lore', 'chests of Pirate Lore',
          'Chests of Pirate Lore'),
    209: ('a book of Pirate Lore', 'books of Pirate Lore',
          'Books of Pirate Lore'),
    210: ('an EITC manual', 'EITC manuals', 'EITC Manuals'),
    211: ('an unfinished book of Pirate Lore',
          'unfinished books of Pirate Lore', 'Unfinished Books of Pirate Lore'),
    ...
    224: ('a bottle of battle-touched earth', 'bottles of battle-touched earth',
          'Bottles of Battle-Touched Earth'),
    ...
    232: ('a pair of fine scissors', 'pairs of fine scissors',
          'Pairs of Fine Scissors'),
    233: ('a spool of silk thread', 'spools of silk thread',
          'Spools of Silk Thread'),
    234: ("Scarlet's pearl", "Scarlet's pearls", "Scarlet's Pearls"),
    235: ('a letter from Scarlet', 'letters from Scarlet',
    ...
    246: ('a chunk of rotten meat', 'chunks of rotten meat',
          'Chunks of Rotten Meat'),
    ...
    260: ('a piece of Navy fabric', 'pieces of Navy fabric',
          'Pieces of Navy Fabric'),
    261: ('a scrap of cursed sail cloth', 'scraps of cursed sail cloth',
          'Scraps of Cursed Sail Cloth'),
    262: ('a suit of spanish armor', 'suits of spanish armor',
          'Suits of Spanish Armor'),
    263: ('a spanish pistol component', 'spanish pistol components',
          'Spanish Pistol Components'),
    ...
    268: ('a barrel of gun powder', 'barrels of gun powder',
...
FactionShipTypeNames = {
    ...
    5: ('East India Trading Co', ('an East India Trading Co',
...
TrackAvTypeNames = {
    ...
    5: {
        0: ('Trading Co Mercenaries', ('a Trading Co Mercenary',
                                       'Trading Co Mercenaries')),
        1: ('Trading Co Assassins', ('a Trading Co Assassin',
                                     'Trading Co Assassins')),
        2: ('Trading Co Officials', ('a Trading Co Official',
                                     'Trading Co Officials'))
    }
}
BossNames = {
    0: {
...
AvatarNames = {
    0: {
        ...
        1: {
            ...
            8: ('Captain Zephyr Windshadow', ('Captain Zephyr Windshadow',
                                              'Captain Zephyr Windshadow')),
        ...
        2: {
            ...
            8: ('Captain Cinderbones', ('Captain Cinderbones',
                                        'Captain Cinderbones')),
        ...
        6: {
            0: ('French Undead Quarter Master',
                ('a French Undead Quarter Master',
                 'French Undead Quarter Masters'), 'Fr.Undead Qtr.Master'),
            1: ('French Undead Maitre', ('a French Undead Maitre',
                                         'French Undead Maitres'),
                'Fr.Undead Maitres'),
            2: ('French Undead Lieutenant', ('a French Undead Lieutenant',
                                             'French Undead Lieutenants'),
                'Fr.Undead Lieutenant'),
            3: ('French Undead Capitaine', ('a French Undead Captaine',
                                            'French Undead Captaines'),
                'Fr.Undead Capitaine')
        },
        7: {
            0: ('Spanish Undead Conquistador', ('a Spanish Undead Conquistador',
                                                'Spanish Undead Conquistadors'),
                'Sp.Undead Conquistador'),
            1: ('Spanish Undead Bandido', ('a Spanish Undead Bandido',
                                           'Spanish Undead Bandidos'),
                'Sp.Undead Bandido'),
            2: ('Spanish Undead Pirata', ('a Spanish Undead Pirata',
                                          'Spanish Undead Piratas'),
                'Sp.Undead Pirata'),
            3: ('Spanish Undead Capitan', ('a Spanish Undead Capitan',
                                           'Spanish Undead Capitans'),
                'Sp.Undead Capitan')
        }
    },
    1: {
...
QuestDefaultDialogDuring = ("How's that task coming?",
                            'Have ye finished that task?')
...
BribeTaskDefaultDialogAfter = ('Pleasure doing business with ye!',
                               'Come back any time.')
...
FishSpeciesNames = {
    ...
    4: ('Arrow Blenny', 'Diamond Blenny', 'Hairy Blenny', 'Seaweed Blenny',
        'Spotcheek Bleeny'),
    6: ('Honeycomb Cowfish', 'Scrawled Cowfish', 'Smooth Trunkfish',
        'Spotted Trunkfish'),
    8: ('Barred Cardinalfish', 'Dusky Cardinalfish', 'Flamefish',
        'Twospot Cardinalfish', 'Whitestar Cardinalfish'),
    100: ('Seaweed', 'Old Boot', 'Empty Bottle')
}
...
NavyShipTitle = 'HMS'
NavyShipPrefix = [
    'Bonny', 'Royal', 'Baron', 'Duke', 'Lord', 'Queen', 'Intrepid',
    'Invincible', 'Fearless', 'Reliant', 'King', 'Loyal', 'Roaring', 'Defiant',
    'Valiant', 'Noble', 'Impervious', 'Golden', 'Sturdy', 'Worthy', 'Fighting',
    'Flying', 'Gallant', 'Brave', 'Resolute', 'Iron', 'Red', 'Vigilant',
    'Vanguard', 'White'
]
NavyShipSuffix = [
    'Bulwark', 'Hunter', 'Virtue', 'Chastity', 'Victory', 'Dasher',
    'Barricader', 'Bounty', 'Valor', 'Justice', 'Leopard', 'Tiger', 'Ferret',
    'Beagle', 'Avenger', 'Boar', 'Hawk', 'Warrior', 'Conqueror', 'Rose',
    'AbbotProvidence', 'Prudence', 'Courage', 'Fish', 'Blockader', 'Runner',
    'Titan', 'Man-O-War', 'Navigator', 'Warlord', 'Hero', 'Soldier', 'Champion',
    'Triumph', 'Endeavor', 'Goliath'
]
TradingShipTitle = 'EI'
TradingShipPrefix = [
    'Glorious', 'Rich', 'Magnificent', 'Wondrous', 'Joyful', 'Shining',
    'Triumphant', 'Golden', 'Silver', 'Platinum'
]
TradingShipSuffix = [
    'Plunder', 'Horde', 'Force', 'Host', 'Vanguard', 'Treasure', 'Endeavour',
    'Journey'
]
SkeletonShipTitle = 'SK'
SkeletonShipPrefix = [
    'Dire', 'Phantom', 'Dark', 'Dread', 'Storm', 'Midnight', 'Black', 'Cursed',
    'Crimson', 'Carrion', 'Rancid', 'Rotten', 'Bloody', 'Vile', 'Venomous',
    'Corrupted'
]
SkeletonShipSuffix = [
    'Treachery', 'Wraith', 'Bane', 'Pestilence', 'Gloom', 'Rebellion',
    'Massacre', 'Doom', 'Tyranny', 'Grudger', 'Reaper', 'Revenge', 'Anarchy',
    'Despair', 'Raider', 'Pain', 'Terror', 'Betrayal', 'Mutiny', 'Nemesis',
    'Villany', 'Destroyer', 'Slaughter', 'Nightmare', 'Vulture', 'Predator',
    'Omen', 'Crow', 'Buzzard', 'Vulture', 'Malice', 'Blade', 'Death',
    'Harbinger', 'Shadow', 'Torturer'
]
...
PlayingCardRanks = ('Two', 'Three', 'Four', 'Five', 'Six', 'Seven', 'Eight',
                    'Nine', 'Ten', 'Jack', 'Queen', 'King', 'Ace')
PlayingCardRanksPlural = ('Twos', 'Threes', 'Fours', 'Fives', 'Sixes', 'Sevens',
...
def getHandNameFull(handCode, cards):
    ...
    cardNamesPlural = map(lambda card: PlayingCardRanksPlural[getRank(card)],
                          cards)
    if handCode == 'Nothing':
        return ''
...
NameGUI_CheckboxText = ['Show', 'Hide']
...
PirateNames_NickNamesGeneric = ['Crazy', 'Bloody']
PirateNames_NickNamesFemale = [
    'Angel', 'Blonde', 'Bonny', 'Lady', 'Little', 'Lovely', 'Madam', 'Miss',
    'Pretty', 'Pirate'
]
PirateNames_NickNamesMale = [
    'Gentleman', 'Fat', 'Big', 'Long', 'Yellow', 'Calico', 'Red', 'Scurvy',
    'Stinky', 'Smelly', 'Blind', 'Dread', 'Swabby', 'Shabby', 'Stumpy',
    'Spanish', 'Dirty', 'Drunk', 'Drunken', 'Cutthroat', 'Cross-eyed',
    'Short-stack', 'Stupid', 'Lazy', 'Iron', 'Coal', 'Old', 'Ugly', 'Gruesome'
]
PirateNames_FirstNamesMale = [
    'Bart', 'Bartholomew', 'Basil', 'Ben', 'Benjamin ', 'Bill', 'Billy',
    'Charles', 'Chris', 'Christopher', 'David', 'Davy', 'Dog', 'Edgar',
    'Edward', 'Eric', 'Enrique', 'Francis', 'Geoffrey', 'George', 'Gerard',
    'Hector', 'Henry', 'Isaiah', 'Jack', 'James', 'Jamie', 'Jason', 'Jeffrey',
    'Jeremiah', 'Jim', 'John', 'Johnny', 'Joseph', 'Lawrence', 'Leon', 'Marc',
    'Mark', 'Matthew', 'Nate', 'Nathaniel', 'Ned', 'Peter', 'Richard', 'Robert',
    'Roger', 'Sam', 'Samuel', 'Simon', 'Solomon', 'Sven', 'Thomas', 'Tobias',
    'Tom', 'Will', 'William'
]
PirateNames_FirstNamesFemale = [
    'Amelia', 'Angel', 'Anne', 'Bess', 'Beth', 'Bettie', 'Catherine',
    'Charlotte', 'Constance', 'Eliza', 'Elizabeth', 'Emily', 'Esmerelda',
    'Gertrude', 'Grace', 'Jade', 'Jane', 'Janet', 'Jeanne', 'Joan', 'Kat',
    'Kate', 'Kelly', 'Li', 'Linda', 'Lisa', 'Liz', 'Maggie', 'Margaret',
    'Marge', 'Maria', 'Mary', 'Meg', 'Meghan', 'Molly', 'Nell', 'Nelly',
    'Rachel', 'Rosa', 'Rose', 'Samantha', 'Sarah'
]
PirateNames_FirstNamesGeneric = []
PirateNames_LastNamePrefixesGeneric = [
    'Bad', 'Barrel', 'Bilge', 'Blade', 'Blast', 'Blue', 'Brawl', 'Bridge',
    'Burn', 'Cabin', 'Calico', 'Calle', 'Cannon', 'Chain', 'Chip', 'Coal',
    'Crest', 'Dagger', 'Damp', 'Dark', 'Deck', 'Dock', 'Dread', 'Edge', 'Fire',
    'Foul', 'Gold', 'Gun', 'Helm', 'Hex', 'Hook', 'Hull', 'Iron', 'Keel',
    'Lock', 'Pillage', 'Plank', 'Plunder', 'Pond', 'Prow', 'Pug', 'Raid', 'Red',
    'Rig', 'Rope', 'Sail', 'Scurvy', 'Sea', 'Shark', 'Ship', 'Shore', 'Singed',
    'Squid', 'Stern', 'Storm', 'Sun', 'Sword', 'Tack', 'Treasure', 'True',
    'War', 'Wave', 'Yellow', 'Wild', 'Whale'
]
PirateNames_LastNamePrefixesCapped = ['Mac', 'Mc', "O'"]
PirateNames_LastNamePrefixesMale = ['Grease']
PirateNames_LastNamePrefixesFemale = ['Heart']
PirateNames_LastNameSuffixesMale = [
    'beard', 'davis', 'dougal', 'roberts', 'wallace'
]
PirateNames_LastNameSuffixesFemale = ['bonnet', 'bonney', 'fellow', 'hara']
PirateNames_LastNameSuffixesGeneric = [
    'batten', 'bellows', 'bain', 'bane', 'bones', 'bowers', 'breaker', 'burn',
    'butler', 'castle', 'crash', 'cutter', 'eagle', 'easton', 'fitte', 'fish',
    'flint', 'foote', 'fury', 'ginty', 'grin', 'grim', 'gull', 'hawk', 'hayes',
    'hazzard', 'hogge', 'hound', 'kidd', 'loather', 'martin', 'malley',
    'menace', 'monger', 'morgan', 'morrigan', 'morris', 'monk', 'paine', 'parr',
    'pigge', 'pratt', 'rackham', 'rage', 'rat', 'ratte', 'scarlett', 'shot',
    'shout', 'silver', 'skull', 'slipper', 'stack', 'steel', 'smythe',
    'spinner', 'stealer', 'swain', 'swine', 'timbers', 'vane', 'walker', 'ward',
    'wash', 'wrecker'
]
...
ProgressBlockPopupDialog = {
    'c3visitJoshamee':
    'Congratulations! You have reached the start of Chapter 3. Only players with full access may continue beyond this point. To become a full access member visit www.piratesclassic.com and subscribe.',
    'c3r2.6visitCarver':
    'Congratulations! You have recruited 5 crew members for the Black Pearl and have given Gibbs a clue as to where she is being held by the Navy. Only players with full access may continue beyond this point. To become a full access member visit www.piratesclassic.com and subscribe.',
    'c4.1visitValentina':
    'Chapter 3 complete! Coming soon: Chapter 4: Search for the Headstone.'
}
TownfolkGreetings = ['Hello.', 'Good day.']
TownfolkGoodbyes = ['Goodbye.', 'Farewell.']
TownfolkEncourage = ['Keep at it, mate!', "Come back when you're finished"]
TownfolkBrushoff = ["Sorry, I've got nothing for you."]
PirateGreetings = [
    'Ahoy!', 'Ahoy there!', 'Avast me hearties!', 'Avast!',
    'Avast, ye landlubber!'
]
PirateGoodbyes = [
    'Arrr!', 'Arrr matey!', "Back to plunderin'!",
    'Best be watchin yer back matey!'
]
PirateEncourage = ['Keep at it, mate!', "Ye're not done yet"]
PirateBrushoff = ['Bother someone else, mate', 'Nothing here for ye']
FormalGreetings = [
    'Welcome', 'Greetings', 'We meet again.', 'How may I help you?'
]
FormalGoodbyes = ['Farewell', 'Goodbye', 'Come back again sometime.']
GypsyGreetings = ['Good-day', 'Greetings']
GypsyGoodbyes = ['Farewell', 'Goodbye']
GypsyEncourage = ['Keep trying', 'You must finish before you return']
GypsyBrushoff = ['I have nothing for you', 'Try someone else']
ShipPVPLordBrushoff = [
...
__NavyAggro = [
    'Halt!', 'Halt!', 'Who goes there!?', 'This area is off limits!',
    'Over there!', 'You are under arrest!', 'Surrender!',
    "It's that pirate again!", 'A pirate!', 'What are you doing here!?'
]
__NavyTaunt = [
    "It'll be the gallows for you, pirate!",
    'You have a morning appointment with the gallows, pirate!',
    'Drop your weapons!', "You're the one who escaped from our jail!",
    "You don't stand a chance!", 'Not so tough now, eh!?',
    "It's back to jail for you!"
]
__NavyTeamTalk = [
    'Hold your fire! We want that pirate alive!',
    "You're outnumbered! Surrender!", 'We have you surrounded!',
    'Capture that pirate!', 'Take that pirate alive for questioning!'
]
__NavyBreakCombat = [
    "That is by far the worst pirate I've ever met.", 'Coward!',
    'Running away again eh!?', 'Come back here and fight!',
    'That coward ran away!', 'Bloody pirate!', 'Accursed pirate!',
...
__UndeadAggro = [
    'An intruder!', 'Trespasser!', 'After that pirate!', 'Take no prisoners!',
    'Leave no one alive!', 'Death cannot stop us!'
]
__UndeadTaunt = [
    'Jolly Roger will be pleased!', 'Death comes for ye, pirate!',
    'Yer finished, pirate!', "See ye in Davy Jones's locker!",
    'Ye fight like a dog!'
]
__UndeadTeamTalk = [
    'We outnumber ye, pirate!', 'Ye cannot defeat us all, pirate!',
    'Fool! We outnumber ye!'
]
__UndeadBreakCombat = [
    'Weakling!', 'A waste of time!', 'Ye cannot escape us forever!',
    'Ye cannot hide from us!', 'Wherever ye go, we will find ye!',
    'Ye run like a dog!', 'Ye call yerself a pirate!'
]
...
__EITCAggro = [
    'An intruder!', 'Halt!', "There's that pirate!", 'What have we here?',
    'Surrender!', 'Mind your own business, pirate!',
    "Don't meddle in our affairs!",
    'You will regret crossing swords with us, pirate!'
]
__EITCTaunt = [
    "You don't stand a chance! Surrender!",
    'Lord Beckett will reward us well for this!', 'You are no match for us!',
    'Any last words, pirate?', 'There is no escape!',
    "It's time to finish you off!",
    'This is the last mistake you make with us, pirate!'
]
__EITCTeamTalk = [
    "You're outnumbered! Surrender!", 'We have you surrounded!',
    'Give it up! We outnumber you!', "Don't let that pirate escape!",
    'Take that pirate alive for questioning!'
]
__EITCBreakCombat = [
    'Bloody pirate!', 'That coward ran away.', 'I grow tired of this.',
    "Let's head him off.", 'Alert the watch!'
]
...
__DavyJonesGuysAggro = [
    'Take no prisoners!', 'Leave no one alive!', "You don't belong here.",
    'Part of the ship... Part of the crew...',
    'We belong to the Flying Dutchman!', 'We serve Davy Jones!'
]
__DavyJonesGuysTaunt = [
    'Davy Jones will be pleased!', 'Do you fear death, pirate!',
    "See ye in Davy Jones's locker!"
]
__DavyJonesGuysTeamTalk = [
    'We outnumber ye, pirate!', 'Ye cannot stop Davy Jones, pirate!',
    'Ye cannot defeat us all, pirate!'
]
__DavyJonesGuysBreakCombat = [
    'Ye cannot escape us forever!', 'Ye cannot hide from us!',
...
__LeftBroadside = ['Broadside port!!!']
__RightBroadside = ['Broadside starboard!!!']
__FullSail = ['Full speed ahead!', 'Full sail!']
__ComeAbout = ["Let's turn her around!", 'Prepare tacking maneuver!']
__OpenFire = [
    'Now! Open fire!!!', 'Shoot! Open fire!!!', "Let 'em have it! Open fire!!!"
]
__TakeCover = [
    "She's gona broadside! Take cover!!!", 'Incoming! Take cover!!!',
    "We're being fired on! Take cover!!!"
]
__PowerRecharge = [
    'To the cannons!!!', "Let's rule the ocean!", "Sink 'em all!!"
]
__Taunt = ['Hey! Over here!']
...
GuildTokenTut = (
    'If you have generated an unlimited use invite code, it will be displayed at the top of the panel.',
    'Unlimited use invite codes can be deleted by clicking the Clear Unlimited Invite button. Limited use codes (single use and limited multi use) can be deleted by clicking the Clear Limited Use Invites button.'
)
GuildTut = (
    'Guilds are useful for grouping with other pirates and staying grouped with them even after you log out.',
    'If you are a basic member, you may join a guild by invite.  If you are an unlimited member, you can start your own guild by pressing the Create Guild button.',
...
SocialPanelHelpContents = (
    'The social panel is where you can access and manage your Friends, Crew, and Guild.',
    ...
    'Crew:\n\nInviting someone to your Crew is very similar to making a Friend. Simply click on the Pirate you would like to invite to join your Crew. Their Pirate Detail Panel will open. Click Crew.\nYou will get a pop-up that says "Would you like to invite (Pirate Name) to join your crew? "Sometime later you get a "(Pirate Name) has joined your crew!" or "(Pirate Name) declined your crew invitation."',
    'Crew:\n\nAll Crew members will appear on your Crew Panel. Unlike Friends and Guilds, Crews are not persistent between sessions. You can have up to 8 members in your Crew.',
    'Guilds:\n\nGuilds are useful for grouping with other pirates and staying grouped with them even after you log out. If you are a basic member, you may join a guild by invite. If you are an unlimited member, you can start your own guild by pressing the Create Guild button.',
    'Guilds:\n\nTo invite a pirate to your new guild, just click on them and select Guild from the menu. If they are not currently online, click the Create Invitation button to generate a code that can be redeemed for membership in your guild. Give the code to your friend, they can then join your guild via the Redeem Invitation button.',
    'Guilds:\n\nThree types of invite codes exist:\n\nSingle Use : Good for one redemption\n\nLimited Multi Use: Redeemable up to the number of times selected\n\nUnlimited Use: Unlimited Redemptions',
    'Guilds:\n\nAs Guildmaster, you can promote other members to Officer and allow them to invite others into the guild.'
)
...
TutorialPanelDialog = {
    ...
    'wreckInstruction':
    'Hit the ship wreck 3 times. Hits so far \x01Ired\x01',
    'exitCannon':
    '\nPress \x01Ired\x01Escape\x02 to stop using the cannon.',
    'showBlacksmith':
    'Walk towards the light ray.\nEnter the Old Warehouse to get a sword.',
    'doCutlassTutorial':
    'Would you like to learn how to use weapons?',
    'drawSword':
    ...
    'compassActiveQuest':
    'The \x01Iyellow\x01ARROW\x02 points to your quest goal.',
    'compassIconsBearing':
    'You are the \x01Iwhite\x01DOT\x02 in the center. \nExits are shown as \x01Iwhite\x01RECTANGLES\x02.',
    'compassIconsPeople':
    'Enemies are shown in \x01Ired\x01RED\x02. Townfolk are shown in \x01Igreen\x01GREEN\x02. Other players are shown in \x01Iblue\x01BLUE\x02.',
    'showNavy':
    "Defeat \x01Ired\x01Navy Soldiers\x02 to find the Black Pearl release orders.\nFollow the arrow towards the Governor's Mansion.",
    'showGovMansion':
    "Enter the \x01Ired\x01Governor's Mansion\x02 to deliver release orders to Elizabeth Swann.",
    'showDarby':
    'Walk towards the light ray. \nFind \x01Ired\x01Darby Drydock\x02 to get a ship.',
    'showDinghy':
    'Use a \x01Ired\x01dinghy\x02 to launch your ship.',
    'showBarbossa':
    "Sail to \x01Ired\x01Devil's Anvil\x02 to visit Barbossa.",
    'pistolAim':
    ...
    'teleport_tut1':
    'Now ....Press the \x05SmallMap\x05 to bring up the Map of the Islands.',
    'teleport_tut2':
    'Continents that are available for transport to are highighted. As you unlock additional continents for transport, they will become highlighted ont his map. Double click the left mouse button \x05leftClick\x05 \x05leftClick\x05 on the highlighted continent (Tortuga) to be transported to there.',
    'teleport_tut3':
    'You have safely arrived in Tortuga. Tortuga is never more than a double-click away. Click Ok to exit the tutorial.',
    'chat_tut1':
    'Chatting with other pirates can be helpful for teaming up on the enemy. \nClick on the \x01Ired\x01Arrow\x02 or press ENTER to start chatting.',
    'chat_tut2':
    '\nSend a message by typing it at the prompt and pressing ENTER.',
    'chat_tut3':
    'You can make friends or start a crew by clicking on another pirate and choosing Friend or Crew from the menu.',
    'chat_tut_alt4':
    'You can make friends or start a crew by clicking on another pirate and choosing Friend or Crew from the menu.',
    'chat_tut5':
    'To see a list of your friends or crewmates, press F or click the mug icon in your Sea Chest.',
    'chat_tut4':
    'In addition to clicking on other players, there are other advanced options for forming a crew in the Crew Panel.',
    'chat_tut_alt5':
    'To see a list of your friends or crewmates, press F or click the mug icon in your Sea Chest.',
    'chat_tut_alt1':
    'Chatting with other pirates can be helpful for teaming up on the enemy.',
...
Hints_General = [
    GeneralTip1, GeneralTip2, GeneralTip4, GeneralTip5, ControlTip1,
    ControlTip3, ControlTip4, ControlTip5, ControlTip6, TonicTip1, TonicTip2,
    TonicTip3, QuestTip1, QuestTip2, QuestTip3, QuestTip4, QuestTip5, QuestTip6,
    QuestTip7, ShipTip0, ShipTip1, ShipTip2, ShipTip3, ShipTip4, ShipTip5,
    ShipTip6, ShipTip7, ShipTip8, ShipTip9, ShipTip10, ShipTip11, ShipTip12,
    ShipTip13, ShipTip14, ShipTip15, ShipTip16, ShipTip17, ShipTip18, ShipTip19,
    ShipTip21, ShipTip22, ShipTip23, ShipTip24, ShipTip25, ShipTip26, ShipTip27,
    ShipTip28, ShipTip29, FriendTip1, FriendTip2, FriendTip3, FriendTip4,
    FriendTip5, FriendTip6, TreadmillTip1, TreadmillTip2, TreadmillTip3,
    TreadmillTip4, TreadmillTip5, TreadmillTip6, TreadmillTip7, ChatTip1,
    LevelupTip1, LevelupTip2, LevelupTip3, LevelupTip4, LevelupTip5,
    LevelupTip6, CombatTip1, CombatTip2, CombatTip3, CombatTip4, CombatTip5,
    CombatTip6, CombatTip7, CombatTip8, CombatTip9, CombatTip10, CombatTip11,
    CombatTip12, CombatTip13, CombatTip14, CombatTip15, CombatTip16,
    ParlorGameTip1, ParlorGameTip2, ParlorGameTip3, FunnyTip1, FunnyTip2,
    FunnyTip3, FunnyTip4, FunnyTip5, DifficultyTip1, DifficultyTip2,
    DifficultyTip3, DifficultyTip4, DifficultyTip5, FlagShipTip1, FlagShipTip2,
    FlagShipTip3, FlagShipTip4
]
Hints_Privateering = [
    ShipPVPHint1, ShipPVPHint2, ShipPVPHint3, ShipPVPHint4, ShipPVPHint5,
    ShipPVPHint6, ShipPVPHint7, ShipPVPHint8, ShipPVPHint9, ShipPVPHint10,
    ShipPVPHint11, ShipPVPHint12, ShipPVPHint13, ShipPVPHint14, ShipPVPHint15,
    ShipPVPHint16
]
HintMap_Levels = {
    1: (QuestTip1, QuestTip2, ControlTip1, ControlTip2, ControlTip4,
        PortRoyalTip1),
    2: (QuestTip1, QuestTip2, PortRoyalTip1, ControlTip1, ControlTip2,
        ControlTip3, ControlTip4, ControlTip7, ControlTip9, ControlTip10,
        ControlTip12, ShipTip0, ShipTip1, ShipTip20),
    3: (ControlTip3, ControlTip4, ControlTip5, ControlTip7, ControlTip11,
        CombatTip3, ShipTip1, ShipTip20, ShipTip21, OptimizeTip1, ShipTip0,
        SkillTip1, QuestTip3),
    4: (ControlTip4, ControlTip5, ControlTip7, ControlTip8, CombatTip3,
        TonicTip1, TonicTip2, ShipTip0, ShipTip1, ShipTip2, ShipTip20,
        ShipTip21, OptimizeTip1, SkillTip1, StoreTip1, QuestTip3),
    5:
    (ControlTip5, ControlTip7, ControlTip8, CombatTip7, CombatTip8, CombatTip9,
     TonicTip1, TonicTip2, GeneralTip6, StoreTip1, ShipTip0, ShipTip1, ShipTip2,
     TreadmillTip6, TreadmillTip8, TreadmillTip9, FriendTip2, QuestTip8),
    6: (ControlTip3, ControlTip5, StoreTip2, StoreTip3, TreadmillTip6,
        TreadmillTip8, TreadmillTip9, FriendTip2, GeneralTip6, QuestTip8,
        TonicTip3, ShipTip3, ShipTip5, CombatTip2, CombatTip4, CombatTip5,
        CombatTip7, CombatTip8, CombatTip9),
    7: (StoreTip2, StoreTip3, CombatTip1, CombatTip2, CombatTip3, CombatTip4,
        CombatTip5, CombatTip10, TreadmillTip6, FriendTip1, QuestTip5,
        GeneralTip1, ShipTip4, ShipTip5, ShipTip15, ShipTip16),
    8: (StoreTip4, StoreTip5, StoreTip6, CombatTip1, CombatTip3, QuestTip4,
        FriendTip4, FriendTip5, TreadmillTip1, TreadmillTip6, GeneralTip1,
        FlagShipTip1, FlagShipTip2, FlagShipTip3, FlagShipTip4),
    9: (LevelupTip1, LevelupTip2, LevelupTip3, LevelupTip4, LevelupTip5,
        LevelupTip6, CombatTip11, CombatTip12, CombatTip13, CombatTip14,
        ControlTip6, ShipTip8),
    10: (ShipTip4, ShipTip6, ShipTip22, FriendTip6, QuestTip7, TreadmillTip5,
         ControlTip6, CombatTip3, ParlorGameTip1, GeneralTip2, GeneralTip3,
         DifficultyTip1, DifficultyTip2, DifficultyTip3, DifficultyTip4),
    11: (TreadmillTip1, TreadmillTip2, TreadmillTip3, QuestTip6, ControlTip6,
         CombatTip3, ParlorGameTip2, GeneralTip4, GeneralTip3, ShipTip7),
    12: (ControlTip1, CombatTip10, CombatTip1, CombatTip3, ParlorGameTip3,
         GeneralTip2, GeneralTip5, GeneralTip3, ShipTip9, ShipTip10, ShipTip11,
         ShipTip17),
    13: (ShipTip12, ShipTip17, ShipTip18, ShipTip19, ShipTip22, ShipTip23,
         ShipTip24, ShipTip25, GeneralTip4, TreadmillTip5, TreadmillTip7),
    14: (),
    15: (),
    16: (),
    17: (),
    ...
    23: (),
    24: (),
    25: ('High level enemies can be found on Kingshead.',
...
TempNameList = ['Pirate', 'Swashbuckler', 'Buccaneer']
WeaponUnlockText = {
...
DoubleXPStart = makeHeadingString(
    'Double Reputation Event In Progress!', 2
...
DoubleXPFullStart = makeHeadingString(
    'Double Reputation Event In Progress!', 2
...
DoubleGoldStart = makeHeadingString(
    'Double Gold Event In Progress!', 2
...
DoubleGoldFullStart = makeHeadingString(
    'Double Gold Event In Progress!', 2
...
BlackJackFridayStart = makeHeadingString(
    'Blackjack Friday in progress!', 2
...
BlackJackFridayEnd = makeHeadingString(
    'Blackjack Friday has ended!',
...
FreeHatStartUnlimited = makeHeadingString(
    'To all Unlimited Access Members', 2
...
FreeHatStartBasic = makeHeadingString(
    'Claim your exclusive in-game item!', 2
...
StPatricksStartUnlimited = makeHeadingString(
    'To all Unlimited Access Members', 2
...
StPatricksStartBasic = makeHeadingString(
    "Get your St. Patrick's day tattoos and hair!", 2
...
MothersDayStartUnlimited = makeHeadingString(
    'To all Unlimited Access Members', 2
...
MothersDayStartBasic = makeHeadingString(
    "Get your Mother's Day tattoos!", 2
...
FathersDayStart = makeHeadingString(
    "Father's Day Event", 2
...
FourthOfJulyStart = makeHeadingString(
    'Fourth of July', 2
...
HalloweenStart = makeHeadingString(
    'All Hallows Eve Holiday is in progress!',
...
FoundersFeastStart = makeHeadingString(
    'Founders Feast Holiday is in progress!',
...
WinterFestivalStart = makeHeadingString(
    'WARM TIDES AND GLAD TIDINGS BRIGHTEN THE CARIBBEAN!', 2
...
FreeBandanaStartUnlimited = makeHeadingString(
    'To all Unlimited Access Members', 2
...
FreeBandanaStartBasic = makeHeadingString(
    'Claim your exclusive in-game item!', 2
...
EMOTE_NO = 65001
receiveWeaponEmotes = {
    EMOTE_RECEIVE_DOLL: ('doll_receive', 1, 'models/handheld/voodoo_doll_high',
                         OL.Emotes_General, None, None),
    EMOTE_RECEIVE_STAFF:
    ('staff_receive', 1, 'models/handheld/voodoo_staff_high', OL.Emotes_General,
     None, None),
    EMOTE_RECEIVE_DAGGER: ('dagger_receive', 1, 'models/handheld/dagger_high',
                           OL.Emotes_General, None, None),
    EMOTE_RECEIVE_GRENADE: ('bomb_receive', 1, 'models/ammunition/grenade',
                            OL.Emotes_General, None, None)
}
emotes = {
    EMOTE_COIN_FLIP: ('coin_flip_idle', 1, 'models/handheld/coin_high',
                      OL.Emotes_General, None, None),
    EMOTE_DANCE_JIG: ('emote_dance_jig', 1, None, OL.Emotes_General, None,
                      None),
    ...
    EMOTE_CELEBRATE: ('emote_celebrate', 0, None, OL.Emotes_General, None,
                      None),
    EMOTE_CLAP: ('emote_clap', 0, None, OL.Emotes_General, None,
                 'audio/sfx_emote_clap.wav'),
    ...
    EMOTE_KNEEL: ('kneel', 1, None, OL.Emotes_General, None, None)
}
...
URL_UpgradeNow = os.getenv(
    'GAME_INGAME_UPGRADE',
    'http://apps.pirates.go.com/pirates/redirect?redirectId=upgrade')
URL_MoreInfo = os.getenv(
    'GAME_INGAME_MOREINFO',
    'http://apps.pirates.go.com/pirates/redirect?redirectId=memopts')
URL_NamingGuidelines = os.getenv(
    'GAME_INGAME_NAMING',
    'http://apps.pirates.go.com/pirates/v3/#/help/name_approvals.html')
URL_FeedbackFormManageAccountURL = os.getenv(
    'GAME_INGAME_MANAGE_ACCT',
    'https://apps.pirates.go.com/pirates/v3/index?pageId=manageAccount')
...
FeedbackFormCatItems = [
    'Quests', 'Weapons', 'Tech', 'Ships', 'PVP', 'Social', 'General', 'Crews',
    'Guilds'
]
...
def getServerTimeString(secondsSinceEpoch):
    import datetime
    return 'Server Time: %s' % datetime.datetime.fromtimestamp(
        secondsSinceEpoch).ctime()
