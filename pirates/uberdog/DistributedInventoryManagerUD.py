...
class InventoryFSM(FSM):
    ...
    def enterCreate(self):
        ...
        stacks = [
            ...
            [InventoryType.SailBroadsideLeft, 1],
            [InventoryType.SailBroadsideRight, 1],
