...
class InventoryType:
    ...
    StartingSkills = [
        CutlassHack, CutlassSlash, SailBroadsideLeft, SailBroadsideRight,
        DaggerCut, DaggerSwipe, StaffBlast, StaffSoulFlay, GrenadeThrow,
        GrenadeExplosion, PistolShoot, PistolLeadShot, DollAttune, DollPoke,
        CannonShoot, CannonRoundShot
    ]
    ...
    Collection_Sets = (Collection_Set1, Collection_Set2, Collection_Set3,
...
class InventoryId:
    ...
    for i in range(InventoryType.begin_Ingredient,
                   InventoryType.end_Ingredient):
    ...
    for i in range(InventoryType.begin_ShipCannon,
                   InventoryType.end_ShipCannon):
    ...
    for i in range(InventoryType.begin_Consumables,
    ...
    MaxPlayerAttributeStack = (InventoryCategory.MAX_PLAYER_ATTRIBUTES,
                               FREE_GIVE_STACK)
    for i in range(InventoryType.begin_MaxPlayerAttribute,
                   InventoryType.end_MaxPlayerAttribute):
    ...
    for i in range(InventoryType.begin_TeleportAccess,
                   InventoryType.end_TeleportAccess):
        idFlags[i] = TeleportAccessStack

    idFlags[InventoryCategory.WEAPON_SKILL_MELEE] = (0, FREE_GIVE_CATEGORY)
    WeaponSkillMeleeStack = (InventoryCategory.WEAPON_SKILL_MELEE,
                             FREE_GIVE_STACK)
    for i in range(InventoryType.begin_WeaponSkillMelee,
    ...
    WeaponSkillCutlassStack = (InventoryCategory.WEAPON_SKILL_CUTLASS,
                               FREE_GIVE_STACK)
    for i in range(InventoryType.begin_WeaponSkillCutlass,
    ...
    WeaponSkillPistolStack = (InventoryCategory.WEAPON_SKILL_PISTOL,
                              FREE_GIVE_STACK)
    for i in range(InventoryType.begin_WeaponSkillPistol,
    ...
    WeaponSkillMusketStack = (InventoryCategory.WEAPON_SKILL_MUSKET,
                              FREE_GIVE_STACK)
    for i in range(InventoryType.begin_WeaponSkillMusket,
    ...
    WeaponSkillBayonetStack = (InventoryCategory.WEAPON_SKILL_BAYONET,
                               FREE_GIVE_STACK)
    for i in range(InventoryType.begin_WeaponSkillBayonet,
    ...
    WeaponSkillDaggerStack = (InventoryCategory.WEAPON_SKILL_DAGGER,
                              FREE_GIVE_STACK)
    for i in range(InventoryType.begin_WeaponSkillDagger,
    ...
    for i in range(InventoryType.begin_SkillSailing,
    ...
    UnspentSkillStack = (InventoryCategory.UNSPENT_SKILL_POINTS,
                         FREE_GIVE_STACK)
    ...
    WeaponSkillGrenadeStack = (InventoryCategory.WEAPON_SKILL_GRENADE,
                               FREE_GIVE_STACK)
    for i in range(InventoryType.begin_WeaponSkillGrenade,
    ...
    WeaponSkillDollStack = (InventoryCategory.WEAPON_SKILL_DOLL,
                            FREE_GIVE_STACK)
    for i in range(InventoryType.begin_WeaponSkillDoll,
    ...
    WeaponSkillWandStack = (InventoryCategory.WEAPON_SKILL_WAND,
                            FREE_GIVE_STACK)
    for i in range(InventoryType.begin_WeaponSkillWand,
    ...
    WeaponSkillKettleStack = (InventoryCategory.WEAPON_SKILL_KETTLE,
                              FREE_GIVE_STACK)
    for i in range(InventoryType.begin_WeaponSkillKettle,
                   InventoryType.end_WeaponSkillKettle):
        idFlags[i] = WeaponSkillKettleStack

    idFlags[InventoryCategory.WEAPON_SKILL_CANNON] = (0, FREE_GIVE_CATEGORY)
    WeaponSkillCannonStack = (InventoryCategory.WEAPON_SKILL_CANNON,
                              FREE_GIVE_STACK)
    for i in range(InventoryType.begin_WeaponSkillCannon,
    ...
    WeaponSkillItemStack = (InventoryCategory.WEAPON_SKILL_ITEM,
                            FREE_GIVE_STACK)
    for i in range(InventoryType.begin_WeaponSkillItem,
                   InventoryType.end_WeaponSkillItem):
    ...
    for i in range(InventoryType.begin_TeleportToken,
    ...
    for i in range(InventoryType.begin_Accumulator,
                   InventoryType.end_Accumulator):
    ...
    for i in range(InventoryType.begin_RepairTokens,
                   InventoryType.end_RepairTokens):
        idFlags[i] = RepairTokensStack

    idFlags[InventoryCategory.WEAPON_PISTOL_AMMO] = (0, FREE_TAKE_CATEGORY)
    WeaponPistolAmmoStack = (InventoryCategory.WEAPON_PISTOL_AMMO,
                             FREE_TAKE_STACK)
    for i in range(InventoryType.begin_WeaponPistolAmmo,
                   InventoryType.end_WeaponPistolAmmo):
        idFlags[i] = WeaponPistolAmmoStack

    idFlags[InventoryCategory.WEAPON_MUSKET_AMMO] = (0, FREE_TAKE_CATEGORY)
    WeaponMusketAmmoStack = (InventoryCategory.WEAPON_MUSKET_AMMO,
                             FREE_TAKE_STACK)
    for i in range(InventoryType.begin_WeaponMusketAmmo,
                   InventoryType.end_WeaponMusketAmmo):
        idFlags[i] = WeaponMusketAmmoStack

    idFlags[InventoryCategory.WEAPON_GRENADE_AMMO] = (0, FREE_TAKE_CATEGORY)
    WeaponGrenadeAmmoStack = (InventoryCategory.WEAPON_GRENADE_AMMO,
                              FREE_TAKE_STACK)
    for i in range(InventoryType.begin_WeaponGrenadeAmmo,
                   InventoryType.end_WeaponGrenadeAmmo):
        idFlags[i] = WeaponGrenadeAmmoStack

    idFlags[InventoryCategory.WEAPON_CANNON_AMMO] = (0, FREE_TAKE_CATEGORY)
    WeaponCannonAmmoStack = (InventoryCategory.WEAPON_CANNON_AMMO,
                             FREE_TAKE_STACK)
    for i in range(InventoryType.begin_WeaponCannonAmmo,
                   InventoryType.end_WeaponCannonAmmo):
    ...
    for i in range(InventoryType.begin_Collections,
                   InventoryType.end_Collections):
    ...
    for i in range(InventoryType.begin_RankingCategories,
                   InventoryType.end_RankingCategories):
        idFlags[i] = RankingStack

    idFlags[InventoryCategory.WEAPON_DAGGER_AMMO] = (0, FREE_TAKE_CATEGORY)
    WeaponDaggerAmmoStack = (InventoryCategory.WEAPON_DAGGER_AMMO,
                             FREE_TAKE_STACK)
    for i in range(InventoryType.begin_WeaponDaggerAmmo,
                   InventoryType.end_WeaponDaggerAmmo):
    ...
    for i in range(InventoryType.begin_PistolPouches,
    ...
    for i in range(InventoryType.begin_DaggerPouches,
    ...
    PouchesGrenadeAmmoStack = (InventoryCategory.GRENADE_POUCHES,
                               FREE_TAKE_STACK)
    for i in range(InventoryType.begin_GrenadePouches,
    ...
    for i in range(InventoryType.begin_CannonPouches,
    ...
    idFlags[InventoryType.UberDogRev] = (InventoryCategory.PLAYER_RANKING,
                                         FREE_TAKE_STACK)
    ...
    def isFreeGiveStackType(id):
        return InventoryId.idFlags.get(
            id, (0, 0))[1] & InventoryId.FREE_GIVE_STACK != 0

    @staticmethod
    def isFreeTakeStackType(id):
        return InventoryId.idFlags.get(
            id, (0, 0))[1] & InventoryId.FREE_TAKE_STACK != 0
    ...
    def isAccumulator(id):
        return InventoryId.idFlags.get(id,
                                       (0, 0))[1] & InventoryId.ACCUMULATOR != 0
    ...
    def isAutoLocation(id):
        return InventoryId.idFlags.get(
            id, (0, 0))[1] & InventoryId.AUTO_LOCATION != 0

    @staticmethod
    def isAutoOwner(id):
        return InventoryId.idFlags.get(id,
                                       (0, 0))[1] & InventoryId.AUTO_OWNER != 0

    @staticmethod
    def isCategory(id):
        return InventoryId.idFlags.get(id,
                                       (0, 0))[1] & InventoryId.CATEGORY != 0
