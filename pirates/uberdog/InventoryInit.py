...
StackLimits = {
    ...
    InventoryType.SailTreasureSense: 6,
    InventoryType.SailTaskmaster: 6,
    InventoryType.SailPowerRecharge: 2,
    InventoryType.CutlassHack: 6,
    InventoryType.CutlassSlash: 6,
    InventoryType.CutlassCleave: 6,
    InventoryType.CutlassFlourish: 6,
    InventoryType.CutlassStab: 6,
    InventoryType.CutlassSweep: 6,
    InventoryType.CutlassBrawl: 6,
    InventoryType.CutlassTaunt: 6,
    InventoryType.CutlassBladestorm: 6,
    InventoryType.CutlassParry: 6,
    InventoryType.CutlassEndurance: 6,
    InventoryType.DaggerCut: 6,
    InventoryType.DaggerSwipe: 6,
    InventoryType.DaggerGouge: 6,
    InventoryType.DaggerEviscerate: 6,
    InventoryType.DaggerAsp: 6,
    InventoryType.DaggerAdder: 6,
    InventoryType.DaggerThrowDirt: 6,
    InventoryType.DaggerSidewinder: 6,
    InventoryType.DaggerViperNest: 6,
    InventoryType.DaggerFinesse: 6,
    InventoryType.DaggerBladeInstinct: 6,
    ...
    InventoryType.PistolTakeAim: 6,
    InventoryType.PistolVenomShot: 6,
    InventoryType.PistolBaneShot: 6,
    InventoryType.PistolHexEaterShot: 6,
    InventoryType.PistolSilverShot: 6,
    InventoryType.PistolSteelShot: 6,
    InventoryType.PistolSharpShooter: 6,
    InventoryType.PistolDodge: 6,
    InventoryType.PistolEagleEye: 6,
    ...
    InventoryType.CannonChainShot: 6,
    InventoryType.CannonGrapeShot: 6,
    InventoryType.CannonFirebrand: 6,
    InventoryType.CannonThunderbolt: 6,
    InventoryType.CannonExplosive: 6,
    InventoryType.CannonFury: 6,
    InventoryType.CannonRapidReload: 6,
    InventoryType.CannonBarrage: 6,
    InventoryType.CannonShrapnel: 6,
    ...
    InventoryType.DollSwarm: 6,
    InventoryType.DollHeal: 6,
    InventoryType.DollCurse: 6,
    InventoryType.DollBurn: 6,
    InventoryType.DollCure: 6,
    InventoryType.DollShackles: 6,
    InventoryType.DollLifeDrain: 6,
    InventoryType.DollFocus: 6,
    InventoryType.DollSpiritWard: 6,
    InventoryType.StaffBlast: 6,
    InventoryType.StaffSoulFlay: 6,
    InventoryType.StaffPestilence: 6,
    InventoryType.StaffWither: 6,
    InventoryType.StaffHellfire: 6,
    InventoryType.StaffBanish: 6,
    InventoryType.StaffDesolation: 6,
    InventoryType.StaffConcentration: 6,
    InventoryType.StaffSpiritLore: 6,
    InventoryType.StaffConservation: 6,
    InventoryType.StaffSpiritMastery: 6,
    InventoryType.GrenadeThrow: 6,
    InventoryType.GrenadeExplosion: 6,
    InventoryType.GrenadeLongVolley: 6,
    InventoryType.GrenadeShockBomb: 6,
    InventoryType.GrenadeFireBomb: 6,
    InventoryType.GrenadeSmokeCloud: 6,
    InventoryType.GrenadeSiege: 6,
    InventoryType.GrenadeDetermination: 6,
    InventoryType.GrenadeDemolitions: 6,
    InventoryType.GrenadeToughness: 6,
    InventoryType.GrenadeIgnorePain: 6,
    ...
    InventoryType.CutlassWeaponL2: 1,
    InventoryType.CutlassWeaponL3: 1,
    InventoryType.CutlassWeaponL4: 1,
    InventoryType.CutlassWeaponL5: 1,
    InventoryType.CutlassWeaponL6: 1,
    InventoryType.PistolWeaponL1: 1,
    InventoryType.PistolWeaponL2: 1,
    InventoryType.PistolWeaponL3: 1,
    InventoryType.PistolWeaponL4: 1,
    InventoryType.PistolWeaponL5: 1,
    InventoryType.PistolWeaponL6: 1,
    InventoryType.DollWeaponL1: 1,
    InventoryType.DollWeaponL2: 1,
    InventoryType.DollWeaponL3: 1,
    InventoryType.DollWeaponL4: 1,
    InventoryType.DollWeaponL5: 1,
    InventoryType.DollWeaponL6: 1,
    InventoryType.DaggerWeaponL1: 1,
    InventoryType.DaggerWeaponL2: 1,
    InventoryType.DaggerWeaponL3: 1,
    InventoryType.DaggerWeaponL4: 1,
    InventoryType.DaggerWeaponL5: 1,
    InventoryType.DaggerWeaponL6: 1,
    InventoryType.GrenadeWeaponL1: 1,
    InventoryType.GrenadeWeaponL2: 1,
    InventoryType.GrenadeWeaponL3: 1,
    InventoryType.GrenadeWeaponL4: 1,
    InventoryType.GrenadeWeaponL5: 1,
    InventoryType.GrenadeWeaponL6: 1,
    InventoryType.WandWeaponL1: 1,
    InventoryType.WandWeaponL2: 1,
    InventoryType.WandWeaponL3: 1,
    InventoryType.WandWeaponL4: 1,
    InventoryType.WandWeaponL5: 1,
    InventoryType.WandWeaponL6: 1,
    InventoryType.PorkChunk: 10,
    InventoryType.UseItem: 6,
    InventoryType.GoldInPocket: 65000,
