...
CutsceneNames = [
    Cutscene1_1_1, Cutscene1_1_2, Cutscene1_1_5_a, Cutscene1_1_5_b,
    Cutscene1_1_5_c, Cutscene1_2, Cutscene1_3, Cutscene2_1, Cutscene2_1_b,
    Cutscene2_2, Cutscene2_3, Cutscene2_4, Cutscene2_4_b, Cutscene2_5,
    Cutscene3_1, Cutscene3_2, Cutscene6_1
]
CutsceneFilenames = {
...
CutsceneIds.sort()
PRELOADED_CUTSCENE_STAGE1 = [Cutscene1_1_2]
PRELOADED_CUTSCENE_STAGE2 = [Cutscene1_1_5_a, Cutscene1_1_5_c]
PRELOADED_CUTSCENE_STAGE3 = [Cutscene1_2, Cutscene1_3]
PRELOADED_CUTSCENE_STAGE4 = [Cutscene2_1_b]
PRELOADED_CUTSCENE_STAGE5 = [Cutscene2_4_b]
...
CutsceneData = {
    ...
    CutsceneDesc(
        ...
        soundFile=('audio/cs_tut_1_1_a_js.mp3',),
        filmSizeHorizontal=42.667,
        focalLength=50),
    Cutscene1_1_2:
    CutsceneDesc(
        ...
        actorFunctors=[CutJackSparrow,
                       Functor(CutLocalPirate, False)],
        soundFile=('audio/cs_tut_1_1_b_js.mp3',),
        filmSizeHorizontal=42.667,
        focalLength=50),
    Cutscene1_1_5_a:
    CutsceneDesc(
        ...
        actorFunctors=[
            ...
            Functor(CutBartenderFmiNell, 1)
        ],
        soundFile=('audio/cs_tut_1_1_5_a_dan.mp3',),
        filmSizeHorizontal=42.667,
        focalLength=50),
    Cutscene1_1_5_b:
    CutsceneDesc(
        ...
        soundFile=('audio/cs_tut_1_1_5_b_dan.mp3',),
        filmSizeHorizontal=42.667,
        focalLength=50),
    Cutscene1_1_5_c:
    CutsceneDesc(
        ...
        soundFile=('audio/cs_tut_1_1_5_c_dan.mp3',),
        filmSizeHorizontal=42.667,
        focalLength=50),
    Cutscene1_2:
    CutsceneDesc(
        id=Cutscene1_2,
        components=['_dock', '_b_dock'],
        actorFunctors=[
            Functor(CutLocalPirate, False),
            Functor(CutCaptainBeckShort, 1),
            Functor(CutGenericActor, 'wheel', 'wheel_zero', 'models/props/'),
            Functor(CutBoat, ShipGlobals.STUMPY_SHIP,
                    PiratesGlobals.PLAYER_TEAM, Vec3(0, 0, 0), 0)
        ],
        soundFile=('audio/cs_tut_1_2_dock.mp3',),
        filmSizeHorizontal=42.667,
        focalLength=50),
    Cutscene1_3:
    CutsceneDesc(
        ...
        actorFunctors=[
            ...
            Functor(CutBoat, ShipGlobals.STUMPY_SHIP,
                    PiratesGlobals.PLAYER_TEAM, Vec3(0, 0, 0), 1),
            Functor(CutBoat, ShipGlobals.SKEL_DEATH_OMEN,
                    PiratesGlobals.UNDEAD_TEAM, Vec3(0, 0, 0), 0)
        ],
        soundFile=('audio/cs_tut_1_3_jr.mp3',),
        filmSizeHorizontal=42.667,
        focalLength=50),
    Cutscene2_1:
    CutsceneDesc(
        ...
        soundFile=('audio/cs_tut_2_1_a_wt.mp3',),
        filmSizeHorizontal=42.667,
        focalLength=72),
    Cutscene2_1_b:
    CutsceneDesc(
        ...
        soundFile=('audio/cs_tut_2_1_b_wt.mp3',),
        filmSizeHorizontal=42.667,
        focalLength=35),
    Cutscene2_2:
    CutsceneDesc(
        ...
        actorFunctors=[
            ...
            Functor(CutBlackGuard3, 3), CutJollyRoger,
            Functor(CutSkeleton, EarthUndead[4], 4),
            Functor(CutSkeleton, EarthUndead[2], 5),
            Functor(CutGenericActor, 'lantern', 'lantern_zero',
                    'models/props/'),
            Functor(CutGenericActor, 'crablegs', 'crablegs_zero',
                    'models/props/')
        ],
        soundFile=('audio/cs_tut_2_2_td.mp3',),
        filmSizeHorizontal=42.667,
        focalLength=72),
    Cutscene2_3:
    CutsceneDesc(
        ...
        actorFunctors=[
            ...
            Functor(CutLocalPirate, False),
            Functor(CutGenericActor, 'paper', 'paper_zero', 'models/props/')
        ],
        soundFile=('audio/cs_tut_2_3_es.mp3',),
        filmSizeHorizontal=42.667,
        focalLength=32),
    Cutscene2_4:
    CutsceneDesc(
        ...
        actorFunctors=[
            ...
            Functor(CutLocalPirate, False),
            Functor(CutGenericActor, 'monkey', 'monkey_hi', 'models/char/')
        ],
        soundFile=('audio/cs_tut_2_4_a_cb.mp3',),
        filmSizeHorizontal=42.667,
        focalLength=50),
    Cutscene2_4_b:
    CutsceneDesc(
        ...
        soundFile=('audio/cs_tut_2_4_b_cb.mp3',),
        filmSizeHorizontal=42.667,
        focalLength=50),
    Cutscene2_5:
    CutsceneDesc(
        ...
        actorFunctors=[
            ...
            Functor(CutBartenderPear, 1)
        ],
        soundFile=('audio/cs_tut_2_5_js.mp3',),
        filmSizeHorizontal=42.667,
        focalLength=30),
    Cutscene3_1:
    CutsceneDesc(
        ...
        actorFunctors=[
            Functor(CutLocalPirate, False),
            Functor(CutGenericActor, 'open_paper', 'open_paper_zero',
                    'models/props/'),
            ...
            Functor(
                ...
                0,
                rootScale=2.0),
            Functor(CutBoat, ShipGlobals.BLACK_PEARL,
                    PiratesGlobals.PLAYER_TEAM, Vec3(0, 0, 0), 0)
        ],
        soundFile=('audio/cs_tut_3_1_bp.mp3',),
        filmSizeHorizontal=42.667,
        focalLength=50),
    Cutscene3_2:
    CutsceneDesc(
        ...
        actorFunctors=[
            CutJackSparrow,
            Functor(CutLocalPirate, False),
            Functor(CutJoshGibbs, '1168022298.47Shochet')
        ],
        soundFile=('audio/cs_tut_3_2_js.mp3',),
        filmSizeHorizontal=42.667,
        focalLength=50),
    Cutscene6_1:
    CutsceneDesc(
        ...
        soundFile=('audio/cs_tut_6_1_td.mp3',),
        filmSizeHorizontal=42.667,
        focalLength=50)
}
