...
__NPCInteractMenus = {
  AvatarTypes.Townfolk: (PLocalizer.TownfolkMenuTitle, [QUEST, BRIBE, HEAL_HP, CANCEL]),
  AvatarTypes.Cast: (PLocalizer.CastMenuTitle, [QUEST, BRIBE, CANCEL]),
  AvatarTypes.Commoner: (PLocalizer.CommonerMenuTitle, [QUEST, BRIBE, HEAL_HP, CANCEL]),
  AvatarTypes.Peasant: (PLocalizer.PeasantMenuTitle, [QUEST, BRIBE, HEAL_HP, CANCEL]),
  AvatarTypes.StoreOwner: (PLocalizer.StoreOwnerMenuTitle, [QUEST, STORE, BRIBE, CANCEL]),
  AvatarTypes.Gypsy: (PLocalizer.GypsyMenuTitle, [QUEST, STORE, BRIBE, HEAL_MOJO, CANCEL]),
  AvatarTypes.Blacksmith: (PLocalizer.BlacksmithMenuTitle, [QUEST, STORE, BRIBE, CANCEL]),
  AvatarTypes.Shipwright: (PLocalizer.ShipwrightMenuTitle, [QUEST, SHIPS, REPAIR, SELL_SHIPS, BRIBE, CANCEL]),
  AvatarTypes.Merchant: (PLocalizer.MerchantMenuTitle, [QUEST, STORE, BRIBE, CANCEL]),
  AvatarTypes.Cannoneer: (PLocalizer.CannoneerMenuTitle, [QUEST, STORE, BRIBE, CANCEL]),
  AvatarTypes.Bartender: (PLocalizer.BartenderMenuTitle, [QUEST, BRIBE, HEAL_HP, CANCEL]),
  AvatarTypes.Gunsmith: (PLocalizer.GunsmithMenuTitle, [QUEST, STORE, BRIBE, CANCEL]),
  AvatarTypes.Grenadier: (PLocalizer.GrenadierMenuTitle, [QUEST, STORE, BRIBE, CANCEL]),
  AvatarTypes.MedicineMan: (PLocalizer.MedicineManMenuTitle, [QUEST, STORE, BRIBE, CANCEL]),
  AvatarTypes.Tailor: (PLocalizer.ShopTailor, [QUEST, ACCESSORIES_STORE, CANCEL]),
  AvatarTypes.Tattoo: (PLocalizer.ShopTattoo, [QUEST, TATTOO_STORE, CANCEL]),
  AvatarTypes.Jeweler: (PLocalizer.ShopJewelry, [QUEST, JEWELRY_STORE, CANCEL]),
  AvatarTypes.Barber: (PLocalizer.ShopBarber, [QUEST, BARBER_STORE, CANCEL]),
  AvatarTypes.Trainer: (PLocalizer.TrainerMenuTitle, [QUEST, RESPEC, BRIBE, CANCEL]),
  AvatarTypes.Musician: (PLocalizer.ShopMusician, [MUSICIAN, CANCEL]),
  AvatarTypes.PvPRewards: (PLocalizer.ShopPvP, [QUEST, PVP_REWARDS_TATTOO, PVP_REWARDS_EYE_PATCHES, PVP_REWARDS_HATS, BRIBE, CANCEL])
}
