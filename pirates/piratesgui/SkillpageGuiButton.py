    ...
    def createHelpbox(self, args=None):
        ...
        if self.skillRank:
            self.rankText = DirectFrame(
                parent=self,
                relief=None,
                text=('\x01gold\x01\x01smallCaps\x01' + PLocalizer.Rank + ' %d'
                      + '\x02\x02') % self.skillRank,
...
# okay decompiling .\pirates\piratesgui\SkillpageGuiButton.pyc
