...
class ShipFrameSelect(ShipFrame):
    ...
    def __init__(self, parent, **kw):
        ...
        optiondefs = (('relief', 0, None), ('frameSize', (0.0, 0.9, 0.0, 0.42),
                      ...
                      ('image_pos', (0.45, 0.0, 0.208),
                       None), ('image_scale', (0.94, 1, 1.1),
                               None), ('image_color', (0.8, 0.8, 0.8, 1), None),
                      ('frameColor', (1, 1, 1, 0.9),
                       None), ('snapShotPos', (-0.04, 0, -0.08),
                               None), ('shipPos', VBase3(0.76, 0, 0.15), None),
                      ('shipHpr', VBase3(-70, 6, 15),
                       None), ('shipScale', VBase3(0.55),
                               None), ('shipType', ShipFrameSelect.STOwn,
                                       None), ('command', None,
                                               None), ('extraArgs', [], None))
        self.nameLabel = None
    ...
    def createGui(self):
        ...
        self.nameLabel = DirectLabel(
            ...
            frameSize=(self['frameSize'][0] + 0.04, self['frameSize'][1] - 0.03,
                       -0.0, 0.05),
...
# okay decompiling .\pirates\piratesgui\ShipFrameSelect.pyc
