...
class NonPayerPanel(DirectFrame):
    ...
    def configurePanel(self):
        ...
        self.gameImage = [
            (piccard.find('**/vr_island1'),
             piccard.find('**/vr_island2')), (piccard.find('**/vr_guild1'),
                                              piccard.find('**/vr_guild2')),
            (piccard.find('**/vr_account1'),
             piccard.find('**/vr_account2')), (piccard.find('**/vr_ship1'),
                                               piccard.find('**/vr_ship2')),
            (piccard.find('**/vr_pvp1'),
             piccard.find('**/vr_pvp2')), (piccard.find('**/vr_weapon1'),
                                           piccard.find('**/vr_weapon2')),
            (piccard.find('**/vr_parlor1'),
             piccard.find('**/vr_parlor2')), (piccard.find('**/vr_treasure2'),
                                              piccard.find('**/vr_treasure1')),
            (piccard.find('**/vr_combat1'),
             piccard.find('**/vr_combat2')), (piccard.find('**/vr_quest1'),
                                              piccard.find('**/vr_quest2')),
            (piccard.find('**/vr_customize1'), piccard.find('**/vr_customize2'))
        ]
        self.gameCaption = [
            (PLocalizer.VR_Cap_Island1, PLocalizer.VR_Cap_Island2),
            (PLocalizer.VR_Cap_Guild1,
             PLocalizer.VR_Cap_Guild2), (PLocalizer.VR_Cap_Account1,
                                         PLocalizer.VR_Cap_Account2),
            (PLocalizer.VR_Cap_Ship1,
             PLocalizer.VR_Cap_Ship2), (PLocalizer.VR_Cap_PVP1,
                                        PLocalizer.VR_Cap_PVP2),
            (PLocalizer.VR_Cap_Weapon1,
             PLocalizer.VR_Cap_Weapon2), (PLocalizer.VR_Cap_Parlor1,
                                          PLocalizer.VR_Cap_Parlor2),
            (PLocalizer.VR_Cap_Treasure1,
             PLocalizer.VR_Cap_Treasure2), (PLocalizer.VR_Cap_Combat1,
                                            PLocalizer.VR_Cap_Combat2),
            (PLocalizer.VR_Cap_Quest1,
             PLocalizer.VR_Cap_Quest2), (PLocalizer.VR_Cap_Customize1,
                                         PLocalizer.VR_Cap_Customize2)
        ]
        self.gameHeader = [
            PLocalizer.VR_Head_Island, PLocalizer.VR_Head_Guild,
            PLocalizer.VR_Head_Account, PLocalizer.VR_Head_Ship,
            PLocalizer.VR_Head_PVP, PLocalizer.VR_Head_Weapon,
            PLocalizer.VR_Head_Parlor, PLocalizer.VR_Head_Treasure,
            PLocalizer.VR_Head_Combat, PLocalizer.VR_Head_Quest,
            PLocalizer.VR_Head_Customize
        ]
        self.gameDescript = [
            PLocalizer.VR_Island, PLocalizer.VR_Guild, PLocalizer.VR_Account,
            PLocalizer.VR_Ship, PLocalizer.VR_PVP, PLocalizer.VR_Weapon,
            PLocalizer.VR_Parlor, PLocalizer.VR_Treasure, PLocalizer.VR_Combat,
            PLocalizer.VR_Quest, PLocalizer.VR_Customize
        ]
    ...
    def __init__(self, w=9.0, h=6.0, lock=True):
        ...
        DirectFrame.__init__(
            ...
            relief=DGG.RIDGE,
            state=DGG.NORMAL,
            frameColor=Vec4(0.0, 0.0, 0.0, 0.7),
        ...
        self.upgradeButton = DirectButton(
            ...
            relief=None,
            geom=(norm_geom, down_geom, over_geom),
            geom0_color=(0.8, 0.8, 0.8, 1),
            geom1_color=(0.7, 0.7, 0.7, 1),
            geom2_color=(1, 1, 1, 1),
            pos=(4.9, 0, 3.15),
            geom_scale=0.4,
        ...
        over_geom = basegeom.find('**/over')
        down_geom = basegeom.find('**/down')
        self.dismissButton = DirectButton(
            parent=self,
            relief=None,
            geom=(norm_geom, down_geom, over_geom),
            scale=0.4,
    ...
    def upgradeNow(self):
        ...
        base.cr.centralLogger.writeClientEvent('UPGRADE_' +
                                               str(self.questIdReporting))
