...
class PVPCompletePanel(BorderFrame):
    ...
    def __init__(self, name, pvp):
        ...
        self.endButton = GuiButton(parent=self, text=PLocalizer.PVPExit, command=pvp.requestPVPLeave, pos=(1.25,
                                                                                                           ...
                                                                                                           0.1))
        self.name = name
        self.title = DirectLabel(parent=self, relief=None, text=name, text_align=TextNode.ALeft, text_scale=0.09, text_fg=PiratesGuiGlobals.TextFG1, text_shadow=PiratesGuiGlobals.TextShadow, textMayChange=1, pos=(0.2,
                                                                                                                                                                                                                     0,
                                                                                                                                                                                                                     1.55))
        self.outcome = DirectLabel(parent=self, relief=None, text='', text_align=TextNode.ARight, text_scale=0.09, text_fg=PiratesGuiGlobals.TextFG1, text_shadow=PiratesGuiGlobals.TextShadow, textMayChange=1, pos=(2.2,
                                                                                                                                                                                                                      0,
                                                                                                                                                                                                                      1.55))
        self.game = pvp
        return
