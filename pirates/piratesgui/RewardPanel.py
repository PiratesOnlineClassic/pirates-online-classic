...
class RewardPanel(PDialog):
    ...
    def __init__(self, parent=None, type=PiratesGlobals.RewardBlackPearl, doneCallback=None, **kw):
        ...
        self.congratsText = DirectLabel(parent=self, relief=None, state=DGG.DISABLED, textMayChange=1, text=PLocalizer.RewardCongratulations, text_font=PiratesGlobals.getInterfaceOutlineFont(), text_align=TextNode.ACenter, text_scale=0.12, text_fg=PiratesGuiGlobals.TextFG1, pos=(0,
                                                                                                                                                                                                                                                                                        0,
                                                                                                                                                                                                                                                                                        0.34))
        self.completeText = DirectLabel(parent=self, relief=None, state=DGG.DISABLED, textMayChange=1, text=TextDict[type][0], text_font=PiratesGlobals.getInterfaceOutlineFont(), text_align=TextNode.ACenter, text_scale=0.05, text_fg=PiratesGuiGlobals.TextFG2, pos=(0,
                                                                                                                                                                                                                                                                         0,
                                                                                                                                                                                                                                                                         0.26))
        self.iconLabel = DirectLabel(parent=self, relief=None, state=DGG.DISABLED, geom=background, geom_scale=0.3, text=TextDict[type][1], text_font=PiratesGlobals.getInterfaceFont(), text_align=TextNode.ACenter, text_scale=0.04, text_fg=PiratesGuiGlobals.TextFG1, text_pos=(0,
                                                                                                                                                                                                                                                                                    0.2), pos=(0,
                                                                                                                                                                                                                                                                                               0,
                                                                                                                                                                                                                                                                                               -0.03))
        self.descriptionText = DirectLabel(parent=self, relief=None, state=DGG.DISABLED, textMayChange=1, text=TextDict[type][2], text_font=PiratesGlobals.getInterfaceFont(), text_align=TextNode.ACenter, text_scale=0.038, text_fg=PiratesGuiGlobals.TextFG1, pos=(0,
                                                                                                                                                                                                                                                                      0,
                                                                                                                                                                                                                                                                      -0.26))
    ...
    def makeCheckbox(self, pos, text, command, initialState, extraArgs, levelText):
        ...
        del charGui
        return c
# okay decompiling .\pirates\piratesgui\RewardPanel.pyc
