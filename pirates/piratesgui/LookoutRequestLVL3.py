...
class LookoutRequestLVL3(DirectFrame):
    ...
    def show(self, gameType, selectedItem):
        ...
        if self.itemList != itemList:
            ...
            self.activityList['canvasSize'] = (0, 0.7, 0, self.activityListItems['frameSize'][3])
