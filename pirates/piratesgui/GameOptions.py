    ...
    def load(self, file_path):
        ...
        try:
            ...
            if (self.window_width,
                    self.window_height) not in base.windowed_resolution_table:
            ...
            self.texture = self.validate(int, 'texture', -1,
                                         [-1, 256, 512, 1024])
            self.textureCompression = self.validate(int, 'texture_compression',
                                                    1)
            ...
            self.terrain_detail_level = self.validate(int,
            ...
            cpu_frequency_warning = self.validate(int, 'cpu_frequency_warning',
                                                  0)
            ...
            if base.config.GetInt('want-game-options-ship-visibility', 0):
                self.ocean_visibility = self.validate(int, 'ocean_visibility',
                                                      1, [0, 1, 2])
