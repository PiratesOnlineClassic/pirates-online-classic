    ...
    def load(self, file_path):
        ...
        try:
            try:
                ...
                if (
                 self.window_width, self.window_height) not in base.windowed_resolution_table:
                ...
                if (
                 self.fullscreen_width, self.fullscreen_height) not in base.fullscreen_resolution_table:
