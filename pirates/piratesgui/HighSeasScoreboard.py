...
class HighSeasScoreboard(GuiPanel.GuiPanel):
    ...
    def __init__(self, name, stats, playerStats, ship):
        ...
        self.closeButton = DialogButton.DialogButton(parent = self, buttonStyle = DialogButton.DialogButton.NO, text = PLocalizer.lClose, pos = (1.05, 0, 0.075), command = self.closePanel)
