...
class GuiManager(FSM.FSM):
    ...
    def __init__(self, av):
        ...
        self.targetStatusTray.voodooMeter.hide()
    ...
    def showQuestItemNotifyText(self, quest, item, note):
        ...
        if note == QuestConstants.QuestItemNotification.AlreadyFound or note == QuestConstants.QuestItemNotification.ValidAttempt or note == QuestConstants.QuestItemNotification.InvalidAttempt:
            itemName = PLocalizer.QuestItemNames[item][1]
        else:
            itemName = PLocalizer.QuestItemNames[item][0]
        if note == QuestConstants.QuestItemNotification.ProgressMadeGoalMet or note == QuestConstants.QuestItemNotification.ProgressMadeGoalUnmet or note == QuestConstants.QuestItemNotification.InvalidAttempt:
