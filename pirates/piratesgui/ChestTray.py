...
class ChestTray(GuiTray.GuiTray):
    ...
    def __init__(self, parent, parentMgr, **kw):
        ...
        buttonColors = (VBase4(0.7, 0.7, 0.7, 1), VBase4(0.8, 0.8, 0.8, 1),
                        VBase4(1.0, 1.0, 1.0, 1), VBase4(0.6, 0.6, 0.6, 1))
        buttonOptions = {
            'image': buttonImages,
            'geom': None,
            'relief': None,
        ...
        self.inventoryButton = GuiButton(
            parent=self.buttonsParent,
            hotkeys=['i', 'shift-i'],
            hotkeyLabel='I',
        ...
        self.treasuresButton = GuiButton(
            parent=self.buttonsParent,
            hotkeys=['u', 'shift-u'],
            hotkeyLabel='U',
            helpText=PLocalizer.TreasuresButtonHelp,
            helpPos=helpPos,
            helpDelay=helpDelay,
            extraArgs=['guiMgrToggleTreasures'],
            pos=(0.01, 0, buttonPosZ),
            **buttonOptions)
