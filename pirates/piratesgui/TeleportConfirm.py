...
class TeleportConfirm(GuiPanel.GuiPanel):
    ...
    def __init__(self, avId, avName):
        GuiPanel.GuiPanel.__init__(self, PLocalizer.TeleportConfirmTitle, 0.5,
                                   0.5)
        ...
        self.bOk = TeleportConfirmButton(
            text=PLocalizer.TeleportConfirmOK, command=self.__handleOk)
        self.bOk.reparentTo(self)
        self.bOk.setPos(0.1, 0, 0.05)
        self.bNo = TeleportConfirmButton(
            text=PLocalizer.TeleportConfirmNo, command=self.__handleNo)
