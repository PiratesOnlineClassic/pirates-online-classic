...
class WeaponButton(GuiButton):
    ...
    def __init__(self, hotkeys=(), hotkeyLabel=None, helpText=None, parent=None, showQuant=0, **kw):
        ...
        optiondefs = (
         ('relief', None, None), ('state', 'normal', None), ('frameSize', (0, 0.12, 0, 0.12), None), ('image', buttonImages, None), ('image_scale', 0.13, None), ('image_pos', (0.06, 0, 0.06), None), ('extraArgs', [0], None))
    ...
    def initInventory(self, inventory):
        ...
        if numItems > 0 and self.showQuant:
            self.quantLabel = DirectLabel(parent=self, relief=None, state=DGG.DISABLED, text=str(numItems), text_font=PiratesGlobals.getPirateBoldOutlineFont(), text_align=TextNode.ACenter, text_scale=PiratesGuiGlobals.TextScaleSmall, text_pos=(0.06,
                                                                                                                                                                                                                                                     0.053), text_fg=PiratesGuiGlobals.TextFG2, text_shadow=PiratesGuiGlobals.TextShadow, textMayChange=1)
        if EconomyGlobals.getItemCategory(self.weaponId) == ItemType.WEAPON:
...
class CombatTray(GuiTray):
    ...
    def trySkill(self, skillId, ammoSkillId, combo=0, charge=0):
        ...
        if skillId == InventoryType.UseItem:
            ...
            if WeaponGlobals.isProjectileSkill(skillId, ammoSkillId):
                ...
                if WeaponGlobals.getIsShipSkill(skillId) and not WeaponGlobals.getIsShout(skillId):
    ...
    def clearQueues(self):
        ...
        self.skillQueue = None
        return
# okay decompiling .\pirates\piratesgui\CombatTray.pyc
