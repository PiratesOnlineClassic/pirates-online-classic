    ...
    def __init__(self, currentRepLevel, advancedOptions=False):
        ...
        if not advancedOptions:
            self.message = DirectLabel(parent=self, relief=None, text=text, text_scale=PiratesGuiGlobals.TextScaleLarge, text_align=TextNode.ACenter, text_fg=PiratesGuiGlobals.TextFG2, text_shadow=PiratesGuiGlobals.TextShadow, text_wordwrap=11, pos=(0.25,
                                                                                                                                                                                                                                                          0,
                                                                                                                                                                                                                                                          0.4), textMayChange=1)
            self.rangeSlider = DirectSlider(parent=self, relief=None, range=(0, 40), value=30, pageSize=2, scale=(0.19,
                                                                                                                  0.24,
            ...
            self.dividerLine = DirectButton(parent=self, relief=None, image=self.charGui.find('**/chargui_slider_large_over'), scale=0.27, image_scale=(1,
                                                                                                                                                        1,
                                                                                                                                                        0.4))
            self.dividerLine2 = DirectButton(parent=self, relief=None, image=self.charGui.find('**/chargui_slider_large_over'), scale=0.27, image_scale=(1,
                                                                                                                                                         1,
                                                                                                                                                         0.4))
            self.dividerLine3 = DirectButton(parent=self, relief=None, image=self.charGui.find('**/chargui_slider_large_over'), scale=0.27, image_scale=(1,
                                                                                                                                                         1,
                                                                                                                                                         0.4))
            ...
            self.messageSail = DirectLabel(parent=self, relief=None, text=PLocalizer.CrewMatchAdvancedMinSailSkillLevel, text_scale=PiratesGuiGlobals.TextScaleLarge, text_align=TextNode.ACenter, text_fg=PiratesGuiGlobals.TextFG2, text_shadow=PiratesGuiGlobals.TextShadow, text_wordwrap=11, pos=(0.25,
                                                                                                                                                                                                                                                                                                       0,
                                                                                                                                                                                                                                                                                                       0.4), textMayChange=1)
            self.messageCannon = DirectLabel(parent=self, relief=None, text=PLocalizer.CrewMatchAdvancedMinCannonSkillLevel, text_scale=PiratesGuiGlobals.TextScaleLarge, text_align=TextNode.ACenter, text_fg=PiratesGuiGlobals.TextFG2, text_shadow=PiratesGuiGlobals.TextShadow, text_wordwrap=11, pos=(0.25,
                                                                                                                                                                                                                                                                                                           0,
                                                                                                                                                                                                                                                                                                           0.27), textMayChange=1)
            self.rangeSliderNoto = DirectSlider(parent=self, relief=None, range=(0,
                                                                                 40), value=30, pageSize=2, scale=(0.19,
                                                                                                                   0.24,
                                                                                                                   0.24), text=self.sliderOutputValue, text_scale=(0.21,
                                                                                                                                                                   0.18,
                                                                                                                                                                   0.18), text_pos=(0,
            ...
            self.rangeSliderSail = DirectSlider(parent=self, relief=None, range=(1,
                                                                                 24), value=1, pageSize=2, scale=(0.19,
                                                                                                                  0.24,
                                                                                                                  0.24), text=self.sliderOutputValue, text_scale=(0.21,
                                                                                                                                                                  0.18,
                                                                                                                                                                  0.18), text_pos=(0,
            ...
            self.rangeSliderCannon = DirectSlider(parent=self, relief=None, range=(1,
                                                                                   24), value=1, pageSize=2, scale=(0.19,
                                                                                                                    0.24,
                                                                                                                    0.24), text=self.sliderOutputValue, text_scale=(0.21,
                                                                                                                                                                    0.18,
