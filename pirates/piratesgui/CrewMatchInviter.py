...
class CrewMatchInviter(GuiPanel.GuiPanel):
    ...
    def __init__(self, currentRepLevel, advancedOptions = False):
        if not advancedOptions:
            ...
            x = 0.5
            y = 0.65
        GuiPanel.GuiPanel.__init__(self, PLocalizer.CrewMatchCrewLookout, x, y, showClose = False)
        ...
        if not advancedOptions:
            self.message = DirectLabel(parent = self, relief = None, text = text, text_scale = PiratesGuiGlobals.TextScaleLarge, text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, text_wordwrap = 11, pos = (0.25, 0, 0.4), textMayChange = 1)
            self.rangeSlider = DirectSlider(parent = self, relief = None, range = (0, 40), value = 30, pageSize = 2, scale = (0.19, 0.24, 0.24), text = self.sliderOutputValue, text_scale = (0.21, 0.18, 0.18), text_pos = (0, 0.075), text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG1, textMayChange = 1, frameColor = (0.5, 0.5, 0.5, 0.3), image = self.charGui.find('**/chargui_slider_small'), thumb_relief = None, image_scale = (2.15, 2.15, 1.5), thumb_image = (self.charGui.find('**/chargui_slider_node'), self.charGui.find('**/chargui_slider_node_down'), self.charGui.find('**/chargui_slider_node_over')), command = self.__showSliderValue)
            ...
            self.dividerLine = DirectButton(parent = self, relief = None, image = self.charGui.find('**/chargui_slider_large_over'), scale = 0.27, image_scale = (1, 1, 0.4))
            self.dividerLine2 = DirectButton(parent = self, relief = None, image = self.charGui.find('**/chargui_slider_large_over'), scale = 0.27, image_scale = (1, 1, 0.4))
            self.dividerLine3 = DirectButton(parent = self, relief = None, image = self.charGui.find('**/chargui_slider_large_over'), scale = 0.27, image_scale = (1, 1, 0.4))
            self.messageNoto = DirectLabel(parent = self, relief = None, text = PLocalizer.CrewMatchAdvancedNotorietyRange, text_scale = PiratesGuiGlobals.TextScaleLarge, text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, text_wordwrap = 11, pos = (0.25, 0, 0.54), textMayChange = 1)
            self.messageSail = DirectLabel(parent = self, relief = None, text = PLocalizer.CrewMatchAdvancedMinSailSkillLevel, text_scale = PiratesGuiGlobals.TextScaleLarge, text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, text_wordwrap = 11, pos = (0.25, 0, 0.4), textMayChange = 1)
            self.messageCannon = DirectLabel(parent = self, relief = None, text = PLocalizer.CrewMatchAdvancedMinCannonSkillLevel, text_scale = PiratesGuiGlobals.TextScaleLarge, text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, text_wordwrap = 11, pos = (0.25, 0, 0.27), textMayChange = 1)
            self.rangeSliderNoto = DirectSlider(parent = self, relief = None, range = (0, 40), value = 30, pageSize = 2, scale = (0.19, 0.24, 0.24), text = self.sliderOutputValue, text_scale = (0.21, 0.18, 0.18), text_pos = (0, 0.075), text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG1, textMayChange = 1, frameColor = (0.5, 0.5, 0.5, 0.3), image = self.charGui.find('**/chargui_slider_small'), thumb_relief = None, image_scale = (2.15, 2.15, 1.5), thumb_image = (self.charGui.find('**/chargui_slider_node'), self.charGui.find('**/chargui_slider_node_down'), self.charGui.find('**/chargui_slider_node_over')), command = self.__showSliderValueNoto)
            self.rangeSliderSail = DirectSlider(parent = self, relief = None, range = (1, 24), value = 1, pageSize = 2, scale = (0.19, 0.24, 0.24), text = self.sliderOutputValue, text_scale = (0.21, 0.18, 0.18), text_pos = (0, 0.075), text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG1, textMayChange = 1, frameColor = (0.5, 0.5, 0.5, 0.3), image = self.charGui.find('**/chargui_slider_small'), thumb_relief = None, image_scale = (2.15, 2.15, 1.5), thumb_image = (self.charGui.find('**/chargui_slider_node'), self.charGui.find('**/chargui_slider_node_down'), self.charGui.find('**/chargui_slider_node_over')), command = self.__showSliderValueSail)
            self.rangeSliderCannon = DirectSlider(parent = self, relief = None, range = (1, 24), value = 1, pageSize = 2, scale = (0.19, 0.24, 0.24), text = self.sliderOutputValue, text_scale = (0.21, 0.18, 0.18), text_pos = (0, 0.075), text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG1, textMayChange = 1, frameColor = (0.5, 0.5, 0.5, 0.3), image = self.charGui.find('**/chargui_slider_small'), thumb_relief = None, image_scale = (2.15, 2.15, 1.5), thumb_image = (self.charGui.find('**/chargui_slider_node'), self.charGui.find('**/chargui_slider_node_down'), self.charGui.find('**/chargui_slider_node_over')), command = self.__showSliderValueCannon)
    ...
    def __handleOk(self):
        if not self.advancedOptions:
            base.localAvatar.guiMgr.crewPage.b_activateCrewLookout(int(self.sliderOutputValue))
        else:
            base.localAvatar.guiMgr.crewPage.b_activateCrewLookout(int(self.sliderOutputValueNoto), int(self.sliderOutputValueSail), int(self.sliderOutputValueCannon))
        self.destroy()
    
    def __handleNo(self):
        if base.localAvatar.guiMgr.crewPage.startACrewState:
            base.localAvatar.guiMgr.crewPage.toggleStartACrew()
        elif base.localAvatar.guiMgr.crewPage.addCrewLookout:
            base.localAvatar.guiMgr.crewPage.addCrewLookout['state'] = DGG.NORMAL
