...
class ShipArmorGui(GuiTray):
    ...
    def __init__(self, parent, **kw):
        ...
        self.hpLeft = DirectFrame(parent = self.damageGUI, relief = None, image = tex, image_scale = 0.06, image_color = (0.1, 0.8, 0.1, 0.8))
        ...
        self.hpRight = DirectFrame(parent = self.damageGUI, relief = None, image = tex, image_scale = 0.06, image_color = (0.1, 0.8, 0.1, 0.8))
        ...
        self.hpRear = DirectFrame(parent = self.damageGUI, relief = None, image = tex, image_scale = 0.06, image_color = (0.1, 0.8, 0.1, 0.8))
