...
class PiratesTimerHourglass(OTPTimer.OTPTimer):
    ...
    def createTimerText(self, titleText, titleFg, infoText):
        self.titleText = DirectFrame(parent = self, relief = None, text = titleText, text_align = TextNode.ACenter, text_scale = 0.15, text_fg = titleFg, text_shadow = PiratesGuiGlobals.TextShadow, text_font = PiratesGlobals.getPirateOutlineFont(), textMayChange = 1, text_wordwrap = 6, pos = (0, 0, 0.7))
