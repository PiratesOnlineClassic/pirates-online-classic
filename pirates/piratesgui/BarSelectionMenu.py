...
class BarSelectionMenu(GuiPanel.GuiPanel):
    ...
    def loadWeaponButtons(self):
        ...
        self.repMeters = []
        self['frameSize'] = (0, self.ICON_WIDTH * len(self.items) + 0.04, 0,
                             self.HEIGHT)
        ...
        for i in range(len(self.items)):
            if self.items[i]:
                ...
                icon = DirectFrame(
                    ...
                    relief=None,
                    frameSize=(0, 0.08, 0, 0.08),
                    pos=(self.ICON_WIDTH * i + 0.08, 0, 0.082))
                ...
                repMeter = DirectWaitBar(
                    ...
                    range=0,
                    value=0,
                    frameColor=(0.24, 0.24, 0.21, 1),
                    barColor=(0.8, 0.8, 0.7, 1),
                    pos=(-0.05, 0, -0.0525),
                    hpr=(0, 0, 0),
                    frameSize=(0.005, 0.095, 0, 0.0125))
    ...
    def selectPrev(self):
        ...
        self.hideTask = taskMgr.doMethodLater(
            self.SelectionDelay,
            self.confirmSelection,
            'BarSelectHideTask' + str(self.getParent()),
            extraArgs=[])
