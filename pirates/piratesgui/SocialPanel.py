...
class SocialPanel(DirectFrame):
    ...
    def __init__(self):
        ...
        self.tCloseButton = DirectButton(parent = self, relief = None, frameColor = (1, 1, 1, 1), pad = (-0.02, -0.02), borderWidth = (0, 0), geom = buttonGeom, pos = (0.09, 0, -0.185), scale = 0.2, rolloverSound = None, command = self.hide)
