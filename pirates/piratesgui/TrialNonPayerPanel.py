...
class TrialNonPayerPanel(DirectFrame):
    ...
    def __init__(self, w=9.0, h=6.0, trial=False, lock=True):
        ...
        if not self.trial:
            gui2 = loader.loadModel('models/gui/gui_main').find(
                '**/velvetrope_top')
            ...
            self.imageTwo = DirectFrame(
                parent=self.imageOne,
                relief=None,
                image=geom,
                scale=1.0,
                pos=(0, 0, 0))
            self.titleText = DirectLabel(
                parent=self.imageOne,
                relief=None,
                text=PLocalizer.VR_FeaturePopTitle,
            ...
            self.fullText = DirectLabel(
                parent=self.imageOne,
                relief=None,
                text=PLocalizer.VR_FeaturePopLongText,
                text_align=TextNode.ACenter,
                text_scale=0.1,
                text_fg=PiratesGuiGlobals.TextFG16,
            ...
            self.upgradeButton = DirectButton(
                ...
                text=PLocalizer.VR_FirstAddUpgrade,
            ...
            self.passButton = DirectButton(
                ...
                geom=(norm_geom, down_geom, over_geom),
                scale=(0.8, 1, 0.1),
                text=PLocalizer.VR_FirstAddBasic,
                text_fg=PiratesGuiGlobals.TextFG15,
                text_font=PiratesGlobals.getInterfaceFont(),
                text_scale=(0.125, 0.8),
                text_pos=(0, -0.45),
                pos=(0, 0, -0.75),
            ...
            self.imageTwo = DirectFrame(
                parent=self.imageOne,
                relief=None,
                image=gui2.find('**/but_compass'),
                scale=1.0,
                pos=(-0.49, 0, 0.22))
            self.titleText = DirectLabel(
                parent=self.imageOne,
                relief=None,
                text=PLocalizer.FirstAddTitle,
            ...
            self.fullText = DirectLabel(
                parent=self.imageOne,
                relief=None,
                text=PLocalizer.FirstAddDisplay,
                text_align=TextNode.ALeft,
                text_scale=0.06,
                text_wordwrap=21,
                text_fg=PiratesGuiGlobals.TextFG1,
    ...
    def dismissNow(self):
        if not self.trial:
            UserFunnel.logSubmit(
                0, 'NON_PAYER_CONTINUE_' + str(self.questIdReporting))
            UserFunnel.logSubmit(
                2, 'NON_PAYER_CONTINUE_' + str(self.questIdReporting))
            base.cr.centralLogger.writeClientEvent('NON_PAYER_CONTINUE_' +
