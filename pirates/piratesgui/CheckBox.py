...
class CheckBox(DirectCheckBox):
    ...
    def __init__(self, text, command):
        ...
        DirectCheckBox.__init__(self, relief = None, pos = (0, 0, 0), text = text, text_scale = PiratesGuiGlobals.TextScaleLarge, text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, text_pos = (0.08, 0.025), image = uncheckedImage, image_scale = (0.07, 0.07, 0.07), image_pos = (-0.01, 0.0, 0.035), command = command, uncheckedImage = uncheckedImage, checkedImage = checkedImage)
