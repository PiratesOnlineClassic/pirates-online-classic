...
from pirates.pirate.HumanDNA import (clothesBotColors, clothesTopColors,
                                     hatColors)
from pirates.piratesbase import (CollectionMap, Freebooter, PiratesGlobals,
                                 PLocalizer)
from pirates.piratesgui import GuiButton, PiratesGuiGlobals, RadialMenu
...
class LootPopupPanel(StackMessage, DirectObject.DirectObject):
    ...
    def __init__(self, background=1, extraArgs=[]):
        ...
        if not LootPopupPanel.lootSfx:
            ...
            LootPopupPanel.CoinTex = loader.loadModel(
        ...
        self.icons = {
            ...
            ItemId.CARGO_SKCHEST: (LootPopupPanel.RoyalChestTex,
                                   PLocalizer.SkChest),
            ...
            if itemType == ItemId.COLLECT:
                ...
                if itemType == ItemId.CLOTHING:
                    ...
                    if clothingId in ClothingGlobals.quest_items:
                        ...
                        textInfo = textInfo + ' ' + ClothingGlobals.getItemTypeName(
                            clothingId)
                                ...
                                if itemType == ItemId.CARGO_CRATE:
                                    ...
                                    if itemType == ItemId.CARGO_CHEST:
                                        ...
                                        if itemType == ItemId.CARGO_SKCHEST:
                                            ...
                                            lootIcon = self.icons.get(itemType)[
                                                0]
                                            iconScale = 0.09
                                        else:
                                            if itemType == ItemId.QUEST_DROP_JEWEL:
                                                obj = JewelryGlobals.jewelry_id.get(
                                                    quantity)
                                                textInfo = None
                                                type = None
                                                lootIcon = None
                                                ...
                                                if itemType == ItemId.QUEST_DROP_TATTOO:
                                                    ...
                                                    if itemType == ItemId.QUEST_DROP_WEAPON:
                                                        ...
                                                        textInfo = None
                                                        lootIcon = None
                                                        iconName = getItemIcons(
                                                            weaponId)
                                                        if iconName is not None:
                                                            lootIcon = LootPopupPanel.WeaponIcons.find(
                                                                '**/' +
                                                                iconName)
                                                            textInfo = PLocalizer.InventoryTypeNames.get(
                                                                weaponId)
            entry = DirectFrame(
                parent=self,
                relief=None,
