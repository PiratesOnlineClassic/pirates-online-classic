...
class TeleportBlockerPanel(GuiPanel.GuiPanel):
    ...
    def __init__(self):
        ...
        self._message = DirectLabel(parent = self, relief = None, text = message, text_pos = (0.2, 0), text_scale = 0.072, text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, text_wordwrap = 9, pos = (0.291294, 0, 0.400258), textMayChange = 1)
