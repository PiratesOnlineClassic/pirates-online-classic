...
buffTable = {WeaponGlobals.C_POISON: ('buff_poison', PLocalizer.BuffPoison), WeaponGlobals.C_ACID: ('buff_acid', PLocalizer.BuffAcid), 
             WeaponGlobals.C_HOLD: ('buff_hold', PLocalizer.BuffHold), WeaponGlobals.C_WOUND: ('buff_wound', PLocalizer.BuffWound), 
             WeaponGlobals.C_ON_FIRE: ('buff_burn', PLocalizer.BuffOnFire), WeaponGlobals.C_FLAMING: ('buff_burn', PLocalizer.BuffOnFire), 
             WeaponGlobals.C_STUN: ('buff_stun', PLocalizer.BuffStun), WeaponGlobals.C_UNSTUN: ('buff_stun', PLocalizer.BuffUnstun), 
             WeaponGlobals.C_SLOW: ('buff_stun', PLocalizer.BuffSlow), WeaponGlobals.C_PAIN: ('buff_stun', PLocalizer.BuffSlow), 
             WeaponGlobals.C_DIRT: ('buff_blind', PLocalizer.BuffBlind), WeaponGlobals.C_BLIND: ('buff_blind', PLocalizer.BuffBlind), 
             WeaponGlobals.C_CURSE: ('buff_curse', PLocalizer.BuffCurse), WeaponGlobals.C_HASTEN: ('buff_hasten', PLocalizer.BuffHasten), 
             WeaponGlobals.C_TAUNT: ('buff_taunt', PLocalizer.BuffTaunt), WeaponGlobals.C_WEAKEN: ('buff_weaken', PLocalizer.BuffWeaken), 
             WeaponGlobals.C_REGEN: ('buff_stun', PLocalizer.BuffRegen), WeaponGlobals.C_SPAWN: ('buff_blind', PLocalizer.BuffSpawn), 
             WeaponGlobals.C_VOODOO_STUN_LOCK: ('buff_stun', PLocalizer.BuffVoodooStunLock), 
             WeaponGlobals.C_ATTUNE: ('buff_attune', PLocalizer.BuffAttune), WeaponGlobals.C_FULLSAIL: ('sail_full_sail', PLocalizer.BuffFullSail), 
             WeaponGlobals.C_COMEABOUT: ('sail_come_about', PLocalizer.BuffComeAbout), 
             WeaponGlobals.C_OPENFIRE: ('buff_openfire', PLocalizer.BuffOpenFire), WeaponGlobals.C_RAM: ('sail_ramming_speed', PLocalizer.BuffRam), 
...
class BuffIcon(DirectFrame):
    ...
    def makeDetails(self):
        ...
        self.detailBox = DirectLabel(state=DGG.DISABLED, relief=None, text=text, text_align=TextNode.ALeft, text_scale=0.03, 
                                     text_fg=(1, 1, 1, 1), text_wordwrap=15, text_shadow=(0, 0, 0, 1), textMayChange=1)
