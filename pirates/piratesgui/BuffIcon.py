...
buffTable = {
    ...
    WeaponGlobals.C_VOODOO_STUN_LOCK: ('buff_stun',
                                       PLocalizer.BuffVoodooStunLock),
...
class BuffIcon(DirectFrame):
    ...
    def makeDetails(self):
        ...
        text = buffTable[self.
                         effectId][1] + PLocalizer.BuffDuration % durationStr
