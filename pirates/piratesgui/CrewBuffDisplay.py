...
class CrewBuffDisplay(DirectFrame):
    ...
    def loadGui(self):
        ...
        self.skillIconFrame = DirectFrame(parent = self.skillRingFrame, pos = (0, 0, 0), relief = None, image = self.skillIcon, image_scale = (0.14, 1, 0.14))
        self.buffTitle = DirectFrame(parent = self.dummyFrame, relief = None, pos = (-0.16, 0, 0.08), text = PLocalizer.CrewBuffCaptainOrder, text_align = TextNode.ALeft, text_scale = 0.05, text_pos = (0, 0), text_fg = PiratesGuiGlobals.TextFG13, text_wordwrap = 15, text_shadow = (0, 0, 0, 1), textMayChange = 0, text_font = PiratesGlobals.getInterfaceFont())
        ...
        self.buffDescFrame = DirectFrame(parent = self.dummyFrame, relief = None, pos = (0.0, 0, -0.045), text = self.buffDesc, text_align = TextNode.ALeft, text_scale = 0.037, text_pos = (0, 0), text_fg = PiratesGuiGlobals.TextFG2, text_wordwrap = 15, text_shadow = (0, 0, 0, 1), textMayChange = 0, text_font = PiratesGlobals.getInterfaceFont())
