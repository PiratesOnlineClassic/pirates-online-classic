...
class PiratesOffLineRequest(GuiPanel.GuiPanel):
    ...
    def __init__(self, title, message, tokenString = None, preExistPerm = 0):
        ...
        self.main = None
        if not tokenString:
            self.message = DirectLabel(parent = self, relief = None, text = message, text_scale = PiratesGuiGlobals.TextScaleLarge, text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG1, text_shadow = PiratesGuiGlobals.TextShadow, text_wordwrap = 11, pos = (0.25, 0, 0.35), textMayChange = 1)
        else:
            self.message = DirectLabel(parent = self, relief = None, text = message, text_scale = PiratesGuiGlobals.TextScaleLarge, text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG1, text_shadow = PiratesGuiGlobals.TextShadow, text_wordwrap = 16, pos = (0.33, 0, 0.68), textMayChange = 1)
        if tokenString != None:
            self.tokenMessage = DirectLabel(parent = self, relief = None, text = tokenString, text_scale = PiratesGuiGlobals.TextScaleTitleMed, text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG1, text_shadow = PiratesGuiGlobals.TextShadow, text_wordwrap = 11, pos = (0.33, 0, 0.55), textMayChange = 1)
        ...
        if tokenString:
            self.cBox1 = self.makeCheckbox((0.215, 0, 0.46), PLocalizer.GuildInviteSingleButton, self.__handleSet, 1, [
                1])
            self.cBox1.reparentTo(self)
            self.cBox2 = self.makeCheckbox((0.215, 0, 0.365), PLocalizer.GuildInviteLimitedButton, self.__handleSet, 0, [
                2])
            self.cBox2.reparentTo(self)
            self.cBox3 = self.makeCheckbox((0.215, 0, 0.175), PLocalizer.GuildInviteUnlimitedButton, self.__handleSet, 0, [
                3])
