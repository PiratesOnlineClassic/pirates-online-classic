...
class ShipFrameBoard(ShipFrame):
    ...
    def __init__(self, parent, **kw):
        ...
        optiondefs = (('relief', 0, None), ('frameSize', (0.0, 0.9, 0.0, 0.42), None), ('image', image[3], None), ('image_pos', (0.45, 0.0, 0.208), None), ('image_scale', (0.94, 1, 1.1), None), ('image_color', (0.8, 0.8, 0.8, 1), None), ('frameColor', (1, 1, 1, 0.9), None), ('snapShotPos', (-0.04, 0, -0.08), None), ('shipPos', VBase3(0.2, 0, 0.08), None), ('shipHpr', VBase3(-70, 6, 15), None), ('shipScale', VBase3(0.55), None), ('time', 0, None), ('command', None, None), ('extraArgs', [], None))
        self.nameLabel = None
