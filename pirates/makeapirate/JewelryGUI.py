...
class JewelryGUI(DirectFrame, StateData.StateData):
    ...
    def setupButtons(self):
        self.zone1Frame = DirectFrame(parent = self.parent, relief = DGG.FLAT, pos = (0.0, 0, 0.7))
        ...
        self.zone2Frame = DirectFrame(parent = self.parent, relief = DGG.FLAT, pos = (0.0, 0, 0.7))
        ...
        self.zone3Frame = DirectFrame(parent = self.parent, relief = DGG.FLAT, pos = (0.0, 0, 0.7))
        ...
        self.zone4Frame = DirectFrame(parent = self.parent, relief = DGG.FLAT, pos = (0.0, 0, 0.7))
        ...
        self.zone5Frame = DirectFrame(parent = self.parent, relief = DGG.FLAT, pos = (0.0, 0, 0.7))
        ...
        self.zone6Frame = DirectFrame(parent = self.parent, relief = DGG.FLAT, pos = (0.0, 0, 0.7))
        ...
        self.zone7Frame = DirectFrame(parent = self.parent, relief = DGG.FLAT, pos = (0.0, 0, 0.7))
        ...
        self.zone8Frame = DirectFrame(parent = self.parent, relief = DGG.FLAT, pos = (0.0, 0, 0.7))
