...
class BodyGUI(DirectFrame, StateData.StateData):
    ...
    def loadHeightGUI(self):
        self.heightSlider = CharGuiSlider(self.main, parent=self._parent, text=PLocalizer.BodyHeightFrameTitle, command=self.updateHeightSlider, range=(-0.1,
                                                                                                                                                       0.1))
    ...
    def setupButtons(self):
        ...
        for i in range(0, len(self.maleShapeButtonIcons)):
            self.shapeButtons.append(DirectButton(parent=self.shapeFrameTitle, relief=None, geom=(self.maleShapeButtonIcons[i], self.maleShapeButtonIconsOver[i], self.maleShapeButtonIconsOver[i]), image_scale=(0.7,
                                                                                                                                                                                                                  1,
                                                                                                                                                                                                                  1), pos=(xOffset, 0, yOffset), command=self.handleShape, extraArgs=[i]))
            xOffset += 0.55
