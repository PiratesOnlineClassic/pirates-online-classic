...
class Nose(DirectObject.DirectObject):
    ...
    def setupButtons(self):
        self.noseFrame = DirectFrame(parent = self.parent, relief = None, text = PLocalizer.NoseFrameTitle, text_fg = (1, 1, 1, 1), text_scale = 0.18, text_pos = (0, -0.05), pos = (0, 0, 0.2), scale = 0.7)
        self.noseFrame.hide()
