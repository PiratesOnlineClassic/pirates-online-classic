...
class Mouth(DirectObject.DirectObject):
    ...
    def setupButtons(self):
        self.jawFrame = DirectFrame(parent = self.parent, relief = None, text = PLocalizer.MouthJawFrameTitle, text_fg = (1, 1, 1, 1), text_scale = 0.18, text_pos = (0, -0.05), pos = (0, 0, 0.4), scale = 0.7)
        self.jawFrame.hide()
        self.lipFrame = DirectFrame(parent = self.parent, relief = None, text = PLocalizer.MouthFrameTitle, text_fg = (1, 1, 1, 1), text_scale = 0.18, text_pos = (0, -0.05), pos = (0, 0, -0.55), scale = 0.7)
        self.lipFrame.hide()
        self.cheekFrame = DirectFrame(parent = self.parent, relief = None, text = PLocalizer.MouthCheekFrameTitle, text_fg = (1, 1, 1, 1), text_scale = 0.18, text_pos = (0, -0.05), pos = (0, 0, -1.4), scale = 0.7)
        self.cheekFrame.hide()
