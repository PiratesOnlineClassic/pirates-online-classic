    ...
    def generateFireworkIval(self):
        if not self.fireworkIval:
            ...
            if self.typeId == FireworkType.BasicBlast:
                firework = FireworkEffect(FireworkBurstType.BasicShell,
                                          FireworkTrailType.Glow, self.velocity,
                                          self.scale, self.primaryColor,
                ...
                if self.typeId == FireworkType.LongBlast:
                    firework = FireworkEffect(
                        FireworkBurstType.LongShell, FireworkTrailType.Default,
                    ...
                    if self.typeId == FireworkType.TrailBurst:
                        ...
                        if self.typeId == FireworkType.RingBlast:
                            firework = FireworkEffect(
                                FireworkBurstType.RingBlast,
                                FireworkTrailType.GlowSparkle, self.velocity,
                                self.scale, self.primaryColor,
                                self.secondaryColor, self.burstDelay)
                            firework.reparentTo(self)
                            self.fireworkEffects.append(firework)
                            self.fireworkIval.append(
                                firework.getFireworkMainIval())
                        else:
                            if self.typeId == FireworkType.NoiseBall:
                                firework = FireworkEffect(
                                    FireworkBurstType.NoiseBall,
                                ...
                                if self.typeId == FireworkType.GlowFlare:
                                    firework = FireworkEffect(
                                        None, FireworkTrailType.LongGlowSparkle,
                                        self.velocity, self.scale,
                                        self.primaryColor, self.secondaryColor,
                                        self.burstDelay)
                                    firework.reparentTo(self)
                                    ...
                                    if self.typeId == FireworkType.PalmTree:
                                        ...
                                        if self.typeId == FireworkType.Mickey:
                                            ...
                                            fireworkParallel.append(
                                                head.getFireworkMainIval())
                                            fireworkParallel.append(
                                                leftEar.getFireworkMainIval())
                                            fireworkParallel.append(
                                                rightEar.getFireworkMainIval())
                                            self.fireworkIval.append(
                                                fireworkParallel)
                                        else:
