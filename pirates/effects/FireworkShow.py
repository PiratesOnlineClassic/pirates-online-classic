...
class FireworkShow(NodePath):
    ...
    def __init__(self, showType):
        ...
        self.showData = {
            FireworkShowType.FourthOfJuly:
            [[
                FireworkType.BasicBlast,
                Vec3(0, 0, 450),
                Point3(0, 0, 0), 1.0,
                Vec4(1, 1, 1, 1),
                Vec4(1, 1, 1, 1), 2.0, 3.0
            ], [
                FireworkType.BasicBlast,
                Vec3(-60, 20, 550),
                Point3(-120, 0, 0), 0.8,
                Vec4(1, 1, 0, 1), -1, 1.8, 0.2
            ], [
                FireworkType.BasicBlast,
                Vec3(30, -20, 470),
                Point3(120, 0, 0), 0.8,
             ...
             [
                 ...
                 FireworkType.AmericanFlag, None,
                 Point3(0, 0, 0), 1.0, None, None, None, 4.0
             ], [
                 FireworkType.GlowFlare,
                 Vec3(-100, 0, 500),
                 Point3(-400, 0, 0), 1.25,
                 Vec4(1, 1, 1, 1), -1, 3.0, 0.0
             ], [
                 FireworkType.GlowFlare,
                 Vec3(100, 0, 500),
                 Point3(400, 0, 0), 1.25,
                 Vec4(1, 1, 1, 1), -1, 3.0, 0.5
             ], [
                 FireworkType.GlowFlare,
                 Vec3(-50, 0, 500),
                 Point3(-250, 0, 0), 1.25,
                 Vec4(0, 1, 0, 1), -1, 3.0, 0.0
             ], [
                 FireworkType.GlowFlare,
                 Vec3(50, 0, 500),
                 Point3(250, 0, 0), 1.25,
                 Vec4(0, 1, 0, 1), -1, 3.0, 0.5
             ], [
                 FireworkType.GlowFlare,
                 Vec3(-25, 0, 500),
                 Point3(-100, 0, 0), 1.25,
                 Vec4(1, 0, 0, 1), -1, 3.0, 0.0
             ], [
                 FireworkType.GlowFlare,
                 Vec3(25, 0, 500),
                 Point3(100, 0, 0), 1.25,
                 Vec4(1, 0, 0, 1), -1, 3.0, 1.0
             ], [
                 FireworkType.RingBlast,
                 Vec3(0, 0, 550),
                 Point3(0, 0, 0), 1.25,
                 Vec4(1, 1, 1, 1), -1, 1.5, 2.0
             ], [
                 FireworkType.RingBlast,
                 Vec3(-100, 50, 500) * r(),
                 Point3(-200, 0, 0), 1.0,
                 ...
                 FireworkType.Mickey, None,
                 Point3(0, 0, 0), 1.0,
                 rC(), -1, None, 3.0
             ], [
                 FireworkType.NoiseBall,
                 Vec3(0, 0, 550),
                 Point3(0, 0, 0), 1.2,
                 rC(), -1, 1.7, 2.0
             ], [
             ...
             [FireworkType.LongBlast,
              ...
              rT(), 0.4], [
                  ...
                  rT(), 0.3], [
                      ...
                      FireworkType.PirateSkull, None,
                      Point3(0, 0, 0), 1.0,
                      Vec4(1, 1, 1, 1), -1, None, 2.0
                  ]]
        }
        self.sectionData = {
            FireworkShowType.FourthOfJuly: [(0, 12), (12, 34), (34, 56), (56,
                                                                          95)]
        }
        del r
        del rV
    ...
    def beginSection(self, startIndex, endIndex, offset):
        ...
        if endIndex == len(self.showData.get(self.showType)):
            sectionIval.append(
                Sequence(Wait(time + 5.0), Func(self.cleanupShow)))
...
# okay decompiling .\pirates\effects\FireworkShow.pyc
