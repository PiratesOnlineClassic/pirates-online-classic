...
trailSfxNames = ['firework_whistle_01.mp3', 'firework_whistle_02.mp3']
burstSfxNames = [
    'firework_explosion_01.mp3', 'firework_explosion_02.mp3',
    'firework_explosion_03.mp3', 'firework_distance_01.mp3',
    'firework_distance_02.mp3', 'firework_distance_03.mp3'
]
    ...
    def getFireworkMainIval(self):
        ...
        if not self.fireworkMainIval:
            ...
            self.fireworkMainIval.append(
                Sequence(
                    Wait(self.burstDelay - 0.1), Func(self.cleanupTrailEffects),
    ...
    def getBurstEffectsIval(self):
        if not self.burstEffectsIval:
            ...
            if flash:
                ...
                flash.fadeTime = 0.5
                self.burstEffectsIval.append(
                    Sequence(Wait(0.1), flash.getTrack()))
            ...
            if primaryBlast:
                ...
                self.burstEffectsIval.append(
                    Sequence(Wait(0.1), primaryBlast.getTrack()))
            ...
            if base.options.getSpecialEffectsSetting(
                ...
                if secondaryBlast:
                    ...
                    self.burstEffectsIval.append(
                        Sequence(Wait(0.1), secondaryBlast.getTrack()))
            ...
            if self.burstTypeId == FireworkBurstType.Sparkles:
                ...
                if sparkles:
                    ...
                    self.burstEffectsIval.append(
                        Sequence(Wait(0.1), sparkles.getTrack()))
            ...
            if self.burstTypeId == FireworkBurstType.BasicShell:
                ...
                if explosion:
                    ...
                    explosion.setEffectColor(self.primaryColor)
                    self.burstEffectsIval.append(
                        Sequence(Wait(0.12), explosion.getTrack()))
                    self.burstEffects.append(explosion)
                ...
                if skullFlash:
                    ...
                    self.burstEffectsIval.append(
                        Sequence(Wait(0.12), skullFlash.getTrack()))
                ...
                if base.options.getSpecialEffectsSetting(
                    ...
                    if sparkles:
                        ...
                        sparkles.setEffectColor(self.secondaryColor)
                        self.burstEffectsIval.append(
                            Sequence(Wait(0.12), sparkles.getTrack()))
                        self.burstEffects.append(sparkles)
