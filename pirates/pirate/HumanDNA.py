...
pirateModelTypes = ['sf', 'ms', 'mi', 'tp', 'tm']
pirateHeadTypes = ['a', 'b', 'c', 'd', 'e']
availableHairColors = [0, 1, 2, 3, 4, 5, 6, 7]
hairColors = [
...
class PirateHead:
    ...
    def __str__(self):
        string = '--shape--\n\t' + 'headWidth %s, headHeight %s, headRoundness %s\n\t' % (
            self.headWidth, self.headHeight, self.headRoundness
        ) + 'jawWidth %s, jawChinSize %s, jawAngle %s, jawLength %s\n\t' % (
            self.jawWidth, self.jawChinSize, self.jawAngle, self.jawLength
        ) + 'face %s\n\t' % self.texture + '--mouth--\n\t' + 'mouthWidth %s, mouthLipThickness %s, \n\t' % (
            self.mouthWidth, self.mouthLipThickness
        ) + 'cheekFat %s, teeth %s\n\t' % (
            self.cheekFat, self.teeth
        ) + '--eyes--\n\t' + 'browProtruding %s\n\t' % self.browProtruding + 'eyeCorner %s, eyeOpeningSize  %s, eyeSpace %s\n\t' % (
            self.eyeCorner, self.eyeOpeningSize, self.eyeBulge
        ) + 'eye %s\n\t' % self.eyes + '--nose--\n\t' + 'noseBridgeWidth %s, noseNostrilWidth %s, noseLength %s, noseBump %s\n\t' % (
            self.noseBridgeWidth, self.noseNostrilWidth, self.noseLength,
            self.noseBump
        ) + 'noseNostrilHeight %s, noseNostrilAngle %s, noseNostrilIndent %s\n\t' % (
            self.noseNostrilHeight, self.noseNostrilAngle,
            self.noseNostrilIndent
        ) + 'noseBridgeBroke %s, noseNostrilBroke %s\n\t' % (
            self.noseBridgeBroke, self.noseNostrilBroke
...
class PirateClothes:
    ...
    def __str__(self):
        string = 'shirt %s:%s:%s, vest %s:%s:%s, coat %s:%s:%s, pant %s:%s:%s,%s, belt %s:%s:%s, hat %s:%s:%s, sock %s:%s, shoe %s:%s' % (
            ...
            self.hat, self.hatTexture, self.hatColor, self.sock,
            self.sockTexture, self.shoe, self.shoeTexture)
        return string
...
class HumanDNA(AvatarDNA.AvatarDNA):
    ...
    def saveAsNPCDict(self):
        ...
        d[HumanDNA.setClothesShirt] = (self.clothes.shirt,
                                       self.clothes.shirtTexture)
        d[HumanDNA.setClothesPant] = (self.clothes.pant,
                                      self.clothes.pantTexture)
        d[HumanDNA.setClothesSock] = (self.clothes.sock,
                                      self.clothes.sockTexture)
        d[HumanDNA.setClothesShoe] = (self.clothes.shoe,
                                      self.clothes.shoeTexture)
        d[HumanDNA.setClothesVest] = (self.clothes.vest,
                                      self.clothes.vestTexture)
        d[HumanDNA.setClothesCoat] = (self.clothes.coat,
                                      self.clothes.coatTexture)
        d[HumanDNA.setClothesBelt] = (self.clothes.belt,
                                      self.clothes.beltTexture)
        d[HumanDNA.setClothesTopColor] = (self.clothes.shirtColor,
                                          self.clothes.vestColor,
                                          self.clothes.coatColor)
        d[HumanDNA.setClothesBotColor] = (self.clothes.pantColor,
                                          self.clothes.sashColor,
                                          self.clothes.shoeColor)
        d[HumanDNA.setTattooChest] = (self.tattooChest[0], self.tattooChest[1],
                                      self.tattooChest[2], self.tattooChest[3],
                                      self.tattooChest[4], self.tattooChest[5])
        d[HumanDNA.setTattooZone2] = (self.tattooZone2[0], self.tattooZone2[1],
                                      self.tattooZone2[2], self.tattooZone2[3],
                                      self.tattooZone2[4], self.tattooZone2[5])
        d[HumanDNA.setTattooZone3] = (self.tattooZone3[0], self.tattooZone3[1],
                                      self.tattooZone3[2], self.tattooZone3[3],
                                      self.tattooZone3[4], self.tattooZone3[5])
        d[HumanDNA.setTattooZone4] = (self.tattooZone4[0], self.tattooZone4[1],
                                      self.tattooZone4[2], self.tattooZone4[3],
                                      self.tattooZone4[4], self.tattooZone4[5])
        d[HumanDNA.setTattooZone5] = (self.tattooZone5[0], self.tattooZone5[1],
                                      self.tattooZone5[2], self.tattooZone5[3],
                                      self.tattooZone5[4], self.tattooZone5[5])
        d[HumanDNA.setTattooZone6] = (self.tattooZone6[0], self.tattooZone6[1],
                                      self.tattooZone6[2], self.tattooZone6[3],
                                      self.tattooZone6[4], self.tattooZone6[5])
        d[HumanDNA.setTattooZone7] = (self.tattooZone7[0], self.tattooZone7[1],
                                      self.tattooZone7[2], self.tattooZone7[3],
                                      self.tattooZone7[4], self.tattooZone7[5])
        d[HumanDNA.setTattooZone8] = (self.tattooZone8[0], self.tattooZone8[1],
                                      self.tattooZone8[2], self.tattooZone8[3],
                                      self.tattooZone8[4], self.tattooZone8[5])
        d[HumanDNA.setJewelryZone1] = (self.jewelryZone1[0],
                                       self.jewelryZone1[1],
                                       self.jewelryZone1[2])
        d[HumanDNA.setJewelryZone2] = (self.jewelryZone2[0],
                                       self.jewelryZone2[1],
                                       self.jewelryZone2[2])
        d[HumanDNA.setJewelryZone3] = (self.jewelryZone3[0],
                                       self.jewelryZone3[1],
                                       self.jewelryZone3[2])
        d[HumanDNA.setJewelryZone4] = (self.jewelryZone4[0],
                                       self.jewelryZone4[1],
                                       self.jewelryZone4[2])
        d[HumanDNA.setJewelryZone5] = (self.jewelryZone5[0],
                                       self.jewelryZone5[1],
                                       self.jewelryZone5[2])
        d[HumanDNA.setJewelryZone6] = (self.jewelryZone6[0],
                                       self.jewelryZone6[1],
                                       self.jewelryZone6[2])
        d[HumanDNA.setJewelryZone7] = (self.jewelryZone7[0],
                                       self.jewelryZone7[1],
                                       self.jewelryZone7[2])
        d[HumanDNA.setJewelryZone8] = (self.jewelryZone8[0],
                                       self.jewelryZone8[1],
                                       self.jewelryZone8[2])
        return d
    ...
    def setTattooChest(self, tattoo, offsetX, offsetY, scale, rotate, color):
        self.tattooChest = [tattoo, offsetX, offsetY, scale, rotate, color]

    def setTattooZone2(self, tattoo, offsetX, offsetY, scale, rotate, color):
        self.tattooZone2 = [tattoo, offsetX, offsetY, scale, rotate, color]

    def setTattooZone3(self, tattoo, offsetX, offsetY, scale, rotate, color):
        self.tattooZone3 = [tattoo, offsetX, offsetY, scale, rotate, color]

    def setTattooZone4(self, tattoo, offsetX, offsetY, scale, rotate, color):
        self.tattooZone4 = [tattoo, offsetX, offsetY, scale, rotate, color]

    def setTattooZone5(self, tattoo, offsetX, offsetY, scale, rotate, color):
        self.tattooZone5 = [tattoo, offsetX, offsetY, scale, rotate, color]

    def setTattooZone6(self, tattoo, offsetX, offsetY, scale, rotate, color):
        self.tattooZone6 = [tattoo, offsetX, offsetY, scale, rotate, color]

    def setTattooZone7(self, tattoo, offsetX, offsetY, scale, rotate, color):
        self.tattooZone7 = [tattoo, offsetX, offsetY, scale, rotate, color]

    def setTattooZone8(self, tattoo, offsetX, offsetY, scale, rotate, color):
        self.tattooZone8 = [tattoo, offsetX, offsetY, scale, rotate, color]
    ...
    def getTutorial(self):
        if base.config.GetBool('ignore-teleport-requirements', True):
    ...
    def lookupClothesTopColor(self):
        ...
        try:
            ...
            return [
                clothesTopColors[idx][0], clothesTopColors[idx][5],
    ...
    def lookupClothesBotColor(self):
        ...
        try:
            ...
            return [
                clothesBotColors[idx][0], clothesBotColors[idx][7],
    ...
    def makeNPCNavySailor(self, seed=None, gender='m'):
        ...
        self.body.shape = randomGen.choice([1, 2, 3, 4])
    ...
    def makeFromNetString(self, netString):
        ...
        # Tattoo
        self.setTattooChest(dgi.getUint16(), dgi.getFloat64(), dgi.getFloat64(),
                            dgi.getFloat64(), dgi.getFloat64(), dgi.getUint16())
        self.setTattooZone2(dgi.getUint16(), dgi.getFloat64(), dgi.getFloat64(),
                            dgi.getFloat64(), dgi.getFloat64(), dgi.getUint16())
        self.setTattooZone3(dgi.getUint16(), dgi.getFloat64(), dgi.getFloat64(),
                            dgi.getFloat64(), dgi.getFloat64(), dgi.getUint16())
        self.setTattooZone4(dgi.getUint16(), dgi.getFloat64(), dgi.getFloat64(),
                            dgi.getFloat64(), dgi.getFloat64(), dgi.getUint16())
        self.setTattooZone5(dgi.getUint16(), dgi.getFloat64(), dgi.getFloat64(),
                            dgi.getFloat64(), dgi.getFloat64(), dgi.getUint16())
        self.setTattooZone6(dgi.getUint16(), dgi.getFloat64(), dgi.getFloat64(),
                            dgi.getFloat64(), dgi.getFloat64(), dgi.getUint16())
        self.setTattooZone7(dgi.getUint16(), dgi.getFloat64(), dgi.getFloat64(),
                            dgi.getFloat64(), dgi.getFloat64(), dgi.getUint16())
        self.setTattooZone8(dgi.getUint16(), dgi.getFloat64(), dgi.getFloat64(),
                            dgi.getFloat64(), dgi.getFloat64(), dgi.getUint16())
