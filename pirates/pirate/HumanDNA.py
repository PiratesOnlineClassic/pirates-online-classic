...
class HumanDNA(AvatarDNA.AvatarDNA):
    ...
    def lookupClothesTopColor(self):
        ...
        try:
            return [
             clothesTopColors[idx][self.clothes.shirtColor], clothesTopColors[idx][self.clothes.vestColor], clothesTopColors[idx][self.clothes.coatColor]]
        except:
            return [
             clothesTopColors[idx][0], clothesTopColors[idx][5], clothesTopColors[idx][10]]
    ...
    def lookupClothesBotColor(self):
        ...
        try:
            return [
             clothesBotColors[idx][self.clothes.pantColor], clothesBotColors[idx][self.clothes.sashColor], clothesBotColors[idx][self.clothes.shoeColor]]
        except:
            return [
             clothesBotColors[idx][0], clothesBotColors[idx][7], clothesBotColors[idx][12]]
