...
class BipedAnimationMixer(AnimationMixer):
    ...
    AnimRankings = {
        ...
        'idle_handhip_from_idle': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                   ACTION['INPLACE_1']),
        ...
        'idle_head_scratch': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                              ACTION['INPLACE_1']),
        'idle_head_scratch_side': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                   ACTION['INPLACE_1']),
        'kraken_struggle_idle': (LOOP['IDLE'], LOOP['IDLE'], LOOP['IDLE']),
        'kraken_fight_idle': (LOOP['IDLE'], LOOP['IDLE'], LOOP['IDLE']),
        'map_head_into_look_left': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                    ACTION['INPLACE_1']),
        'map_head_outof_look_left': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                     ACTION['INPLACE_1']),
        ...
        'semi_conscious_standup': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                   ACTION['INPLACE_1']),
        ...
        'bar_talk01_outof_look': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                  ACTION['INPLACE_1']),
        ...
        'bar_talk02_outof_look': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                  ACTION['INPLACE_1']),
        ...
        'barrel_hide_into_look': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                  ACTION['INPLACE_1']),
        'barrel_hide_look_idle': (LOOP['IDLE'], LOOP['IDLE'], LOOP['IDLE']),
        'barrel_hide_outof_look': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                   ACTION['INPLACE_1']),
        'sit_hanginglegs_outof_look': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                       ACTION['INPLACE_1']),
        'sit_hanginglegs_look_idle': (LOOP['IDLE'], LOOP['IDLE'], LOOP['IDLE']),
        'sit_hanginglegs_into_look': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                      ACTION['INPLACE_1']),
        ...
        'sleep_sick_outof_look': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                  ACTION['INPLACE_1']),
        ...
        'tatoo_receive_into_look': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                    ACTION['INPLACE_1']),
        'tatoo_receive_look_idle': (LOOP['IDLE'], LOOP['IDLE'], LOOP['IDLE']),
        'tatoo_receive_outof_look': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                     ACTION['INPLACE_1']),
        ...
        'doctor_work_into_look': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                  ACTION['INPLACE_1']),
        'doctor_work_look_idle': (LOOP['IDLE'], LOOP['IDLE'], LOOP['IDLE']),
        'doctor_work_outof_look': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                   ACTION['INPLACE_1']),
        ...
        'boxing_fromidle': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                            ACTION['INPLACE_1']),
        'boxing_hit_head_right': (ACTION['INPLACE_0'], ACTION['INMOTION_1'],
                                  ACTION['INMOTION_1']),
        ...
        'bigbomb_charge_loop': (ACTION['INPLACE_1'], ACTION['INMOTION_2'],
                                ACTION['INMOTION_2']),
        'bigbomb_charge_throw': (ACTION['INPLACE_1'], ACTION['INMOTION_2'],
                                 ACTION['INMOTION_2']),
        ...
        (ACTION['INPLACE_1'], ACTION['INMOTION_2'], ACTION['INMOTION_2']),
        ...
        'blacksmith_work_into_look': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                      ACTION['INPLACE_1']),
        'blacksmith_work_outof_look': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                       ACTION['INPLACE_1']),
        ...
        'cards_set_down_win': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                               ACTION['INPLACE_1']),
        'cards_set_down_win_show': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                    ACTION['INPLACE_1']),
        ...
        'tread_water_into_teleport': (ACTION['INPLACE_1'], ACTION['INPLACE_1'],
                                      ACTION['INPLACE_1']),
        'rope_grab': (ACTION['INMOTION_2'], ACTION['INMOTION_2'],
                      ACTION['INMOTION_2']),
        'rope_grab_from_idle': (ACTION['INMOTION_2'], ACTION['INMOTION_2'],
                                ACTION['INMOTION_2']),
        ...
        (ACTION['INPLACE_0'], ACTION['INMOTION_1'], ACTION['INMOTION_1']),
        'sand_in_eyes_wWeapon': (ACTION['INPLACE_0'], ACTION['INMOTION_1'],
                                 ACTION['INMOTION_1']),
