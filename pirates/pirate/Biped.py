...
ACTION_INDEX = 4
msfCustomAnimList = [
 'idle', 'bayonet_drill', 'bayonet_run', 'bayonet_attack_idle', 'bayonet_attackA', 'bayonet_attackB', 'bayonet_attackC', 'bigbomb_draw', 'bigbomb_idle', 'bigbomb_throw', 'bigbomb_walk', 'cards_blackjack_hit', 'cards_blackjack_stay', 'emote_anger', 'emote_clap', 'emote_fear', 'emote_sad', 'emote_wave', 'emote_yes', 'bomb_draw', 'bomb_idle', 'bomb_throw', 'cards_check', 'cards_hide', 'cards_hide_hit', 'cards_hide_idle', 'cards_pick_up', 'cards_pick_up_idle', 'cards_set_down', 'cards_set_down_win', 'cards_set_down_lose', 'cards_cheat', 'cards_good_tell', 'cards_bad_tell', 'dagger_combo', 'deal', 'deal_idle', 'idle_arm_scrach', 'idle_head_scratch_side', 'idle_head_scratch', 'idle_butt_scratchinto_deal', 'jail_dropinto', 'repairfloor_into', 'repairfloor_outof', 'run', 'run_with_weapon', 'sit', 'sleep_idle', 'sweep', 'staff_receive', 'voodoo_doll_poke']
mmsCustomAnimList = [
 'idle']
mmiCustomAnimList = [
 'bayonet_drill', 'bayonet_attackA', 'bayonet_attack_idle', 'bayonet_run', 'bayonet_attack_idle', 'bayonet_attackB', 'bayonet_attackC', 'emote_clap', 'idle', 'idle_arm_scratch', 'run', 'sweep']
mtpCustomAnimList = [
 'idle_butt_scratch', 'bayonet_drill', 'bigbomb_draw', 'bigbomb_idle', 'bigbomb_throw', 'bigbomb_walk', 'bomb_draw', 'bomb_idle', 'bomb_throw', 'cards_check', 'cards_hidecards_hide_idle', 'cards_pick_up', 'cards_pick_up_idle', 'cards_set_down', 'cards_set_down_win', 'cards_set_down_lose', 'cards_cheat', 'cards_good_tell', 'cards_bad_tell', 'dagger_combo', 'deal', 'deal_idle', 'idle', 'into_deal', 'run', 'sit', 'voodoo_doll_poke']
mtmCustomAnimList = [
 'bayonet_drill', 'bayonet_attackA', 'bayonet_attack_idle', 'bayonet_run', 'bayonet_attack_idle', 'bayonet_attackB', 'bayonet_attackC', 'emote_clap', 'emote_fear', 'death4', 'idle_butt_scratch', 'idle_arm_scratch', 'sow_idle', 'sow_into_look', 'sow_outof_look', 'run', 'sweep', 'idle']
fsfCustomAnimList = [
 'bayonet_attack_idle', 'bayonet_run', 'bayonet_attackB', 'bayonet_attackC', 'bigbomb_draw', 'bigbomb_idle', 'bigbomb_throw', 'bomb_draw', 'bomb_idle', 'bomb_throw', 'cards_bad_tell', 'cards_cheat', 'cards_good_tell', 'cards_hide', 'cards_hide_idle', 'cards_pick_up', 'cards_pick_up_idle', 'cards_set_down', 'cards_set_down_lose', 'cards_set_down_win', 'emote_anger', 'emote_clap', 'emote_fear', 'emote_wave', 'cutlass_bladestorm', 'cutlass_combo', 'cutlass_headbutt', 'cutlass_kick', 'cutlass_sweep', 'cutlass_taunt', 'dagger_asp', 'deal', 'deal_idle', 'drink_potion', 'emote_no', 'emote_sad', 'emote_yes', 'into_deal', 'kneel', 'kneel_fromidle', 'emote_laugh', 'repairfloor_idle', 'repairfloor_into', 'repairfloor_outof', 'run', 'run_with_weapon', 'sit', 'sleep_idle', 'sleep_into_look', 'sleep_outof_look', 'emote_smile', 'sweep', 'sword_draw', 'sword_hit', 'sword_idle', 'teleport', 'tentacle_idle', 'tentacle_squeeze', 'voodoo_draw', 'voodoo_idle', 'voodoo_doll_poke', 'yawn']
fmsCustomAnimList = []
fmiCustomAnimList = []
ftpCustomAnimList = [
 'run']
...
jsCustomAnimList = (
 (
  'idle', 'js_idle'), ('sit_idle', 'js_playing_cards_idle'), ('into_sit_speak_idle', 'js_playing_cards_into_look'), ('sit_speak_idle', 'js_playing_cards_look_idle'), ('outof_sit_speak_idle', 'js_playing_cards_outof_look'), ('hands_on_hips', 'js_handsOnHips'), ('idle_to_bow', 'js_idleToBow'), ('special_bow', 'js_tv_bow'), ('walk_camera', 'js_walk_camera'))
wtCustomAnimList = (
 (
...
jrCustomAnimList = (
 (
  'idle', 'jr_look_idle'), ('jr_look_idle', 'jr_look_idle'), ('jr_look_idle_2', 'jr_look_idle_2'))
plfCustomAnimList = (
 (
...
Biped.setupAnimInfo()
Biped.initSfx()
# okay decompiling .\pirates\pirate\Biped.pyc
