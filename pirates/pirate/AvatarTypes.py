...
NPC_SPAWNABLES = {'Skeleton': [lambda p0=0, p1=3: pickEarthUndead(p0, p1)],
   ...
   'French Undead Quarter Master': [lambda p0=FrenchUndeadB: typePassthrough(p0)],
   ...
   'Spanish Undead Conquistador': [lambda p0=SpanishUndeadA: typePassthrough(p0)],
...
NPC_SPAWNABLES_KEYS = ['Noob Skeleton', 'Low Skeleton', 'Early Skeleton', 'Mid Skeleton', 'Mean Skeleton', 'High Skeleton', 'Fierce Skeleton',
                      'Elite Skeleton', 'Low EITC', 'Mid EITC', 'High EITC', 'Crab', 'Rock Crab', 'Giant Crab', 'Scorpion', 'Dread Scorpion', 'Alligator',
                      'Big Gator', 'Huge Gator', 'Bat', 'Vampire Bat', 'Wasp', 'Angry Wasp', 'FlyTrap', 'Stump', 'Noob Navy', 'Low Navy', 'Mid Navy',
                      'High Navy', 'Low DJCrew', 'Early DJCrew', 'Mid DJCrew', 'Mean DJCrew', 'High DJCrew', 'Fierce DJCrew', 'Elite DJCrew', 'Area',
                      'French Undead', 'French Undead Low', 'French Undead Mid', 'French Undead High', 'French Undead Maitre', 'French Undead Quarter Master',
                      'French Undead Lieutenant', 'French Undead Capitaine', 'Spanish Undead', 'Spanish Undead Low', 'Spanish Undead Mid', 'Spanish Undead High',
                      'Spanish Undead Conquistador', 'Spanish Undead Bandido', 'Spanish Undead Pirata', 'Spanish Undead Captain']

def buildEditorSpawnableTypes():
    category = [[['Cadet', 'Guard', 'Sergeant', 'Veteran', 'Officer'], 'Navy - '],
                [['Thug', 'Grunt', 'Hiredgun', 'Mercenary', 'Assassin'], 'EITC - '],
                [['Clod', 'Sludge', 'Mire', 'Muck', 'Corpse', 'Carrion', 'Cadaver', 'Zombie', 'CaptMudmoss', 'Mossman', 'Drip', 'Damp',
                  'Drizzle', 'Spray', 'Splatter', 'Drool', 'Drench', 'Douse', 'CaptBriney', 'Spout'], 'Undead - ']]
