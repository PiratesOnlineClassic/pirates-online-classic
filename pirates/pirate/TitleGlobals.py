...
FounderBreakpoints = [
    ...
    1]
TitlesDict = {
    ShipPVPTitle: ('models/textureCards/skillIcons', shipPVPIcons, standardScale, PLocalizer.PVPTitleSeaName, PLocalizer.PVPTitleSeaRanks, PLocalizer.PVPTitleSeaDesc, RenownBreakpointsSea, InventoryType.PVPTotalInfamySea, 0),
    LandPVPTitle: ('models/textureCards/skillIcons', shipPVPIcons, standardScale, PLocalizer.PVPTitleLandName, PLocalizer.PVPTitleLandRanks, PLocalizer.PVPTitleLandDesc, RenownBreakpointsLand, InventoryType.PVPTotalInfamyLand, 0),
