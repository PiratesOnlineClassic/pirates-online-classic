...
class Wasp(Creature):
    ...
    sfx = {}
    AnimList = (('idle', 'idle'), ('idle_flying', 'idle_fly'), ('walk', 'walk'),
                ('drop', 'react_drop'), ('advance', 'attack_advance'),
                ('sting', 'attack_sting'), ('leap_sting', 'attack_leap_sting'),
                ('pain', 'react_pull_back'), ('death', 'react_death'))
    ...
    def setupAnimInfo(cls):
        cls.setupAnimInfoState(
            'LandRoam',
            (('idle_flying', 1.0), ('idle_flying', 1.0), ('idle_flying', 1.0),
             ('idle_flying', 1.0), ('idle_flying', 1.0), ('idle_flying', 1.0),
             ('idle_flying', 1.0), ('idle_flying', 1.0), ('idle_flying', 1.0),
             ('idle_flying', 1.0), ('idle_flying', 1.0), ('idle_flying', 1.0)))
        cls.setupAnimInfoState(
