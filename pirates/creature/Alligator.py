...
class Alligator(Creature):
    ...
    SfxNames.update({
        'death': 'sfx_alligator_death.mp3',
        'pain': 'sfx_alligator_flinch_left.mp3'
    })
    sfx = {}
    AnimList = (('idle', 'idle'), ('walk', 'walk'), ('run', 'run'), ('swim',
                                                                     'swim'),
                ('swim_alt', 'swim_alt'), ('pull_back',
                                           'pull_back'), ('pain', 'pull_back'),
                ('attack_left',
                 'attack_left'), ('attack_right',
                                  'attack_right'), ('attack_straight',
                                                    'attack_straight'),
                ('flinch_left', 'flinch_left'), ('flinch_right',
                                                 'flinch_right'), ('death',
                                                                   'death'))
    ...
    def setupAnimInfo(cls):
        cls.setupAnimInfoState('LandRoam',
                               (('idle', 1.0), ('walk', 1.0), ('run', 1.0),
                                ...
                                ('run', 1.0), ('run', 1.0), ('walk', 1.0),
                                ('walk', 1.0), ('idle', 1.0), ('idle', 1.0)))
        cls.setupAnimInfoState(
            'WaterRoam',
            (('swim', 1.0), ('swim', 1.0), ('swim_alt', 1.0), ('swim', -1.0),
             ('swim_alt', 1.0), ('swim_alt', 1.0), ('swim_alt', 1.0),
             ('swim_alt', 1.0), ('swim_alt', 1.0), ('swim', 1.0), ('idle', 1.0),
             ('idle', 1.0)))
    ...
    def __init__(self):
        ...
        if not Alligator.sfx:
            for name in Alligator.SfxNames:
                Alligator.sfx[name] = loader.loadSfx('audio/' +
                                                     Alligator.SfxNames[name])
