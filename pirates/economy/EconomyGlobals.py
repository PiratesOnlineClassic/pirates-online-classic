...
__pouchTypeToAmmo = {
  ItemType.PISTOL_POUCH: [ItemId.VENOMSHOT, ItemId.IRONSHOT, ItemId.GOLDENSHOT, ItemId.SILVERSHOT, ItemId.STEELSHOT],
  ItemType.DAGGER_POUCH: [ItemId.ASP_DAGGER, ItemId.ADDER_DAGGER, ItemId.SIDEWINDER_DAGGER, ItemId.VIPERNEST_DAGGER],
  ItemType.GRENADE_POUCH: [ItemId.EXPLOSION_G, ItemId.SHOCKBOMB_G, ItemId.FLAME_G, ItemId.SMOKE_G, ItemId.SIEGE_G],
  ItemType.CANNON_POUCH: [ItemId.CHAIN_SHOT, ItemId.GRAPE_SHOT, ItemId.FIREBRAND, ItemId.THUNDERBOLT, ItemId.EXPLOSIVE, ItemId.FURY]
}
