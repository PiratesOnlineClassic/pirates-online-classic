...
class Wand(Weapon.Weapon):
    modelTypes = {
        InventoryType.WandWeaponL1: ('models/handheld/voodoo_staff_high',
                                     Vec4(1, 1, 1, 1)),
        InventoryType.WandWeaponL2: ('models/handheld/voodoo_staff_a_high',
                                     Vec4(1, 1, 1, 1)),
        InventoryType.WandWeaponL3: ('models/handheld/voodoo_staff_b_high',
                                     Vec4(1, 1, 1, 1)),
        InventoryType.WandWeaponL4: ('models/handheld/voodoo_staff_c_high',
                                     Vec4(1, 1, 1, 1)),
        InventoryType.WandWeaponL5: ('models/handheld/voodoo_staff_d_high',
                                     Vec4(1, 1, 1, 1)),
        InventoryType.WandWeaponL6: ('models/handheld/voodoo_staff_e_high',
                                     Vec4(1, 1, 1, 1))
    }
    colorAndOffset = {
    ...
    def getDrawIval(self, av, ammoSkillId=0, blendInT=0.1, blendOutT=0):
        ...
        track = Parallel(
            ...
            av.actorInterval(
                ...
                blendInT=blendInT,
                blendOutT=blendOutT),
            Sequence(Wait(0.56), Func(self.attachTo, av)))
        del playSfx
        return track
    ...
    def startChargeEffect(self):
        ...
        if self.gem and not self.gem.isEmpty():
            ...
            self.gem.node().setAttrib(
                ColorBlendAttrib.make(ColorBlendAttrib.MAdd,
                                      ColorBlendAttrib.OOne,
                                      ColorBlendAttrib.OIncomingAlpha))
            fadeIn = LerpColorScaleInterval(
                self.gem, 0.5, color / 1.3, startColorScale=color)
            fadeOut = LerpColorScaleInterval(
                self.gem, 0.5, color, startColorScale=color / 1.3)
    ...
    def setupSounds(cls):
        ...
        Wand.soulflayChargeSfx = loader.loadSfx(
            'audio/sfx_wand_soul_flay_charge.mp3')
        Wand.soulflayHoldSfx = loader.loadSfx(
            'audio/sfx_wand_soul_flay_hold.wav')
        Wand.soulflayFireSfx = loader.loadSfx(
            'audio/sfx_wand_soul_flay_fire.mp3')
        Wand.soulflayHitSfx = loader.loadSfx(
            'audio/sfx_wand_soul_flay_impact.mp3')
        Wand.pestilenceChargeSfx = loader.loadSfx(
            'audio/sfx_wand_pestilence_charge.mp3')
        Wand.pestilenceHoldSfx = loader.loadSfx(
            'audio/sfx_wand_pestilence_hold.wav')
        Wand.pestilenceFireSfx = loader.loadSfx(
            'audio/sfx_wand_pestilence_fire.mp3')
        Wand.pestilenceHitSfx = loader.loadSfx(
            'audio/sfx_wand_pestilence_impact.mp3')
        Wand.witherChargeSfx = loader.loadSfx(
            'audio/sfx_wand_wither_charge.mp3')
        ...
        Wand.hellfireChargeSfx = loader.loadSfx(
            'audio/sfx_wand_hellfire_charge.mp3')
        Wand.hellfireHoldSfx = loader.loadSfx(
            'audio/sfx_wand_hellfire_hold.wav')
        Wand.hellfireFireSfx = loader.loadSfx(
            'audio/sfx_wand_hellfire_fire.mp3')
        Wand.hellfireHitSfx = loader.loadSfx(
            'audio/sfx_wand_hellfire_impact.mp3')
        Wand.banishChargeSfx = loader.loadSfx(
            'audio/sfx_wand_banish_charge.mp3')
        ...
        Wand.desolationChargeSfx = loader.loadSfx(
            'audio/sfx_wand_desolation_charge.mp3')
        Wand.desolationHoldSfx = loader.loadSfx(
            'audio/sfx_wand_desolation_hold.wav')
        Wand.desolationFireSfx = loader.loadSfx(
            'audio/sfx_wand_desolation_fire.mp3')
        Wand.desolationHitSfx = loader.loadSfx(
            'audio/sfx_wand_desolation_impact.mp3')
