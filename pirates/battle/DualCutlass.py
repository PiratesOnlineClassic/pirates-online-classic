...
class DualCutlass(Weapon.Weapon):
    modelTypes = {
        InventoryType.DualCutlassL1: ('models/handheld/cutlass_rusty_high',
                                      Vec4(1, 1, 1, 1))
    }
    models = {}
    icons = {}
    ...
    @classmethod
    def setupSounds(cls):
        DualCutlass.hitSfxs = (loader.loadSfx('audio/sword-clashNclang.mp3'),
        ...
        DualCutlass.missSfxs = (loader.loadSfx('audio/sword-swoosh1.mp3'),
