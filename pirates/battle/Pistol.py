...
class Pistol(Weapon.Weapon):
    modelTypes = {InventoryType.PistolWeaponL1: ('models/handheld/pistol_high', Vec4(1, 1, 1, 1)),
    ...
    def setupSounds(cls):
        ...
        Pistol.missSfxs = (
         loader.loadSfx('audio/gunshot1.mp3'),)
        Pistol.aimSfxs = (
         loader.loadSfx('audio/musketCock.mp3'),)
        Pistol.skillSfxs = {InventoryType.PistolShoot: loader.loadSfx('audio/sfx_pistol_shoot.mp3'), InventoryType.PistolTakeAim: loader.loadSfx('audio/sfx_pistol_shoot.mp3')}
