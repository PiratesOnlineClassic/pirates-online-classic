...
class Dagger(Weapon.Weapon):
    ...
    modelTypes = {
        InventoryType.DaggerWeaponL1: ('models/handheld/dagger_high',
                                       Vec4(1, 1, 1, 1)),
        InventoryType.DaggerWeaponL2: ('models/handheld/dagger_dirk_high',
                                       Vec4(1, 1, 1, 1)),
        InventoryType.DaggerWeaponL3: ('models/handheld/dagger_gauche_high',
                                       Vec4(1, 1, 1, 1)),
        InventoryType.DaggerWeaponL4: ('models/handheld/dagger_coltello_high',
                                       Vec4(1, 1, 1, 1)),
        InventoryType.DaggerWeaponL5:
        ('models/handheld/dagger_bloodletter_high', Vec4(1, 1, 1, 1)),
        InventoryType.DaggerWeaponL6: ('models/handheld/dagger_slicer_high',
                                       Vec4(1, 1, 1, 1))
    }
    models = {}
    icons = {}
    vertex_list = [Vec4(0.0, 0.4, 0.0, 1.0), Vec4(0.0, 2.0, 0.0, 1.0)]
    motion_color = [Vec4(0.3, 0.4, 0.6, 1.0), Vec4(0.7, 0.7, 0.8, 1.0)]
    ...
    def getDrawIval(self, av, ammoSkillId=0, blendInT=0.1, blendOutT=0):
        ...
        track = Parallel(
            ...
            av.actorInterval(
                ...
                blendInT=blendInT,
                blendOutT=blendOutT),
            Sequence(Wait(0.187), Func(self.attachTo, av)))
        del playSfx
        return track
    ...
    def getReturnIval(self, av, blendInT=0, blendOutT=0.1):
        track = Parallel(
            av.actorInterval(
                ...
                blendInT=blendInT,
                blendOutT=blendOutT),
            Sequence(Wait(0.56), Func(self.detachFrom, av)))
        return track
    ...
    def getCut(self, av, skillId, ammoSkillId, charge, target):
        ival = Parallel(
            ...
            Sequence(
                Func(self.lockInput, av), Func(self.endAttack, av),
                Func(self.setTrailLength, 0.25), Func(self.beginAttack, av),
                av.actorInterval(
                    'dagger_combo',
                    playRate=1.0,
                    startFrame=1,
    ...
    def getSwipe(self, av, skillId, ammoSkillId, charge, target):
        ival = Parallel(
            ...
            Sequence(
                Func(self.lockInput, av), Func(self.endAttack, av),
                Func(self.setTrailLength, 0.3), Func(self.beginAttack, av),
                av.actorInterval(
                    'dagger_combo',
                    playRate=1.0,
                    startFrame=29,
                    endFrame=53,
                    blendInT=0.5,
                    blendOutT=0.5), Func(self.hideSpinBlur)),
            Sequence(Wait(0.583), Func(self.unlockInput, av)),
            Sequence(Wait(0.1), Func(self.showSpinBlur)))
        return ival
    ...
    def getGouge(self, av, skillId, ammoSkillId, charge, target):
        ival = Parallel(
            ...
            Sequence(
                Func(self.lockInput, av), Func(self.endAttack, av),
                Func(self.setTrailLength, 0.5), Func(self.beginAttack, av),
                av.actorInterval(
                    'dagger_combo',
                    playRate=1.0,
                    startFrame=54,
    ...
    def getEviscerate(self, av, skillId, ammoSkillId, charge, target):
        ival = Parallel(
            ...
            Sequence(
                Func(self.lockInput, av), Func(self.endAttack, av),
                Func(self.setTrailLength, 0.6), Func(self.beginAttack, av),
                av.actorInterval(
                    'dagger_combo',
                    playRate=1.0,
                    startFrame=88,
    ...
    def getDaggerThrowDirtInterval(self, av, skillId, ammoSkillId, charge,
        ...
        ival = Sequence(
            ...
            Func(self.hideMouse, av), Func(base.disableMouse),
            Func(self.endAttack, av), Func(self.setTrailLength, 0.25),
            Func(self.hideWeapon), Func(self.beginAttack, av),
            av.actorInterval(
                'dagger_throw_sand',
                playRate=1.0,
                startFrame=1,
                endFrame=10,
                blendInT=0.2,
                blendOutT=0), Func(self.playSkillSfx, skillId, av),
            Func(startVFX),
            av.actorInterval(
                'dagger_throw_sand',
                playRate=1.0,
                ...
                endFrame=38,
                blendInT=0,
                blendOutT=0.3), Func(self.showWeapon), Func(av.motionFSM.on),
    ...
    def getDaggerAspInterval(self, av, skillId, ammoSkillId, charge, target):
        ...
        track = Sequence(
            Func(self.lockInput, av), Func(self.setTrailLength, 0.25),
            Func(self.playSkillSfx, skillId, av),
            av.actorInterval(
            ...
            Parallel(
                ...
                Func(self.hideWeapon)), Func(self.showWeapon),
            Func(self.unlockInput, av))
        return track
        ...
        track = Sequence(
            ...
            Parallel(
                ...
                Func(
                    ...
                    targetPos,
                    motion_color,
                    roll=90), Func(self.hideWeapon)), Func(self.showWeapon),
            Func(self.unlockInput, av))
        return track
    ...
    def getDaggerViperNestInterval(self, av, skillId, ammoSkillId, charge,
        ...
        daggerTossIval = Parallel(
            Sequence(
                ...
                av.actorInterval(
                    ...
                    endFrame=35,
                    blendInT=0,
                    blendOutT=0.4), Func(self.showWeapon),
        ...
        track = Sequence(
            Func(av.motionFSM.off), Func(self.hideMouse, av),
            Func(self.hideWeapon), Func(self.playSkillSfx, skillId, av),
    ...
    @classmethod
    def setupSounds(cls):
        Dagger.missSfxs = (loader.loadSfx('audio/swordSwipeSingle-01.mp3'),
                           loader.loadSfx('audio/swordSwipeSingle-02.mp3'))
        Dagger.hitSfxs = (loader.loadSfx('audio/sfx_dagger_impact.mp3'),)
        Dagger.skillSfxs = {
            InventoryType.DaggerCut:
            loader.loadSfx('audio/sfx_dagger_cut.mp3'),
            InventoryType.DaggerSwipe:
            loader.loadSfx('audio/sfx_dagger_swipe.mp3'),
            InventoryType.DaggerGouge:
            loader.loadSfx('audio/sfx_dagger_gouge.mp3'),
            InventoryType.DaggerEviscerate:
            loader.loadSfx('audio/sfx_dagger_eviscerate.mp3'),
            InventoryType.DaggerAsp:
            loader.loadSfx('audio/sfx_dagger_thrown.mp3'),
            InventoryType.DaggerAdder:
            loader.loadSfx('audio/sfx_dagger_poison.mp3'),
            InventoryType.DaggerThrowDirt:
            loader.loadSfx('audio/sfx_dagger_throw_dirt.mp3'),
            InventoryType.DaggerSidewinder:
            loader.loadSfx('audio/sfx_dagger_sidewinder.mp3'),
