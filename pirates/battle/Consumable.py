...
__modelTypes = {
    ...
    InventoryType.Potion3: ('models/props/largejug_B', Vec4(0.2, 0.2, 1, 1),
                            0.24),
    InventoryType.Potion4: ('models/props/largejug_B', Vec4(0.2, 1.0, 0.2, 1),
                            0.24),
    InventoryType.Potion5: ('models/props/largejug_B', Vec4(0.7, 0.2, 1, 1),
                            0.24),
    InventoryType.ShipRepairKit: ('models/props/largejug_B', Vec4(1, 0.6, 1, 1),
                                  0.24),
    InventoryType.PorkChunk: ('models/handheld/pir_m_hnd_foo_porktonic',
                              Vec4(1, 1, 1, 1), 1.0)
}
...
def getMissSfx():
    global missSfxs
    if not missSfxs:
        missSfxs = (loader.loadSfx('audio/whoosh-10.mp3'),
