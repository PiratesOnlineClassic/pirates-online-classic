...
class Sword(Weapon.Weapon):
    modelTypes = {
        InventoryType.CutlassWeaponL1: ('models/handheld/cutlass_rusty_high',
                                        Vec4(1, 1, 1, 1)),
        InventoryType.CutlassWeaponL2: ('models/handheld/cutlass_iron_high',
                                        Vec4(1, 1, 1, 1)),
        InventoryType.CutlassWeaponL3: ('models/handheld/cutlass_steel_high',
                                        Vec4(1, 1, 1, 1)),
        InventoryType.CutlassWeaponL4: ('models/handheld/cutlass_fine_high',
                                        Vec4(1, 1, 1, 1)),
        InventoryType.CutlassWeaponL5:
        ('models/handheld/cutlass_pirateblade_high', Vec4(1, 1, 1, 1)),
        InventoryType.CutlassWeaponL6: ('models/handheld/cutlass_dark_high',
                                        Vec4(1, 1, 1, 1))
    }
    models = {}
    icons = {}
    ...
    def getDrawIval(self, av, ammoSkillId=0, blendInT=0.1, blendOutT=0):
        track = Parallel(
            Func(base.playSfx, self.drawSfx, node=av),
            av.actorInterval(
                'sword_draw',
                playRate=1.5,
                endFrame=15,
    ...
    def getReturnIval(self, av, blendInT=0, blendOutT=0.1):
        track = Parallel(
            Func(base.playSfx, self.returnSfx, node=av),
            av.actorInterval(
                'sword_putaway',
                playRate=2,
                endFrame=35,
    ...
    @classmethod
    def setupSounds(cls):
        Sword.hitSfxs = (loader.loadSfx('audio/sword-clashNclang.mp3'),
                         loader.loadSfx('audio/sword-swipeNclang1.mp3'),
                         loader.loadSfx('audio/sword-swipeNclang2.mp3'),
                         loader.loadSfx('audio/sword-swipeNclang3.mp3'))
        Sword.missSfxs = (loader.loadSfx('audio/sword-swoosh1.mp3'),
                          loader.loadSfx('audio/sword-swoosh2.mp3'))
        Sword.skillSfxs = {
            InventoryType.CutlassHack:
            loader.loadSfx('audio/sfx_cutlass_hack.mp3'),
            InventoryType.CutlassSlash:
            loader.loadSfx('audio/sfx_cutlass_slash.mp3'),
            InventoryType.CutlassStab:
            loader.loadSfx('audio/sfx_cutlass_stab.mp3'),
            InventoryType.CutlassFlourish:
            loader.loadSfx('audio/sfx_cutlass_flourish.mp3'),
            InventoryType.CutlassCleave:
            loader.loadSfx('audio/sfx_cutlass_cleave.mp3'),
            InventoryType.CutlassTaunt:
            loader.loadSfx('audio/sfx_cutlass_taunt.mp3'),
            InventoryType.CutlassBrawl:
            loader.loadSfx('audio/sfx_cutlass_brawl_headbutt.mp3'),
            InventoryType.CutlassSweep:
            loader.loadSfx('audio/sfx_cutlass_sweep.mp3'),
            InventoryType.CutlassBladestorm:
            loader.loadSfx('audio/sfx_cutlass_bladestorm.mp3')
        }
