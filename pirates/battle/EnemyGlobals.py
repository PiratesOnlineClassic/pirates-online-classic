...
ENABLED_INDEX = 6
__baseAvatarStats = {AvatarTypes.Undead: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Clod: [1, 3, 1.0, 5.0, 2.0, SKELETON, 1], AvatarTypes.Sludge: [2, 5, 1.0, 5.0, 2.0, SKELETON, 1], AvatarTypes.Mire: [4, 8, 1.0, 5.0, 2.0, SKELETON, 1], AvatarTypes.Muck: [7, 11, 1.0, 5.0, 2.0, SKELETON, 1], AvatarTypes.Corpse: [12, 18, 1.0, 5.0, 2.0, SKELETON, 1], AvatarTypes.Carrion: [17, 23, 1.0, 5.0, 2.0, SKELETON, 1], AvatarTypes.Cadaver: [22, 28, 1.0, 5.0, 2.0, SKELETON, 1], AvatarTypes.Zombie: [27, 33, 1.0, 5.0, 2.0, SKELETON, 1], AvatarTypes.CaptMudmoss: [32, 38, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Mossman: [19, 25, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Whiff: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Reek: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Billow: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Stench: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Shade: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Specter: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Phantom: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Wraith: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.CaptZephyr: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Squall: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Glint: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Flicker: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Smolder: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Spark: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Imp: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Brand: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Lumen: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Fiend: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.CaptCinderbones: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Torch: [1, 1, 1.0, 5.0, 2.0, SKELETON, 0], AvatarTypes.Drip: [22, 26, 1.0, 5.0, 2.0, MONSTER, 1], AvatarTypes.Damp: [24, 28, 1.0, 5.0, 2.0, MONSTER, 1], AvatarTypes.Drizzle: [26, 30, 1.0, 5.0, 2.0, MONSTER, 1], AvatarTypes.Spray: [28, 32, 1.0, 5.0, 2.0, MONSTER, 1], AvatarTypes.Splatter: [30, 34, 1.0, 5.0, 2.0, MONSTER, 1], AvatarTypes.Drool: [32, 36, 1.0, 5.0, 2.0, MONSTER, 1], AvatarTypes.Drench: [34, 38, 1.0, 5.0, 2.0, MONSTER, 1], AvatarTypes.Douse: [36, 40, 1.0, 5.0, 2.0, MONSTER, 1], AvatarTypes.CaptBriney: [38, 40, 1.0, 5.0, 2.0, MONSTER, 0], AvatarTypes.Spout: [40, 40, 1.0, 5.0, 2.0, MONSTER, 0], AvatarTypes.FrenchUndeadA: [10, 15, 1.0, 5.0, 2.0, SKELETON, 1], AvatarTypes.FrenchUndeadB: [15, 20, 1.0, 5.0, 2.0, SKELETON, 1], AvatarTypes.FrenchUndeadC: [20, 25, 1.0, 5.0, 2.0, SKELETON, 1], AvatarTypes.FrenchUndeadD: [25, 30, 1.0, 5.0, 2.0, SKELETON, 1], AvatarTypes.SpanishUndeadA: [10, 15, 1.0, 5.0, 2.0, SKELETON, 1], AvatarTypes.SpanishUndeadB: [15, 20, 1.0, 5.0, 2.0, SKELETON, 1], AvatarTypes.SpanishUndeadC: [20, 25, 1.0, 5.0, 2.0, SKELETON, 1], AvatarTypes.SpanishUndeadD: [25, 30, 1.0, 5.0, 2.0, SKELETON, 1], AvatarTypes.Navy: [1, 1, 1.0, 5.0, 2.0, HUMAN, 0], AvatarTypes.Cadet: [2, 4, 1.0, 5.0, 2.0, HUMAN, 1], AvatarTypes.Guard: [5, 8, 1.0, 5.0, 2.0, HUMAN, 1], AvatarTypes.Sergeant: [9, 12, 1.0, 5.0, 2.0, HUMAN, 1], AvatarTypes.Veteran: [15, 18, 1.0, 5.0, 2.0, HUMAN, 1], AvatarTypes.Officer: [20, 26, 1.0, 5.0, 2.0, HUMAN, 1], AvatarTypes.TradingCo: [1, 1, 1.0, 5.0, 2.0, HUMAN, 0], AvatarTypes.Thug: [8, 12, 1.0, 5.0, 2.0, HUMAN, 1], AvatarTypes.Grunt: [14, 18, 1.0, 5.0, 2.0, HUMAN, 1], AvatarTypes.Hiredgun: [19, 24, 1.0, 5.0, 2.0, HUMAN, 1], AvatarTypes.Mercenary: [25, 30, 1.0, 5.0, 2.0, HUMAN, 1], AvatarTypes.Assassin: [30, 35, 1.0, 5.0, 2.0, HUMAN, 1], AvatarTypes.Creature: [1, 1, 1.0, 4.0, 2.0, MONSTER, 0], AvatarTypes.Monkey: [1, 1, 1.0, 2.0, 2.0, MONSTER, 0], AvatarTypes.Crab: [1, 4, 2.0, 1.0, 1.0, MONSTER, 1], AvatarTypes.RockCrab: [6, 9, 3.5, 2.0, 1.0, MONSTER, 1], AvatarTypes.GiantCrab: [16, 23, 5.0, 3.0, 2.0, MONSTER, 1], AvatarTypes.Stump: [30, 35, 1.15, 8.0, 2.5, MONSTER, 1], AvatarTypes.FlyTrap: [9, 18, 1.0, 20.0, 2.5, MONSTER, 1], AvatarTypes.Seagull: [1, 1, 1.0, 3.0, 2.0, MONSTER, 0], AvatarTypes.Scorpion: [2, 5, 0.35, 2.0, 2.0, MONSTER, 1], AvatarTypes.DreadScorpion: [14, 21, 0.5, 2.0, 2.0, MONSTER, 1], AvatarTypes.Alligator: [2, 4, 1.0, 2.0, 2.0, MONSTER, 1], AvatarTypes.BigGator: [9, 14, 1.5, 2.0, 2.0, MONSTER, 1], AvatarTypes.HugeGator: [12, 18, 2.0, 2.0, 2.0, MONSTER, 1], AvatarTypes.Bat: [1, 4, 1.0, 6.0, 2.0, MONSTER, 1], AvatarTypes.VampireBat: [9, 14, 1.5, 6.0, 2.0, MONSTER, 1], AvatarTypes.Wasp: [6, 12, 0.5, 4.0, 2.0, MONSTER, 1], AvatarTypes.AngryWasp: [14, 20, 0.7, 4.0, 2.0, MONSTER, 1], AvatarTypes.SeaSerpent: [30, 30, 2.0, 60.0, 280.0, MONSTER, 0], AvatarTypes.Townfolk: [1, 1, 1.0, 5.0, 2.0, HUMAN, 0], AvatarTypes.Pirate: [1, 1, 1.0, 5.0, 2.0, HUMAN, 0], AvatarTypes.Landlubber: [1, 4, 1.0, 5.0, 2.0, HUMAN, 0], AvatarTypes.Scallywag: [2, 8, 1.0, 5.0, 2.0, HUMAN, 0], AvatarTypes.Buccaneer: [4, 12, 1.0, 5.0, 2.0, HUMAN, 0], AvatarTypes.Swashbuckler: [8, 16, 1.0, 5.0, 2.0, HUMAN, 0], AvatarTypes.Warmonger: [16, 20, 1.0, 5.0, 2.0, HUMAN, 0]}
...
def determineAggroInfo(aggroRadius):
    aggroInfo = [
     AGGRO_MODE_NEVER, INSTANT_AGGRO_RADIUS_DEFAULT]
    if aggroRadius != None:
