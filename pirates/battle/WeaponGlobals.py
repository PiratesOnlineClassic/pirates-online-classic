...
__dcFieldNames = {InventoryType.MeleeRep: 'Melee', InventoryType.CutlassRep: 'Cutlass', InventoryType.PistolRep: 'Pistol', InventoryType.MusketRep: 'Musket', InventoryType.DaggerRep: 'Dagger', InventoryType.GrenadeRep: 'Grenade', InventoryType.DollRep: 'Doll', InventoryType.WandRep: 'Wand', InventoryType.KettleRep: 'Kettle', InventoryType.CannonRep: 'Cannon'}
__weaponId2Class = {InventoryType.MeleeWeaponL1: Melee.Melee,InventoryType.MeleeWeaponL2: Melee.Melee,InventoryType.MeleeWeaponL3: Melee.Melee,InventoryType.MeleeWeaponL4: Melee.Melee,InventoryType.MeleeWeaponL5: Melee.Melee,InventoryType.MeleeWeaponL6: Melee.Melee,InventoryType.CutlassWeaponL1: Sword.Sword,InventoryType.CutlassWeaponL2: Sword.Sword,InventoryType.CutlassWeaponL3: Sword.Sword,InventoryType.CutlassWeaponL4: Sword.Sword,InventoryType.CutlassWeaponL5: Sword.Sword,InventoryType.CutlassWeaponL6: Sword.Sword,InventoryType.PistolWeaponL1: Pistol.Pistol,InventoryType.PistolWeaponL2: Pistol.Pistol,InventoryType.PistolWeaponL3: Pistol.Pistol,InventoryType.PistolWeaponL4: Pistol.Pistol,InventoryType.PistolWeaponL5: Pistol.Pistol,InventoryType.PistolWeaponL6: Pistol.Pistol,InventoryType.MusketWeaponL1: Bayonet.Bayonet,InventoryType.MusketWeaponL2: Bayonet.Bayonet,InventoryType.MusketWeaponL3: Bayonet.Bayonet,InventoryType.BayonetWeaponL1: Bayonet.Bayonet,InventoryType.BayonetWeaponL2: Bayonet.Bayonet,InventoryType.BayonetWeaponL3: Bayonet.Bayonet,InventoryType.DaggerWeaponL1: Dagger.Dagger,InventoryType.DaggerWeaponL2: Dagger.Dagger,InventoryType.DaggerWeaponL3: Dagger.Dagger,InventoryType.DaggerWeaponL4: Dagger.Dagger,InventoryType.DaggerWeaponL5: Dagger.Dagger,InventoryType.DaggerWeaponL6: Dagger.Dagger,InventoryType.GrenadeWeaponL1: Grenade.Grenade,InventoryType.GrenadeWeaponL2: Grenade.Grenade,InventoryType.GrenadeWeaponL3: Grenade.Grenade,InventoryType.GrenadeWeaponL4: Grenade.Grenade,InventoryType.GrenadeWeaponL5: Grenade.Grenade,InventoryType.GrenadeWeaponL6: Grenade.Grenade,InventoryType.WandWeaponL1: Wand.Wand,InventoryType.WandWeaponL2: Wand.Wand,InventoryType.WandWeaponL3: Wand.Wand,InventoryType.WandWeaponL4: Wand.Wand,InventoryType.WandWeaponL5: Wand.Wand,InventoryType.WandWeaponL6: Wand.Wand,InventoryType.DollWeaponL1: Doll.Doll,InventoryType.DollWeaponL2: Doll.Doll,InventoryType.DollWeaponL3: Doll.Doll,InventoryType.DollWeaponL4: Doll.Doll,InventoryType.DollWeaponL5: Doll.Doll,InventoryType.DollWeaponL6: Doll.Doll,InventoryType.Potion1: Consumable.Consumable,InventoryType.Potion2: Consumable.Consumable,InventoryType.Potion3: Consumable.Consumable,InventoryType.Potion4: Consumable.Consumable,InventoryType.Potion5: Consumable.Consumable,InventoryType.ShipRepairKit: Consumable.Consumable,InventoryType.PorkChunk: Consumable.Consumable,InventoryType.MonsterWeaponL1: MonsterMelee.MonsterMelee,InventoryType.MonsterWeaponL2: MonsterMelee.MonsterMelee,InventoryType.MonsterWeaponL3: MonsterMelee.MonsterMelee,InventoryType.MonsterWeaponL4: MonsterMelee.MonsterMelee,InventoryType.MonsterWeaponL5: MonsterMelee.MonsterMelee,InventoryType.DualCutlassL1: DualCutlass.DualCutlass,InventoryType.FoilL1: Foil.Foil}
__weaponClass2Key = {Sword.Sword: 1, Pistol.Pistol: 2, Doll.Doll: 3, Dagger.Dagger: 4, Grenade.Grenade: 5, Wand.Wand: 6}
...
__multiHitAttacks = {InventoryType.DaggerSwipe: [0.1, 0.4], InventoryType.DaggerEviscerate: [0.15, 0.65, 1.15], InventoryType.DaggerViperNest: [1.0, 1.4, 1.7], InventoryType.CutlassBladestorm: [0.4, 0.7, 1.13, 1.41, 2.6], InventoryType.CutlassFlourish: [0.56, 0.93, 1.3], InventoryType.BayonetRush: [0.15, 0.65, 1.15, 1.6], EnemySkills.CUTLASS_DOUBLESLASH: [0.3, 0.8], EnemySkills.CUTLASS_FLURRY: [0.15, 0.65, 1.15], EnemySkills.CUTLASS_COMBOA: [0.56, 0.93, 1.3], EnemySkills.DUAL_CLAW: [0.3, 0.5], EnemySkills.BAT_FLURRY: [0.4, 0.7, 1.13, 1.41], EnemySkills.FOIL_REPRISE: [0.3, 0.8], EnemySkills.FOIL_REMISE: [0.5, 0.9], EnemySkills.FOIL_CADENCE: [0.5, 0.9, 1.3, 1.8], EnemySkills.DUALCUTLASS_COMBINATION: [0.36, 0.8, 1.2, 1.3, 1.68, 2.1], EnemySkills.DUALCUTLASS_BARRAGE: [0.62, 0.9, 1.25, 1.5, 1.8], EnemySkills.DUALCUTLASS_SPIN: [0.29, 0.5, 0.75, 0.95], EnemySkills.DUALCUTLASS_XSLASH: [0.7, 1.7], EnemySkills.DUALCUTLASS_GORE: [0.4, 1.6]}

def getMultiHitAttacks(skillId):
    return __multiHitAttacks.get(skillId)


__projectileAttacks = {InventoryType.DaggerAsp: (80, 0.708, (150, 15)), InventoryType.DaggerAdder: (80, 0.708, (150, 15)), InventoryType.DaggerSidewinder: (80, 0.292, (150, 15)), InventoryType.StaffBlast: (80, 0.0, (70, 5)), InventoryType.StaffHellfire: (100, 0.0, (100, 5)), EnemySkills.FLYTRAP_SPIT: (100, 0.958, (70, 5)), EnemySkills.DAGGER_THROW_KNIFE: (80, 0.708, (150, 15)), EnemySkills.DAGGER_THROW_VENOMBLADE: (80, 0.708, (150, 15)), EnemySkills.DAGGER_THROW_BARBED: (80, 0.292, (150, 15)), EnemySkills.DAGGER_THROW_INTERRUPT: (80, 0.708, (150, 15))}
...
__effectTable = {C_FLAMING: ((-30, 0, 0, 0, 0), 3),C_ON_FIRE: ((-24, 0, 0, 0, 0), 3),C_WOUND: ((-40, 0, 0, 0, 0), 3),C_ACID: ((-28, 0, 0, 0, 0), 3),C_POISON: ((-20, 0, 0, 0, 0), 3),C_REGEN: ((20, 0, 0, 0, 0), 3),C_STUN: ((0, 0, 0, 0, -1), 1),C_UNSTUN: ((0, 0, 0, 0, 0), 1),C_SLOW: ((0, 0, 0, 0, 0), 1),C_PAIN: ((0, 0, 0, 0, 0), 1),C_HOLD: ((0, 0, 0, 0, -1), 1),C_BLIND: ((0, 0, 0, 0, 0), 1),C_TAUNT: ((0, 0, 0, 0, 0), 1),C_MINE: ((0, 0, 0, 0, 0), 1),C_CURSE: ((0, 0, 0, 0, 0), 1),C_HASTEN: ((0, 0, 0, 0, 0), 1),C_WEAKEN: ((0, 0, 0, 0, 0), 1),C_FULLSAIL: ((0, 0, 0, 0, 0), 1),C_COMEABOUT: ((0, 0, 0, 0, 0), 1),C_OPENFIRE: ((0, 0, 0, 0, 0), 1),C_RAM: ((0, 0, 0, 0, 0), 1),C_TAKECOVER: ((0, 0, 0, 0, 0), 1),C_RECHARGE: ((0, 0, 0, 0, 0), 1),C_ATTUNE: ((0, 0, 0, 0, 0), 10),C_DIRT: ((0, 0, 0, 0, 0), 1),C_SPAWN: ((0, 0, 0, 0, 0), 1),C_SOULTAP: ((0, 0, 0, 0, 0), 1),C_LIFEDRAIN: ((0, 0, 0, 0, 0), 1),C_MANADRAIN: ((0, 0, 0, 0, 0), 1),C_BUFF_BREAK: ((0, 0, 0, 0, 0), 1),C_UNDEAD_KILLER: ((0, 0, 0, 0, 0), 1),C_MONSTER_KILLER: ((0, 0, 0, 0, 0), 1),C_SHIPHEAL: ((0, 0, 0, 0, 0), 1),C_VOODOO_STUN: ((0, 0, 0, 0, 0), 1),C_VOODOO_STUN_LOCK: ((0, 0, 0, 0, 0), 1),C_VOODOO_HEX_STUN: ((0, 0, 0, 0, 0), 1),C_INTERRUPTED: ((0, 0, 0, 0, 0), 1)}
