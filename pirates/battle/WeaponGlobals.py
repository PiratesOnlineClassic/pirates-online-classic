...
__effectTable = {C_FLAMING: ((-30, 0, 0, 0, 0), 3), C_ON_FIRE: ((-24, 0, 0, 0, 0), 3), C_WOUND: ((-40, 0, 0, 0, 0), 3), C_ACID: ((-28, 0, 0, 0, 0), 3), C_POISON: ((-20, 0, 0, 0, 0), 3), C_REGEN: ((20, 0, 0, 0, 0), 3), C_STUN: ((0, 0, 0, 0, -1), 1), C_UNSTUN: ((0, 0, 0, 0, 0), 1), C_SLOW: ((0, 0, 0, 0, 0), 1), C_PAIN: ((0, 0, 0, 0, 0), 1), C_HOLD: ((0, 0, 0, 0, -1), 1), C_BLIND: ((0, 0, 0, 0, 0), 1), C_TAUNT: ((0, 0, 0, 0, 0), 1), C_MINE: ((0, 0, 0, 0, 0), 1), C_CURSE: ((0, 0, 0, 0, 0), 1), C_HASTEN: ((0, 0, 0, 0, 0), 1), C_WEAKEN: ((0, 0, 0, 0, 0), 1), C_FULLSAIL: ((0, 0, 0, 0, 0), 1), C_COMEABOUT: ((0, 0, 0, 0, 0), 1), C_OPENFIRE: ((0, 0, 0, 0, 0), 1), C_RAM: ((0, 0, 0, 0, 0), 1), C_TAKECOVER: ((0, 0, 0, 0, 0), 1), C_RECHARGE: ((0, 0, 0, 0, 0), 1), C_ATTUNE: ((0, 0, 0, 0, 0), 10), C_DIRT: ((0, 0, 0, 0, 0), 1), C_SPAWN: ((0, 0, 0, 0, 0), 1), C_SOULTAP: ((0, 0, 0, 0, 0), 1), C_LIFEDRAIN: ((0, 0, 0, 0, 0), 1), C_MANADRAIN: ((0, 0, 0, 0, 0), 1), C_BUFF_BREAK: ((0, 0, 0, 0, 0), 1), C_UNDEAD_KILLER: ((0, 0, 0, 0, 0), 1), C_MONSTER_KILLER: ((0, 0, 0, 0, 0), 1), C_SHIPHEAL: ((0, 0, 0, 0, 0), 1), C_VOODOO_STUN: ((0, 0, 0, 0, 0), 1), C_VOODOO_STUN_LOCK: ((0, 0, 0, 0, 0), 1), C_INTERRUPTED: ((0, 0, 0, 0, 0), 1)}
