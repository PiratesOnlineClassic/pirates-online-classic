...
class DistributedShipUD(DistributedMovingObject, DistributedCharterableObject, Teamable):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedShipUD')

    def __init__(self, air):
        DistributedMovingObject.__init__(self, air)
        DistributedCharterableObject.__init__(self, air)
