...
WARSHIPL3 = 23
WARSHIPL4 = 24
PLAYER_SHIPS = (INTERCEPTORL1, INTERCEPTORL2, INTERCEPTORL3, INTERCEPTORL4,
                MERCHANTL1, MERCHANTL2, MERCHANTL3, MERCHANTL4, WARSHIPL1,
                WARSHIPL2, WARSHIPL3, WARSHIPL4)
BLACK_PEARL = 50
DAUNTLESS = 51
FLYING_DUTCHMAN = 52
GOLIATH = 53
...
SHIP_CLASS_LIST = [
    'DINGHY', 'INTERCEPTORL1', 'INTERCEPTORL2', 'INTERCEPTORL3',
    'INTERCEPTORL4', 'MERCHANTL1', 'MERCHANTL2', 'MERCHANTL3', 'WARSHIPL1',
    'WARSHIPL2', 'WARSHIPL3', 'WARSHIPL4', 'BLACK_PEARL', 'DAUNTLESS',
    'FLYING_DUTCHMAN', 'GOLIATH', 'SKEL_WARSHIPL3', 'SKEL_INTERCEPTORL3',
    'STUMPY_SHIP', 'NAVY_FERRET', 'NAVY_GREYHOUND', 'NAVY_KINGFISHER',
    'NAVY_PREDATOR', 'NAVY_BULWARK', 'NAVY_VANGUARD', 'NAVY_MONARCH',
    'NAVY_COLOSSUS', 'NAVY_PANTHER', 'NAVY_CENTURION', 'NAVY_MAN_O_WAR',
    'NAVY_DREADNOUGHT', 'EITC_SEA_VIPER', 'EITC_BLOODHOUND', 'EITC_BARRACUDA',
    'EITC_CORSAIR', 'EITC_SENTINEL', 'EITC_IRONWALL', 'EITC_OGRE',
    'EITC_BEHEMOTH', 'EITC_CORVETTE', 'EITC_MARAUDER', 'EITC_WARLORD',
    'EITC_JUGGERNAUT', 'SKEL_PHANTOM', 'SKEL_REVENANT', 'SKEL_STORM_REAPER',
    'SKEL_BLACK_HARBINGER', 'SKEL_DEATH_OMEN', 'SKEL_SHADOW_CROW_FR',
    'SKEL_HELLHOUND_FR', 'SKEL_BLOOD_SCOURGE_FR', 'SKEL_SHADOW_CROW_SP',
    'SKEL_HELLHOUND_SP', 'SKEL_BLOOD_SCOURGE_SP'
]
...
def getHullInfo(shipClass):
    ...
    hullInfo = [[
        shipInfo['setHullTextureIndex'], shipInfo['setHullColorIndex']
    ], [shipInfo['setStripeTextureIndex'], shipInfo['setStripeColorIndex']], [
        shipInfo['setPatternTextureIndex'], shipInfo['setPatternColorIndex']
    ]]
    for s in hullInfo:
        for p in s:
            p += [0] * (3 - len(p))
...
__baseShipConfigs = {
    ...
    WARSHIPL3: {
        ...
        'setLeftBroadsideConfig': [
            CANNONL2, CANNONL2, CANNONL2, CANNONL2, CANNONL2, CANNONL2,
            CANNONL2, 0, CANNONL2, CANNONL2, CANNONL2, 0
        ],
        'setRightBroadsideConfig': [
            CANNONL2, CANNONL2, CANNONL2, CANNONL2, CANNONL2, CANNONL2,
            CANNONL2, 0, CANNONL2, CANNONL2, CANNONL2, 0
        ...
        InventoryType.CannonRoundShot,
        'setWallDecorConfig': [
            200, 200, 200, 200, 200, 202, 200, 200, 200, 200, 200, 202, 200,
            200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 200, 202, 202,
            202, 201, 201, 201, 201, 201, 201, 201, 201
        ],
        'setFloorDecorConfig': [3] * 26,
        'setProwType':
        0,
    ...
    MERCHANTL2: {
        ...
        'setLeftBroadsideConfig': [
            CANNONL2, CANNONL2, CANNONL2, CANNONL2, CANNONL2, 0, 0, CANNONL2,
            CANNONL2, CANNONL2, CANNONL2, 0
        ],
        'setRightBroadsideConfig': [
            CANNONL2, CANNONL2, CANNONL2, CANNONL2, CANNONL2, 0, 0, CANNONL2,
            CANNONL2, CANNONL2, CANNONL2, 0
    ...
    GOLIATH: {
        ...
        'setFloorDecorConfig': [
            0, 0, 3, 3, 0, 0, 0, 0, 3, 3, 0, 0, 0, 0, 3, 3, 3, 3, 3, 3, 0, 0, 3,
            3, 3, 3
        ],
        'setProwType':
        0,
    ...
    NAVY_CENTURION: {
        ...
        'setWallDecorConfig': [],
        'setFloorDecorConfig':
        [3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 0, 0, 0, 0, 3, 3, 0, 0, 3, 3],
        'setProwType':
        0,
        'setRamType':
        RAML3,
    ...
    NAVY_MONARCH: {
        ...
        'setCannonConfig': [CANNONL1] * 8,
        'setLeftBroadsideConfig': [
            0, CANNONL2, CANNONL2, CANNONL2, CANNONL2, 0, 0, 0, CANNONL2,
            CANNONL2, CANNONL2, 0
        ],
        'setRightBroadsideConfig': [
            0, CANNONL2, CANNONL2, CANNONL2, CANNONL2, 0, 0, 0, CANNONL2,
    ...
    NAVY_COLOSSUS: {
        ...
        'setCannonConfig': [CANNONL1] * 10,
        'setLeftBroadsideConfig': [
            CANNONL2, CANNONL2, CANNONL2, CANNONL2, CANNONL2, CANNONL2, 0,
            CANNONL2, CANNONL2, CANNONL2, CANNONL2, 0
        ],
        'setRightBroadsideConfig': [
            CANNONL2, CANNONL2, CANNONL2, CANNONL2, CANNONL2, CANNONL2, 0,
            CANNONL2, CANNONL2, CANNONL2, CANNONL2, 0
    ...
    EITC_OGRE: {
        ...
        'setLeftBroadsideConfig': [
            CANNONL2, CANNONL2, CANNONL2, CANNONL2, CANNONL2, 0, 0, CANNONL2,
            CANNONL2, CANNONL2, CANNONL2, CANNONL2
        ],
        'setRightBroadsideConfig': [
            CANNONL2, CANNONL2, CANNONL2, CANNONL2, CANNONL2, 0, 0, CANNONL2,
            CANNONL2, CANNONL2, CANNONL2, CANNONL2
    ...
    SKEL_PHANTOM: {
        ...
        'setLeftBroadsideConfig': [
            0, SKEL_CANNON_L2, SKEL_CANNON_L2, SKEL_CANNON_L2, SKEL_CANNON_L2,
            SKEL_CANNON_L2, 0
        ],
        'setRightBroadsideConfig': [
            0, SKEL_CANNON_L2, SKEL_CANNON_L2, SKEL_CANNON_L2, SKEL_CANNON_L2,
...
def getMastInfo(hullId):
    ...
    mastNames = [
        'setMastConfig1', 'setMastConfig2', 'setMastConfig3',
        'setForemastConfig', 'setAftmastConfig'
    ]
    sailNames = [
        'setSailConfig1', 'setSailConfig2', 'setSailConfig3',
        'setForesailConfig', 'setAftsailConfig'
    ]
    mastInfo = []
...
__shipAttributes = ['setShipClass']
__hullAttributes = [
    'setShipClass', 'setCannonConfig', 'setLeftBroadsideConfig',
    'setRightBroadsideConfig', 'setBroadsideAmmo', 'setWallDecorConfig',
    'setFloorDecorConfig', 'setProwType', 'setRamType', 'setHullTextureIndex',
    'setHullColorIndex', 'setHullHilightColorIndex', 'setStripeTextureIndex',
    'setStripeColorIndex', 'setStripeHilightColorIndex',
    'setPatternTextureIndex', 'setPatternColorIndex',
    'setPatternHilightColorIndex'
]
__cabinAttributes = [
    'setShipClass', 'setCabinType', 'setCannonConfig', 'setWallDecorConfig',
    'setFloorDecorConfig', 'setWindowConfig', 'setHullTextureIndex',
    'setHullColorIndex', 'setHullHilightColorIndex', 'setStripeTextureIndex',
    'setStripeColorIndex', 'setStripeHilightColorIndex',
    'setPatternTextureIndex', 'setPatternColorIndex',
    'setPatternHilightColorIndex'
...
__mastAttributes = {
    0:
    ['setShipClass', 'setMastConfig1', 'setSailConfig1', 'setMastTextureIndex'],
    1:
    ['setShipClass', 'setMastConfig2', 'setSailConfig2', 'setMastTextureIndex'],
    2:
    ['setShipClass', 'setMastConfig3', 'setSailConfig3', 'setMastTextureIndex'],
    3: [
        'setShipClass', 'setForemastConfig', 'setForesailConfig',
        'setMastTextureIndex'
    ],
    4: [
        'setShipClass', 'setAftmastConfig', 'setAftsailConfig',
        'setMastTextureIndex'
    ]
}
__sailAttributes = {
    0: [
        'setMastConfig1', 'setSailConfig1', 'setSailTextureIndex',
        'setSailLogoIndex'
    ],
    1: [
        'setMastConfig2', 'setSailConfig2', 'setSailTextureIndex',
        'setSailLogoIndex'
    ],
    2: [
        'setMastConfig3', 'setSailConfig3', 'setSailTextureIndex',
        'setSailLogoIndex'
    ],
    3: [
        'setForemastConfig', 'setForesailConfig', 'setSailTextureIndex',
        'setSailLogoIndex'
    ],
    4: [
        'setAftmastConfig', 'setAftsailConfig', 'setSailTextureIndex',
        'setSailLogoIndex'
    ]
}
__prowAttributes = ['setProwType']
__ramAttributes = ['setRamType']
__wallDecorAttributes = ['setWallDecorConfig']
__floorDecorAttributes = ['setFloorDecorConfig']
__shipDNAdata = ['setShipClass', 'setOwnerId']
__hullDNAdata = [
    'setShipClass', 'setCannonConfig', 'setLeftBroadsideConfig',
    'setRightBroadsideConfig', 'setBroadsideAmmo', 'setWallDecorConfig',
    'setFloorDecorConfig', 'setProwType', 'setRamType', 'setHullTextureIndex',
...
__mastDNAdata = [
    'setShipClass', 'setMastType', 'setSailConfig', 'setTextureIndex',
    'setPosIndex'
]
__sailDNAdata = [
    'setMastType', 'setSailType', 'setTextureIndex', 'setLogoIndex',
    'setPosIndex'
]
__prowDNAdata = ['setProwType', 'setOwnerId']
__decorDNAdata = ['setDecorType', 'setPosIndex', 'setOwnerId']
...
def getRepairCost(ship,
                  ...
                  prow=None,
                  ram=None):
    return calcRepairCost(ship.maxHp, ship.Hp, ship.maxSp, ship.Sp,
                          ship.modelClass)
...
BroadsideAnimDict = (('zero', '_zero'), ('Fire', '_fire'), ('Open', '_open'),
                     ('Close', '_close'))
...
def preprocessMast(name, maxHeight, index):
    ...
    for j in xrange(maxHeight):
        ...
        if j < maxHeight - 1:
            ...
            excludedJoint = []
        mast.makeSubpart('mast_%d_%d' % (j, index), ['def_mast_' + str(j)],
                         excludedJoint)
...
def getMast(filename):
    try:
        ...
        base.notify.error(
            'Mast helper function from ShipGlobals encountered an error trying to load %s'
            % filename)
...
KrakenLocators = {
    INTERCEPTORL1: ((Point3(40, 20, -5), 0.5, Point3(0), 0.9), (Point3(
        40, -40, -5), 0.5, Point3(0), 0.9)),
    INTERCEPTORL2: ((Point3(50, 40, -5), 0.75, Point3(0), 0.9), (Point3(
        50, -70, -5), 0.75, Point3(0), 0.9)),
    INTERCEPTORL3: ((Point3(60, 80, 0), 0.8, Point3(0), 0.9), (Point3(
        60, -30, 0), 0.8, Point3(0), 0.9)),
    MERCHANTL1: ((Point3(30, 50, -5), 0.6, Point3(0), 0.9), (Point3(
        40, -10, -5), 0.6, Point3(0), 0.9), (Point3(40, -70, -5), 0.6,
                                             Point3(0), 0.9)),
    MERCHANTL2: ((Point3(50, 50, 0), 0.8, Point3(0),
                  0.9), (Point3(50, -10, 0), 0.8, Point3(0), 0.9), (Point3(
                      50, -70, 0), 0.8, Point3(0), 0.9)),
    MERCHANTL3: ((Point3(60, 50, 0), 1, Point3(0), 0.9), (Point3(70, -10, 0), 1,
                                                          Point3(0), 0.9),
                 (Point3(70, -120, 0), 1, Point3(0), 0.9)),
    WARSHIPL1: ((Point3(30, 50, -15), 0.6, Point3(0, 22, 0), 0.7), (Point3(
        40, -10, -15), 0.6, Point3(0), 0.8), (Point3(40, -70, -15), 0.6,
                                              Point3(0), 0.8)),
    WARSHIPL2: ((Point3(40, 90, -15), 0.8, Point3(10, 25, 0), 0.8), (Point3(
        50, 10, -15), 0.8, Point3(0), 0.9), (Point3(50, -70, -15), 0.8,
                                             Point3(0), 0.9)),
    WARSHIPL3: ((Point3(50, 90, -15), 1, Point3(-20, 15, 0), 0.6), (Point3(
        60, 10, -15), 1, Point3(0), 0.8), (Point3(60, -120, -15), 1, Point3(0),
                                           0.9))
}
__shipSplitOffsets = {
    DINGHY: (0.0, 0),
