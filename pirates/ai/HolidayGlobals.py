...
holidays = {
    ...
    HolidayDates(HolidayDates.TYPE_CUSTOM, [(2008, Month.FEBRUARY, 25, 0, 0, 0),
                                            (2008, Month.MARCH, 2, 0, 0, 0)]),
    PiratesGlobals.SAINTPATRICKSDAY:
    HolidayDates(HolidayDates.TYPE_YEARLY, [(Month.MARCH, 14, 0, 0, 0),
                                            (Month.MARCH, 18, 0, 0, 0)]),
    PiratesGlobals.MOTHERSDAY:
    HolidayDates(HolidayDates.TYPE_YEARLY, [(Month.MAY, 10, 0, 0, 0),
                                            (Month.MAY, 12, 0, 0, 0)]),
    PiratesGlobals.FATHERSDAY:
    HolidayDates(HolidayDates.TYPE_YEARLY, [(Month.JUNE, 13, 0, 0, 0),
                                            (Month.JUNE, 18, 0, 0, 0)]),
    PiratesGlobals.FOURTHOFJULY:
    HolidayDates(HolidayDates.TYPE_YEARLY, [(Month.JULY, 3, 18, 0, 0),
                                            (Month.JULY, 7, 0, 0, 0)]),
    ...
    HolidayDates(HolidayDates.TYPE_YEARLY, [(Month.OCTOBER, 31, 3, 0, 0),
...
holidayMessages = {
    PiratesGlobals.DOUBLEGOLDHOLIDAY:
    (PLocalizer.DoubleGoldStart, PLocalizer.DoubleGoldStartChat,
     PLocalizer.DoubleGoldEnd, PLocalizer.DoubleGoldEnd,
     PLocalizer.CHAT_STATUS_DOUBLEGOLD, 'admin'),
    PiratesGlobals.DOUBLEGOLDHOLIDAYPAID:
    (PLocalizer.DoubleGoldFullStart, PLocalizer.DoubleGoldFullStartChat,
     PLocalizer.DoubleGoldFullEnd, PLocalizer.DoubleGoldFullEnd,
     PLocalizer.CHAT_STATUS_DOUBLEGOLD_PAID, 'admin'),
    PiratesGlobals.DOUBLEXPHOLIDAY:
    (PLocalizer.DoubleXPStart, PLocalizer.DoubleXPStartChat,
     PLocalizer.DoubleXPEnd, PLocalizer.DoubleXPEnd,
     PLocalizer.CHAT_STATUS_DOUBLEXP, 'admin'),
    PiratesGlobals.DOUBLEXPHOLIDAYPAID:
    (PLocalizer.DoubleXPFullStart, PLocalizer.DoubleXPFullStartChat,
     PLocalizer.DoubleXPFullEnd, PLocalizer.DoubleXPFullEnd,
     PLocalizer.CHAT_STATUS_DOUBLEXP_PAID, 'admin'),
    PiratesGlobals.BLACKJACKFRIDAY:
    (PLocalizer.BlackJackFridayStart, PLocalizer.BlackJackFridayStartChat,
     PLocalizer.BlackJackFridayEnd, PLocalizer.BlackJackFridayEndChat,
     PLocalizer.CHAT_STATUS_BLACKJACK_FRIDAY, 'friends'),
    PiratesGlobals.FREEHATWEEK: (PLocalizer.FreeHatStartUnlimited,
                                 PLocalizer.FreeHatStartUnlimitedChat, None,
                                 None, None, 'admin'),
    PiratesGlobals.SAINTPATRICKSDAY: (PLocalizer.StPatricksStartUnlimited,
                                      PLocalizer.StPatricksStartUnlimitedChat,
                                      None, None, None, 'admin'),
    PiratesGlobals.MOTHERSDAY: (PLocalizer.MothersDayStartUnlimited,
                                PLocalizer.MothersDayStartUnlimitedChat, None,
                                None, PLocalizer.CHAT_STATUS_MOTHERS_DAY_PAID,
                                'tattoo'),
    PiratesGlobals.FATHERSDAY: (PLocalizer.FathersDayStart,
                                PLocalizer.FathersDayStartChat, None, None,
                                PLocalizer.CHAT_STATUS_FATHERS_DAY, 'admin'),
    PiratesGlobals.FOURTHOFJULY: (PLocalizer.FourthOfJulyStart,
                                  PLocalizer.FourthOfJulyStartChat, None, None,
                                  PLocalizer.CHAT_STATUS_FOURTHOFJULY, 'admin'),
    PiratesGlobals.HALFOFFCUSTOMIZATION:
    (PLocalizer.HalfOffCustomizationUnlimited,
     PLocalizer.HalfOffCustomizationUnlimited,
     PLocalizer.HalfOffCustomizationEnd, PLocalizer.HalfOffCustomizationEnd,
     PLocalizer.HalfOffCustomizationStatus, 'admin'),
    PiratesGlobals.ALLACCESSWEEKEND:
    (PLocalizer.UnlimitedAccessEventBasic, PLocalizer.UnlimitedAccessEventBasic,
     None, None, PLocalizer.AllAccessHolidayStart, 'admin'),
    PiratesGlobals.HALLOWEEN: (PLocalizer.HalloweenStart,
                               PLocalizer.HalloweenStartChat,
                               PLocalizer.HalloweenEnd, PLocalizer.HalloweenEnd,
                               PLocalizer.CHAT_STATUS_HALLOWEEN, 'admin'),
    PiratesGlobals.JOLLYROGERCURSE: (None, None, None, None,
                                     PLocalizer.CHAT_STATUS_JOLLYROGERCURSE,
                                     'admin'),
    PiratesGlobals.FOUNDERSFEAST:
    (PLocalizer.FoundersFeastStart, PLocalizer.FoundersFeastStartChat,
     PLocalizer.FoundersFeastEnd, PLocalizer.FoundersFeastEnd,
     PLocalizer.CHAT_STATUS_FOUNDERSFEAST, 'admin'),
    PiratesGlobals.FREEITEMTHANKSGIVING:
    (PLocalizer.FreeBandanaStartUnlimited,
     PLocalizer.FreeBandanaStartUnlimitedChat, PLocalizer.FreeBandanaStartBasic,
     PLocalizer.FreeBandanaStartBasicChat, 'hat'),
    PiratesGlobals.CURSEDNIGHT: (PLocalizer.CursedNightStart,
                                 PLocalizer.CursedNightStart,
                                 PLocalizer.CursedNightEnd,
                                 PLocalizer.CursedNightEnd, 'admin'),
    PiratesGlobals.JOLLYCURSEAUTO: (None, None, None, None,
                                    PLocalizer.CHAT_STATUS_JOLLYROGERCURSE,
                                    'admin'),
    PiratesGlobals.WINTERFESTIVAL:
    (PLocalizer.WinterFestivalStart, PLocalizer.WinterFestivalStartChat,
     PLocalizer.WinterFestivalEnd, PLocalizer.WinterFestivalEnd,
...
discordHolidayNames = {
    PiratesGlobals.DOUBLEGOLDHOLIDAY:
    PLocalizer.DISCORD_DOUBLE_GOLD_HOLIDAY,
    PiratesGlobals.DOUBLEGOLDHOLIDAYPAID:
    PLocalizer.DISCORD_DOUBLE_GOLD_HOLIDAY_PAID,
    PiratesGlobals.DOUBLEXPHOLIDAY:
    PLocalizer.DISCORD_DOUBLE_EXP_HOLIDAY,
    PiratesGlobals.DOUBLEXPHOLIDAYPAID:
    PLocalizer.DISCORD_DOUBLE_EXP_HOLIDAY_PAID,
    PiratesGlobals.FREEHATWEEK:
    PLocalizer.DISCORD_FREE_HAT_WEEK,
    PiratesGlobals.SAINTPATRICKSDAY:
    PLocalizer.DISCORD_SAINT_PATRICKS_DAY,
    PiratesGlobals.MOTHERSDAY:
    PLocalizer.DISCORD_MOTHERS_DAY,
    PiratesGlobals.FATHERSDAY:
    PLocalizer.DISCORD_FATHERS_DAY,
    PiratesGlobals.FOURTHOFJULY:
    PLocalizer.DISCORD_FOURTH_OF_JULY,
    PiratesGlobals.HALFOFFCUSTOMIZATION:
    PLocalizer.DISCORD_HALF_OFF_CUSTOMIZATION,
    PiratesGlobals.ALLACCESSWEEKEND:
    PLocalizer.DISCORD_ALL_ACCESS_WEEKEND,
    PiratesGlobals.HALLOWEEN:
    PLocalizer.DISCORD_HALLOWEEN,
    PiratesGlobals.JOLLYROGERCURSE:
    PLocalizer.DISCORD_JOLLY_ROGER_CURSE,
    PiratesGlobals.FOUNDERSFEAST:
    PLocalizer.DISCORD_FOUNDERS_FEAST,
    PiratesGlobals.FREEITEMTHANKSGIVING:
    PLocalizer.DISCORD_FREE_ITEM_THANKSGIVING,
    PiratesGlobals.CURSEDNIGHT:
    PLocalizer.DISCORD_CURSED_NIGHT,
    PiratesGlobals.JOLLYCURSEAUTO:
    PLocalizer.DISCORD_JOLLY_CURSE_AUTO,
    PiratesGlobals.WINTERFESTIVAL:
    PLocalizer.DISCORD_WINTER_FESTIVAL
}
...
def getHolidayDiscordPrefixMessage(holidayId):
    return discordPrefixMessages.get(holidayId,
                                     getHolidayStartChatMsg(holidayId))
