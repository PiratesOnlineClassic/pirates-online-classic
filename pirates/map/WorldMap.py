...
class WorldMap(DirectFrame):
    ...
    def showMapConfig(self):
        ...
        self.mapConfig = MapConfig(relief = DGG.FLAT, frameSize = (-0.02, 0.82, -1, 1), frameColor = (1, 1, 1, 1), pos = (0.7, 0, 0.0), scale = 0.75)
    ...
    def showCollisionDebug(self):
        ...
        df = DirectFrame(geom = shot, relief = None, parent = aspect2d, scale = 0.5, pos = (0.833, 0, -0.5), text = 'side', text_scale = 0.1, text_pos = (-0.75, 0.75, 0), text_fg = (1, 1, 1, 1))
        ...
        df = DirectFrame(geom = shot, relief = None, parent = aspect2d, scale = 0.5, pos = (0.833, 0, 0.5), text = 'top', text_scale = 0.1, text_pos = (-0.75, 0.75, 0), text_fg = (1, 1, 1, 1))
    ...
    def addOceanArea(self, name, areaUid, pos1, pos2):
        self.mapBall.placeOceanArea(name, areaUid, pos1, pos2)
    
    def addShip(self, shipInfo, worldPos):
        self.mapBall.placeShip(shipInfo, worldPos)
