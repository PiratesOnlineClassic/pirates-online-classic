...
from otp.distributed.AstronDatabaseInterface import AstronDatabaseInterface
    ...
    def handleGetObjectResp(self, di):
        ...
        for i in range(dclass.getNumInheritedFields()):
            ...
            try:
                ...
                self.notify.error('Failed to unpack required field %s for %s: %s' % (field.getName(), dclass.getName(), e))
                fields[field.getName()] = None
            unpacker.endUnpack()
        ...
        for i in range(other):
            ...
            try:
                ...
                self.notify.error('Failed to unpack field %s for %s: %s' % (field.getName(), dclass.getName(), e))
                fields[field.getName()] = None
            unpacker.endUnpack()
