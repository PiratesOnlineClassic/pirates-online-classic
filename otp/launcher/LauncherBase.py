...
class LauncherBase(DirectObject):
    ...
    def decompressPatchDone(self):
        self.notify.info(
            'decompressPatchDone: Patching file: ' + self.currentPatchee + ' from ver: ' + `self.currentPatchVersion`)
    ...
    def startReextractingFiles(self):
        self.notify.info('startReextractingFiles: Reextracting ' + `len(
    ...
    def patchMultifile(self):
        ...
        if clientVer == 1:
            ...
            self.notify.info(
                'patchMultifile: Old version for multifile: ' + self.currentMfname + ' Client ver: ' + `clientVer`)
            self.maybeStartGame()
