...
class PROCESSENTRY32(ctypes.Structure):
    _fields_ = [('dwSize', DWORD), ('cntUsage', DWORD),
                ('th32ProcessID', DWORD), ('th32DefaultHeapId',
                                           HANDLE), ('th32ModuleID', DWORD),
                ('cntThreads', DWORD), ('th32ParentProcessID',
                                        DWORD), ('pcPriClassBase', LONG),
...
def getProcessList():
    ...
    if hProcessSnap != INVALID_HANDLE_VALUE:
        ...
        if cwk.Process32First(hProcessSnap, ctypes.byref(pe32)):
            while True:
                processList.append(
                    ProcessEntryPY(pe32.szExeFile.lower(),
